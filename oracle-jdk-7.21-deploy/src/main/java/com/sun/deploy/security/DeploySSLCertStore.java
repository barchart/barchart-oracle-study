...
{
  private static String _userFilename = Config.getUserTrustedHttpsCertificateFile();
  private static String _systemFilename = Config.getSystemTrustedHttpsCertificateFile();
