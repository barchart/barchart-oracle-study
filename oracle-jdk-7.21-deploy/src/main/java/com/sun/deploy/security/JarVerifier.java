...
public abstract class JarVerifier
{
  ...
  public abstract void validate(DownloadDelegate paramDownloadDelegate)
    ...
    throws MalformedURLException
  {
    ...
    else
    {
      ...
      if ((arrayOfCertificate != null) && (arrayOfCertificate.length > 0))
      {
        ...
        int[] arrayOfInt = (int[])localHashMap.get(str);
        if (arrayOfInt == null)
        {
  ...
  public static JarFile getValidatedJarFile(File paramFile, URL paramURL1, URL paramURL2, String paramString, DownloadDelegate paramDownloadDelegate)
    throws IOException
  {
    int i = 0;
