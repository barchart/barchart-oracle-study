  ...
  implements AuthKey
{
  ...
  {
    String str1 = getRequestingScheme();
    if (str1.equalsIgnoreCase("NEGOTIATE"))
      return null;
    ...
    try
    {
      ...
      {
        if (localInetAddress.equals((InetAddress)this.repeatSiteTL.get()))
          i = 1;
        else
          this.repeatSiteTL.set(localInetAddress);
        str2 = localInetAddress.toString();
      }
      else
      {
        ...
        if ((str2 == null) || (str2.length() == 0))
          str2 = getMessage("net.authenticate.unknownSite");
      }
      ...
      if (Config.isJavaVersionAtLeast15())
      {
        ...
        if ((getCredentialManager() == null) || (!getCredentialManager().isCredentialValid(localCredentialInfo1)) || (i != 0))
        {
          localCredentialInfo2 = openDialog(str2, getRequestingPrompt(), str1, localCredentialInfo1);
  ...
  private CredentialInfo openDialog(String paramString1, String paramString2, String paramString3, CredentialInfo paramCredentialInfo)
  {
    ...
    boolean bool2 = false;
    if (getCredentialManager() != null)
      bool2 = getCredentialManager().isPasswordStorageSupported();
    try
    {
