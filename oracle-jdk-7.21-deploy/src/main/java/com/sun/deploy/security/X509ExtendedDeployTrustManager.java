...
public final class X509ExtendedDeployTrustManager extends X509ExtendedTrustManager
{
  ...
  public static void reset()
  {
    ...
    sessionStore = new SessionCertStore("x509extended");
    ...
    throws CertificateException
  {
    ...
    try
    {
      ...
      {
        k = (alwaysShow) || (bool) || (i != 0) || ((mismatchShow) && (!CertUtils.checkWildcardDomainList(paramString2, CertUtils.getServername(paramArrayOfX509Certificate[0])))) ? 1 : 0;
        if (k != 0)
        {
