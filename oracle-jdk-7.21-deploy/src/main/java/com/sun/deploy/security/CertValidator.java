...
final class CertValidator
{
  ...
  {
    String str1 = TrustDecider.getLocString(paramCodeSource.getLocation());
    ...
    for (paramInt = 0; m < paramArrayOfCertificate.length; paramInt++)
    {
      int n = k;
      Object localObject1 = null;
      Object localObject2 = null;
      for (n = k; n < paramArrayOfCertificate.length; n++)
      {
        X509Certificate localX509Certificate = null;
        localObject3 = null;
        if ((paramArrayOfCertificate[n] instanceof X509Certificate))
          localX509Certificate = (X509Certificate)paramArrayOfCertificate[n];
        if ((n + 1 < paramArrayOfCertificate.length) && ((paramArrayOfCertificate[(n + 1)] instanceof X509Certificate)))
          localObject3 = (X509Certificate)paramArrayOfCertificate[(n + 1)];
        else
        ...
        if ((!paramCertStore1.contains(localX509Certificate)) && (n + 1 != paramArrayOfCertificate.length) && (CertUtils.isIssuerOf(localX509Certificate, (X509Certificate)localObject3)) && ((paramCertStore2 == null) || (!paramCertStore2.contains(localX509Certificate))))
          CertUtils.checkUsageForCodeSigning(localX509Certificate, n - k);
        ...
        catch (GeneralSecurityException localGeneralSecurityException)
        {
          ...
          str2 = ResourceManager.getMessage("trustdecider.check.signature");
          throw new CertificateException(str2);
        }
      }
      m = n < paramArrayOfCertificate.length ? n + 1 : n;
      if (!SecuritySettings.isAskGrantShowSet())
      {
        str2 = ResourceManager.getMessage("trustdecider.user.cannot.grant.any");
        throw new CertificateException(str2);
      }
      int i1 = (paramCertStore1.verify(paramArrayOfCertificate[(m - 1)])) || ((paramCertStore2 != null) && (paramCertStore2.verify(paramArrayOfCertificate[(m - 1)]))) ? 1 : 0;
      if (i1 == 0)
      {
        if (!SecuritySettings.isAskGrantSelfSignedSet())
        {
          str2 = ResourceManager.getMessage("trustdecider.user.cannot.grant.notinca");
          throw new CertificateException(str2);
        }
        bool1 = true;
      }
      ...
      try
      {
        ...
        if (localTimestamp != null)
        {
          ...
          if (!bool2)
          {
            ...
            Date localDate2 = ((X509Certificate)paramArrayOfCertificate[(m - 1)]).getNotAfter();
            Date localDate3 = ((X509Certificate)paramArrayOfCertificate[(m - 1)]).getNotBefore();
            if ((((Date)localObject3).before(localDate2)) && (((Date)localObject3).after(localDate3)))
            {
              ...
              boolean bool3 = checkTSAPath((CertPath)localObject4, localDate1, paramCertStore2, paramCertStore1, localHashMap);
              if (bool3)
              {
                bool2 = true;
                i = 0;
      ...
      int i2 = 0;
      if (paramCertStore6.contains(paramArrayOfCertificate[k]))
        if (paramCertStore6.contains(paramArrayOfCertificate[k], str1, true))
          i2 = 1;
        else
          i2 = !bool2 ? 1 : 0;
      if (i2 == 0)
      {
        if (((!bool1) || (!(paramArrayOfCertificate[k] instanceof X509Certificate)) || (!TrustDecider.checkTrustedExtension((X509Certificate)paramArrayOfCertificate[k]))) && (paramCertStore5.contains(paramArrayOfCertificate[k])) && ((bool2) || (!paramCertStore5.contains(paramArrayOfCertificate[k], str1, true))))
          return true;
        if ((paramCertStore4.contains(paramArrayOfCertificate[k])) && ((bool2) || (!paramCertStore4.contains(paramArrayOfCertificate[k], str1, true))))
          return true;
        if ((paramCertStore3 != null) && (paramCertStore3.contains(paramArrayOfCertificate[k])))
          return true;
        int i3 = X509Util.showSecurityDialog(paramArrayOfCertificate, paramCodeSource.getLocation(), k, m, bool1, i, (Date)localObject3, paramAppInfo);
        if (i3 == 0)
        {
          Trace.msgSecurityPrintln("trustdecider.user.grant.session");
          paramCertStore4.add(paramArrayOfCertificate[k], str1, bool2);
        ...
        else if (i3 == 2)
        {
          ...
          if (((CertStore)localObject4).add(paramArrayOfCertificate[k], str1, bool2))
        ...
        else
        {
          ...
          paramCertStore6.add(paramArrayOfCertificate[k], str1, bool2);
