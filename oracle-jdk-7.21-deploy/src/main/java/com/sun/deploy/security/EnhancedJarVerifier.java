...
public class EnhancedJarVerifier extends JarVerifier
{
  ...
  public void validate(DownloadDelegate paramDownloadDelegate)
    ...
    try
    {
      ...
      if ((arrayOfCodeSource != null) && (arrayOfCodeSource.length > 0))
      {
        ...
        if (((List)localObject1).size() != arrayOfCodeSource.length)
          arrayOfCodeSource = (CodeSource[])((List)localObject1).toArray(new CodeSource[((List)localObject1).size()]);
        else
      ...
      while (localEnumeration.hasMoreElements())
      {
        ...
        if ((localObject1 == null) || ((!JarUtil.isSigningRelated((String)localObject1)) && (!((String)localObject1).endsWith("/"))))
        {
