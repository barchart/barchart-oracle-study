...
public final class MozillaMyKeyStore extends KeyStoreSpi
{
  ...
  public Certificate[] engineGetCertificateChain(String paramString)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (paramString.equals(localKeyEntry.getAlias()))
      {
        ...
        X509Certificate[] arrayOfX509Certificate2 = (X509Certificate[])arrayOfX509Certificate1.clone();
    ...
    throws Throwable
  {
    ...
    Object[] arrayOfObject1 = (Object[])localMethod2.invoke(localObject1, null);
        ...
        if (localBoolean.booleanValue())
          try
          {
            ...
            if ((localObject3.equals(localObject4)) || (localObject3.equals(localObject5)))
            {
              ...
              Object[] arrayOfObject5 = (Object[])localMethod7.invoke(paramObject1, arrayOfObject4);
              ...
              for (int j = 0; j < arrayOfObject5.length; j++)
              {
                ...
                generateCertificate((byte[])localObject7, localArrayList);
              }
