  ...
  implements CertStore
{
    ...
    throws IOException, CertificateException, KeyStoreException, NoSuchAlgorithmException
  {
    ...
    try
    {
      ...
      Object[] arrayOfObject = (Object[])localMethod1.invoke(localObject1, null);
      for (int i = 0; i < arrayOfObject.length; i++)
      {
        ...
        if (isTrustedSigningCACertStore())
        {
          ...
          localBoolean1 = (Boolean)localMethod3.invoke(localObject1, (Object[])localObject3);
          Field localField = localClass3.getField("EmailSigner");
          localObject3[2] = localField.get(arrayOfObject[i]);
          Boolean localBoolean2 = (Boolean)localMethod3.invoke(localObject1, (Object[])localObject3);
          if ((!localBoolean1.booleanValue()) && (!localBoolean2.booleanValue()));
        }
        else if (isTrustedSSLCACertStore())
        {
        ...
        {
          localObject2 = localClass2.getMethod("getEncoded", null);
          localObject3 = (byte[])((Method)localObject2).invoke(arrayOfObject[i], null);
          generateCertificate((byte[])localObject3, this.certs);
        }
      }
    }
