  ...
  implements ListSelectionListener, ChangeListener
{
  ...
  private void initComponents()
  {
    ...
    addWindowListener(new WindowAdapter()
    {
      ...
      {
        CertificatesDialog.this.closeDialog(paramAnonymousWindowEvent);
      }
    });
    ...
    this.certsComboBox.addActionListener(new ActionListener()
    {
      ...
      {
        CertificatesDialog.this.certsComboBoxActionPerformed(paramAnonymousActionEvent);
      }
    });
    ...
    this.importButton.addActionListener(new ActionListener()
    {
      public void actionPerformed(ActionEvent paramAnonymousActionEvent)
      {
        CertificatesDialog.this.importButtonActionPerformed(paramAnonymousActionEvent);
      }
    });
    ...
    this.exportButton.addActionListener(new ActionListener()
    {
      public void actionPerformed(ActionEvent paramAnonymousActionEvent)
      {
        CertificatesDialog.this.exportButtonActionPerformed(paramAnonymousActionEvent);
      }
    });
    ...
    this.removeButton.addActionListener(new ActionListener()
    {
      public void actionPerformed(ActionEvent paramAnonymousActionEvent)
      {
        CertificatesDialog.this.removeButtonActionPerformed(paramAnonymousActionEvent);
      }
    });
    ...
    this.detailsButton.addActionListener(new ActionListener()
    {
      public void actionPerformed(ActionEvent paramAnonymousActionEvent)
      {
        CertificatesDialog.this.detailsButtonActionPerformed(paramAnonymousActionEvent);
      }
    });
    ...
    AbstractAction local8 = new AbstractAction()
    {
      public void actionPerformed(ActionEvent paramAnonymousActionEvent)
      {
        CertificatesDialog.this.closeButtonActionPerformed(paramAnonymousActionEvent);
      }
    };
  ...
  private void exportButtonActionPerformed(ActionEvent paramActionEvent)
  {
    ...
    if (i != -1)
    {
      ...
      {
        arrayOfCertificate = (Certificate[])arrayOfObject[i];
    ...
    try
    {
      ...
      if (arrayOfChar != null)
      {
        ...
        while (((Enumeration)localObject1).hasMoreElements())
        {
          ...
          this.model.addClientAuthCertChain(this, (Certificate[])localObject2, localKey);
        }
      }
    }
    catch (Throwable localThrowable)
  ...
  private void reset()
  {
    ...
    else
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        if (str.equals(this.strClientAuth))
        {
          Certificate[] arrayOfCertificate = (Certificate[])localIterator.next();
          localX509Certificate = (X509Certificate)arrayOfCertificate[0];
        }
        else
        {
