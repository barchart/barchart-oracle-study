  ...
  implements ActionListener
{
  ...
  public void show()
  {
    ...
    addKeyListener(new KeyAdapter()
    {
      ...
      {
        int i = ResourceManager.getMnemonic("find.cancelButton");
        if (paramAnonymousKeyEvent.getKeyCode() == i)
  ...
  private class PathChooser extends JFileChooser
  {
    public PathChooser()
    {
      ...
      addActionListener(new ActionListener()
      {
        ...
        public void actionPerformed(ActionEvent paramAnonymousActionEvent)
        {
          if ("ApproveSelection".equals(paramAnonymousActionEvent.getActionCommand()))
          {
            if ((paramAnonymousActionEvent.getSource() instanceof JFileChooser))
            {
              JFileChooser localJFileChooser = (JFileChooser)paramAnonymousActionEvent.getSource();
          ...
          else if ("CancelSelection".equals(paramAnonymousActionEvent.getActionCommand()))
          {
      ...
      addPropertyChangeListener(new PropertyChangeListener()
      {
        ...
        {
          if (("SelectedFileChangedProperty".equals(paramAnonymousPropertyChangeEvent.getPropertyName())) || ("directoryChanged".equals(paramAnonymousPropertyChangeEvent.getPropertyName())))
            JreFindDialog.PathChooser.this.updateDirectory();
        }
      });
      try
    ...
    implements ActionListener
  {
    ...
    public SearchPanel()
    {
      this.list.setCellRenderer(new DefaultListCellRenderer()
      {
        ...
        {
          if ((paramAnonymousObject instanceof JREInfo))
            paramAnonymousObject = ((JREInfo)paramAnonymousObject).getPath();
          return super.getListCellRendererComponent(paramAnonymousJList, paramAnonymousObject, paramAnonymousInt, paramAnonymousBoolean1, paramAnonymousBoolean2);
        }
      });
      ...
      implements Runnable
    {
      ...
      private boolean check(File paramFile, boolean paramBoolean)
      {
        ...
        if ((paramFile.isFile()) && ((str.equals("java")) || (str.equals("javaw.exe"))))
        {
          ...
          if (localObject != null)
          {
            JreFindDialog.SearchPanel.this.add(this, (JREInfo)localObject);
            return true;
          }
        }
