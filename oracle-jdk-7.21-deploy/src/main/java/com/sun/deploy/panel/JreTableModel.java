...
public class JreTableModel extends AbstractTableModel
{
  ...
  public JreTableModel(boolean paramBoolean)
  {
    ...
    localArrayList.add(ResourceManager.getMessage("controlpanel.jre.platformTableColumnTitle"));
    localArrayList.add(ResourceManager.getMessage("controlpanel.jre.productTableColumnTitle"));
    localArrayList.add(ResourceManager.getMessage("controlpanel.jre.locationTableColumnTitle"));
    localArrayList.add(ResourceManager.getMessage("controlpanel.jre.pathTableColumnTitle"));
    localArrayList.add(ResourceManager.getMessage("controlpanel.jre.vmargsTableColumnTitle"));
    if (Platform.get().canUseAlternateJREs())
      localArrayList.add(ResourceManager.getMessage("controlpanel.jre.enabledTableColumnTitle"));
    this._jres = new ArrayList();
    this._validPaths = new ArrayList();
    this._columnNames = ((String[])localArrayList.toArray(new String[localArrayList.size()]));
  ...
  public Object getValueAt(int paramInt1, int paramInt2)
  {
    ...
    return Boolean.valueOf(getJRE(paramInt1).isEnabled());
  }

  public boolean isCellEditable(int paramInt1, int paramInt2)
  {
    if (getJRE(paramInt1).isSystemJRE())
      return false;
    return (paramInt2 != 5) || (getRowCount() != 1);
  }
