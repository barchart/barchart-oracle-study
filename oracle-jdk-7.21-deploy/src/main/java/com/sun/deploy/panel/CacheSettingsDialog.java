...
public class CacheSettingsDialog extends JDialog
{
  ...
  private void initComponents()
  {
    ...
    this.cacheEnabled.addItemListener(new ItemListener()
    {
      ...
      {
        CacheSettingsDialog.this.checkboxStateChanged(paramAnonymousItemEvent);
      }
    });
    ...
    this.chooseBtn.addActionListener(new ActionListener()
    {
      ...
      {
        CacheSettingsDialog.this.chooseButtonActionPerformed(paramAnonymousActionEvent);
      }
    });
    ...
    this.cacheSizeSlider.addChangeListener(new ChangeListener()
    {
      ...
      {
        CacheSettingsDialog.this.sliderStateChanged(paramAnonymousChangeEvent);
      }
    });
    ...
    this.deleteFilesBtn.addActionListener(new ActionListener()
    {
      public void actionPerformed(ActionEvent paramAnonymousActionEvent)
      {
        CacheSettingsDialog.this.deleteFilesBtnActionPerformed(paramAnonymousActionEvent);
      }
    });
    ...
    this.restoreDefaultsBtn.addActionListener(new ActionListener()
    {
      public void actionPerformed(ActionEvent paramAnonymousActionEvent)
      {
        CacheSettingsDialog.this.restoreDefaultsBtnActionPerformed(paramAnonymousActionEvent);
      }
    });
    ...
    this.okBtn.addActionListener(new ActionListener()
    {
      public void actionPerformed(ActionEvent paramAnonymousActionEvent)
      {
        CacheSettingsDialog.this.okBtnActionPerformed(paramAnonymousActionEvent);
      }
    });
    AbstractAction local8 = new AbstractAction()
    {
      public void actionPerformed(ActionEvent paramAnonymousActionEvent)
      {
        CacheSettingsDialog.this.cancelBtnActionPerformed(paramAnonymousActionEvent);
      }
    };
  ...
  private void chooseButtonActionPerformed(ActionEvent paramActionEvent)
  {
    ...
    int i = ResourceManager.getMnemonic("cache.settings.dialog.select");
