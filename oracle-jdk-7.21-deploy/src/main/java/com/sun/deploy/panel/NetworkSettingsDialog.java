  ...
  implements ActionListener
{
  ...
  private void initComponents()
  {
    ...
    addWindowListener(new WindowAdapter()
    {
      ...
      {
        NetworkSettingsDialog.this.closeDialog(paramAnonymousWindowEvent);
      }
    });
    JPanel localJPanel1 = new JPanel();
    localJPanel1.setLayout(new BorderLayout());
    localJPanel1.setBorder(new EmptyBorder(5, 5, 5, 5));
    ...
    this.browserRbutton.setMnemonic(ResourceManager.getMnemonic("network.settings.dlg.browser_rbtn"));
    ...
    this.manualRbutton.setMnemonic(ResourceManager.getMnemonic("network.settings.dlg.manual_rbtn"));
    ...
    this.advancedBtn.setMnemonic(ResourceManager.getMnemonic("network.settings.dlg.advanced_btn"));
    this.advancedBtn.addActionListener(new ActionListener()
    {
      public void actionPerformed(ActionEvent paramAnonymousActionEvent)
      {
        NetworkSettingsDialog.this.advancedBtnActionPerformed(paramAnonymousActionEvent);
      }
    });
    ...
    this.bypassProxyChbox.setMnemonic(ResourceManager.getMnemonic("network.settings.dlg.bypass_text"));
    ...
    this.autoConfigRbutton.setMnemonic(ResourceManager.getMnemonic("network.settings.dlg.autoconfig_rbtn"));
    ...
    this.directRbutton.setMnemonic(ResourceManager.getMnemonic("network.settings.dlg.direct_rbtn"));
    ...
    this.okButton.addActionListener(new ActionListener()
    {
      public void actionPerformed(ActionEvent paramAnonymousActionEvent)
      {
        NetworkSettingsDialog.this.okBtnActionPerformed(paramAnonymousActionEvent);
      }
    });
    ...
    AbstractAction local4 = new AbstractAction()
    {
      public void actionPerformed(ActionEvent paramAnonymousActionEvent)
      {
        NetworkSettingsDialog.this.cancelBtnActionPerformed(paramAnonymousActionEvent);
      }
    };
