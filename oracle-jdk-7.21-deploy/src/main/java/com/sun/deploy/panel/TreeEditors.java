...
public class TreeEditors
{
    ...
    implements TreeCellEditor
  {
    ...
    {
      public void editingStopped(ChangeEvent paramAnonymousChangeEvent)
      {
        ...
        while (localIterator.hasNext())
          ((CellEditorListener)localIterator.next()).editingStopped(paramAnonymousChangeEvent);
      }

      public void editingCanceled(ChangeEvent paramAnonymousChangeEvent)
      {
        Vector localVector = (Vector)TreeEditors.DelegateEditor.this.vListeners.clone();
        Iterator localIterator = localVector.iterator();
        while (localIterator.hasNext())
          ((CellEditorListener)localIterator.next()).editingCanceled(paramAnonymousChangeEvent);
      }
    };
  ...
  private class TextFieldEditor extends TreeEditors.DeployEditor
  {
    ...
    private JButton browse_btn = new JButton(TreeEditors.getMessage("deploy.advanced.browse.browse_btn"));
    ...
    public TextFieldEditor(JTree paramDefaultTreeCellRenderer, DefaultTreeCellRenderer arg3)
    {
      ...
      this.browse_btn.setMnemonic(ResourceManager.getMnemonic("deploy.advanced.browse.browse_btn"));
      ...
      this.browse_btn.addActionListener(new ActionListener()
      {
        ...
        public void actionPerformed(ActionEvent paramAnonymousActionEvent)
        {
          ...
          localJFileChooser.setDialogTitle(TreeEditors.getMessage("deploy.advanced.browse.title"));
          localJFileChooser.setApproveButtonText(TreeEditors.getMessage("deploy.advanced.browse.select"));
          String str1 = TreeEditors.getMessage("deploy.advanced.browse.select_tooltip");
          localJFileChooser.setApproveButtonToolTipText(str1);
          int i = ResourceManager.getMnemonic("deploy.advanced.browse.select");
