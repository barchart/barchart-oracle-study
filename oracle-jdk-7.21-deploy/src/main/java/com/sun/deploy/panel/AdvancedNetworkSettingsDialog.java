...
public class AdvancedNetworkSettingsDialog extends JDialog
{
  ...
  private void initComponents()
  {
    ...
    localJPanel2.setBorder(new EmptyBorder(15, 15, 15, 15));
    ...
    this.useForAllChBox.addItemListener(new ItemListener()
    {
      ...
      {
        AdvancedNetworkSettingsDialog.this.useForAllChBoxItemStateChanged(paramAnonymousItemEvent);
      }
    });
    ...
    localJPanel9.setBorder(new EmptyBorder(15, 15, 15, 15));
    ...
    this.okButton.addActionListener(new ActionListener()
    {
      ...
      {
        AdvancedNetworkSettingsDialog.this.okButtonActionPerformed(paramAnonymousActionEvent);
      }
    });
