...
public class TreeRenderers
{
  private static final DefaultTreeCellRenderer _renderer = new DefaultTreeCellRenderer()
  {
    ...
    {
      public void paintBorder(Graphics paramAnonymous2Graphics)
      {
        getBorder().paintBorder(this, paramAnonymous2Graphics, 0, 0, getWidth(), getHeight());
      }

      public void paint(Graphics paramAnonymous2Graphics)
      {
        super.paint(paramAnonymous2Graphics);
      }
    };
    ...
    {
      Object localObject;
      if ((paramAnonymousObject instanceof ToggleProperty))
      {
        localObject = (ToggleProperty)paramAnonymousObject;
        ...
        this._checkBox.setFont(paramAnonymousJTree.getFont());
        this._checkBox.setEnabled(!Config.get().isPropertyLocked(((ToggleProperty)localObject).getPropertyName()));
        this._checkBox.setRequestFocusEnabled(paramAnonymousBoolean4);
      ...
      if ((paramAnonymousObject instanceof RadioProperty))
      {
        localObject = (RadioProperty)paramAnonymousObject;
        ...
        this._radio.setFont(paramAnonymousJTree.getFont());
        ...
        this._radio.setRequestFocusEnabled(paramAnonymousBoolean4);
      ...
      if ((paramAnonymousObject instanceof TextFieldProperty))
      {
        localObject = (TextFieldProperty)paramAnonymousObject;
        ...
        this._path.setFont(paramAnonymousJTree.getFont());
      ...
      this._label.setFont(paramAnonymousJTree.getFont());
      this._label.setText(String.valueOf(paramAnonymousObject));
