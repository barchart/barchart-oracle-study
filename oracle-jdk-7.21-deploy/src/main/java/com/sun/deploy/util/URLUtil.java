...
public class URLUtil
{
  ...
  private static final ThreadLocal packURLOriginal = new ThreadLocal();
  ...
  public static int getPort(URL paramURL)
  {
  ...
  public static URL getPack200URL(URL paramURL, boolean paramBoolean)
  {
    URL localURL = null;
    if (paramURL == null)
      return null;
