  ...
  implements Cloneable
{
  ...
  private static List jnlpProps = Arrays.asList(new Object[] { "jnlp.packEnabled", "jnlp.versionEnabled", "jnlp.concurrentDownloads" });
  ...
  private static void collectsJnlpProperties(String paramString1, String paramString2, AppContext paramAppContext)
  {
    ...
    if (paramString1.equals("jnlp.concurrentDownloads"))
    {
      ...
      if (i > 10)
        i = 10;
      localObject = SystemUtils.integerValueOf(i);
    }
