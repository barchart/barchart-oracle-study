...
public class JVMParameters
{
  ...
  {
    return getCommandLineArguments(paramBoolean1, true, paramBoolean2, true, false, -1);
  }

  public List getCommandLineArguments(boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4, boolean paramBoolean5, int paramInt)
  {
    int j = 0;
    if (paramInt < 0)
      paramInt = 2147483647;
    ...
    if (paramBoolean2)
    {
      ...
      while ((j < paramInt) && (((Iterator)localObject1).hasNext()))
      {
        ...
        if ((!paramBoolean5) || ((!((String)localObject2).startsWith("-Xbootclasspath/a")) && (!((String)localObject2).startsWith("-Djava.class.path"))))
        {
  ...
  {
    return StringQuoteUtil.getStringByCommandList(getCommandLineArguments(false, paramBoolean, false, true, false, -1));
  }
  ...
  public void setHtmlJavaArgs(boolean paramBoolean)
  {
    this.isHtmlJavaArguments = paramBoolean;
  }
  ...
  public static void setRunningJVMParameters(JVMParameters paramJVMParameters)
  {
    ...
    if (paramJVMParameters != null)
      runningJVMParameters.setHtmlJavaArgs(paramJVMParameters.isHtmlJavaArgs());
  }
  ...
  static class ArgumentSet
  {
    ...
    public void addAll(Properties paramProperties)
    {
      ...
      while (localEnumeration.hasMoreElements())
      {
        ...
        String str3 = (String)JVMParameters.knownDefaultValues.get(str1);
    ...
    public boolean addArgument(String paramString, boolean paramBoolean)
    {
      ...
      if (paramBoolean)
      {
        ...
        if (localProperty != null)
        {
          if ((JVMParameters.knownDefaultValues.containsKey(localProperty.getKey())) && (JVMParameters.knownDefaultValues.get(localProperty.getKey()).equals(localProperty.getValue())))
            return true;
