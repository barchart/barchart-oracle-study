...
public class AssociationService
{
  ...
  public AssociationService(LocalApplicationProperties paramLocalApplicationProperties)
  {
    this.appAssocReader = AppAssociationReaderFactory.newInstance(paramLocalApplicationProperties);
    this.appAssocWriter = AppAssociationWriterFactory.newInstance(paramLocalApplicationProperties);
  }
  ...
  {
    return this.appAssocReader.getAssociations();
  }
}
