...
public class DefaultConfig extends EmptyConfig
{
  ...
  public boolean init(String paramString1, String paramString2)
  {
    _inInit = true;
    clear();
    setProperty("deployment.webjava.enabled", "true");
    ...
    setProperty("deployment.user.security.sandbox.certs", USEC_SANDBOX_CERTS_DEF);
    ...
    setProperty("deployment.user.security.blacklisted.certs", USEC_BLACKLIST_CERTS_DEF);
    setProperty("deployment.user.security.blacklist.dynamic", USEC_DYNAMIC_BLACKLIST_DEF);
    ...
    setProperty("deployment.macosx.check.update", "true");
    setProperty("deployment.javafx.mode.enabled", "true");
    setProperty("deployment.baseline.url", "https://javadl-esd-secure.oracle.com/update/baseline.version");
    setProperty("deployment.blacklist.url", "https://javadl-esd-secure.oracle.com/update/blacklist");
    setProperty("deployment.blacklisted.certs.url", "https://javadl-esd-secure.oracle.com/update/blacklisted.certs");
    ...
    setProperty("deployment.security.disable", "false");
    setProperty("deployment.security.run.untrusted", "PROMPT");
    setProperty("deployment.security.local.applets", "PROMPT");
    setProperty("deployment.security.sandbox.casigned", "PROMPT");
    setProperty("deployment.security.sandbox.selfsigned", "PROMPT");
