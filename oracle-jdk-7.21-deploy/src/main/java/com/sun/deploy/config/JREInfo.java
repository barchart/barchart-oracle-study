...
public class JREInfo
{
  ...
  public JREInfo(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    String str1 = Environment.getenv("FORCED_FX_ROOT");
    this._jfxRuntime = (str1 != null ? JfxRuntime.runtimeForPath(str1) : null);
    if (this._jfxRuntime == null)
    {
      this._jfxRuntime = JfxRuntime.runtimeForPath(paramString4);
      if (this._jfxRuntime == null)
      {
        String str2 = Config.getJavaHome(paramString4);
        this._jfxRuntime = JfxRuntime.runtimeForPath(str2);
        if (this._jfxRuntime == null)
  ...
  {
    JREInfo[] arrayOfJREInfo = getAll();
    for (int i = 0; i < arrayOfJREInfo.length; i++)
      addJRE(new JREInfo(arrayOfJREInfo[i]), true);
  }
  ...
  public static JREInfo findByJREPath(String paramString)
  {
    if ((paramString == null) || (_jres == null))
      return null;
    ListIterator localListIterator = _jres.listIterator();
    while (localListIterator.hasNext())
    {
      JREInfo localJREInfo = (JREInfo)localListIterator.next();
      String str = Config.getJavaHome(localJREInfo.getPath());
  ...
  public static JREInfo[] getAll()
  {
    ...
    try
    {
      arrayOfJREInfo = (JREInfo[])_jres.toArray(new JREInfo[0]);
    }
    finally
    {
      localLock.release();
  ...
  public static boolean setInstalledJREList(Vector paramVector)
  {
    ...
    try
    {
      for (int i = 0; i < paramVector.size(); i += 2)
      {
        String str1 = (String)paramVector.get(i);
        String str2 = (String)paramVector.get(i + 1);
        if (str1.lastIndexOf(".") > 2)
        {
          ...
          int j = findJREByPath_int(localJREInfo, _jres);
          if (j < 0)
          {
          ...
          {
            ((JREInfo)_jres.get(j)).setRegistered(true);
          }
        }
      }
      validateJREs_int();
