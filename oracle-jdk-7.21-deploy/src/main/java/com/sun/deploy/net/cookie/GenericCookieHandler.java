  ...
  implements CookieHandler
{
  ...
  public static void main(String[] paramArrayOfString)
  {
    try
    {
      ...
      URL localURL1 = new URL("http://oracle.com/bar/index.html");
      URL localURL2 = new URL("http://oracle.com");
      URL localURL3 = new URL("http://oracle.com/xyz/bar/index.html");
      URL localURL4 = new URL("https://oracle.com");
      URL localURL5 = new URL("https://oracle.com/foo/xyz/index.html");
      URL localURL6 = new URL("https://oracle.com/foobar/xyz/index.html");
      URL localURL7 = new URL("https://oracle.com/xyz/foo/index.html");
