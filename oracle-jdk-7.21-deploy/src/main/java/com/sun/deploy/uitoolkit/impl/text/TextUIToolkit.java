...
public class TextUIToolkit extends UIToolkit
{
  ...
  public SecurityManager getSecurityManager()
  {
    ...
    try
    {
      localSecurityManager = (SecurityManager)ReflectionUtil.createInstance("sun.plugin2.applet.FXAppletSecurityManager", Thread.currentThread().getContextClassLoader());
    }
