  ...
  public SwingConsoleWindow(ConsoleController paramConsoleController)
  {
    ...
    if (OSType.isMac())
      this.scroller.setBorder(new Border()
      {
        ...
        {
          paramAnonymousGraphics.setColor(Color.gray);
          paramAnonymousGraphics.drawLine(0, paramAnonymousInt4 - 1, paramAnonymousInt3, paramAnonymousInt4 - 1);
        }
    ...
    ActionListener local6 = new ActionListener()
    {
      private final ConsoleController val$controller;
    ...
    ActionListener local7 = new ActionListener()
    {
      private final ConsoleController val$controller;
    ...
    ActionListener local9 = new ActionListener()
    {
      private final ConsoleController val$controller;
    ...
    ActionListener local10 = new ActionListener()
    {
      private final ConsoleController val$controller;
    ...
    ActionListener local11 = new ActionListener()
    {
      private final ConsoleController val$controller;
    ...
    ActionListener local12 = new ActionListener()
    {
      public void actionPerformed(ActionEvent paramAnonymousActionEvent)
      {
    ...
    ActionListener local13 = new ActionListener()
    {
      public void actionPerformed(ActionEvent paramAnonymousActionEvent)
      {
    ...
    ActionListener local16 = new ActionListener()
    {
      ...
      public void actionPerformed(ActionEvent paramAnonymousActionEvent)
      {
        ...
        Trace.println(ResourceManager.getMessage("console.completed"));
        this.val$showMemory.actionPerformed(paramAnonymousActionEvent);
      }
    };
    ...
    ActionListener local19 = new ActionListener()
    {
      public void actionPerformed(ActionEvent paramAnonymousActionEvent)
      {
    ...
    ActionListener local20 = new ActionListener()
    {
      public void actionPerformed(ActionEvent paramAnonymousActionEvent)
      {
    ...
    ActionListener local21 = new ActionListener()
    {
      public void actionPerformed(ActionEvent paramAnonymousActionEvent)
      {
    ...
    ActionListener local22 = new ActionListener()
    {
      public void actionPerformed(ActionEvent paramAnonymousActionEvent)
      {
    ...
    ActionListener local23 = new ActionListener()
    {
      public void actionPerformed(ActionEvent paramAnonymousActionEvent)
      {
    ...
    ActionListener local24 = new ActionListener()
    {
      private final ConsoleController val$controller;
    ...
    if (paramConsoleController.isDumpStackSupported())
      this.textArea.registerKeyboardAction(local3, KeyStroke.getKeyStroke(86, 0), 2);
    if (paramConsoleController.isProxyConfigReloadSupported())
      this.textArea.registerKeyboardAction(local7, KeyStroke.getKeyStroke(80, 0), 2);
    if (paramConsoleController.isSecurityPolicyReloadSupported())
      this.textArea.registerKeyboardAction(local6, KeyStroke.getKeyStroke(82, 0), 2);
    if (paramConsoleController.isClearClassLoaderSupported())
      this.textArea.registerKeyboardAction(local11, KeyStroke.getKeyStroke(88, 0), 2);
    if (paramConsoleController.isDumpClassLoaderSupported())
      this.textArea.registerKeyboardAction(local10, KeyStroke.getKeyStroke(76, 0), 2);
    if (paramConsoleController.isLoggingSupported())
      this.textArea.registerKeyboardAction(local24, KeyStroke.getKeyStroke(79, 0), 2);
    this.textArea.registerKeyboardAction((ActionListener)localObject, KeyStroke.getKeyStroke(84, 0), 2);
    this.textArea.registerKeyboardAction(local8, KeyStroke.getKeyStroke(83, 0), 2);
    this.textArea.registerKeyboardAction(local9, KeyStroke.getKeyStroke(72, 0), 2);
    this.textArea.registerKeyboardAction(local15, KeyStroke.getKeyStroke(77, 0), 2);
    this.textArea.registerKeyboardAction(local12, KeyStroke.getKeyStroke(67, 0), 2);
    this.textArea.registerKeyboardAction(local17, KeyStroke.getKeyStroke(71, 0), 2);
    this.textArea.registerKeyboardAction(local16, KeyStroke.getKeyStroke(70, 0), 2);
    this.textArea.registerKeyboardAction(local14, KeyStroke.getKeyStroke(81, 0), 2);
    this.textArea.registerKeyboardAction(local18, KeyStroke.getKeyStroke(48, 0), 2);
    this.textArea.registerKeyboardAction(local19, KeyStroke.getKeyStroke(49, 0), 2);
    this.textArea.registerKeyboardAction(local20, KeyStroke.getKeyStroke(50, 0), 2);
    this.textArea.registerKeyboardAction(local21, KeyStroke.getKeyStroke(51, 0), 2);
    this.textArea.registerKeyboardAction(local22, KeyStroke.getKeyStroke(52, 0), 2);
    this.textArea.registerKeyboardAction(local23, KeyStroke.getKeyStroke(53, 0), 2);
    ...
    localJButton1.addActionListener(local12);
    localJButton2.addActionListener(local13);
    localJButton3.addActionListener(local14);
  }
