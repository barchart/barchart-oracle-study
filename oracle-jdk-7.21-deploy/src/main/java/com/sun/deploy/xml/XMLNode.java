...
public class XMLNode
{
  ...
  public boolean equalsTemplate(Object paramObject)
  {
    ...
    boolean bool = (matchTemplateName(localXMLNode._name)) && (matchTemplateAttribute(this._attr, localXMLNode._attr)) && (matchTemplateNode(this._nested, localXMLNode._nested)) && (matchTemplateNode(this._next, localXMLNode._next));
    return bool;
  }
  ...
  public boolean equals(Object paramObject)
  {
    if ((paramObject == null) || (!(paramObject instanceof XMLNode)))
      return false;
    XMLNode localXMLNode = (XMLNode)paramObject;
    boolean bool = (match(this._name, localXMLNode._name)) && (match(this._attr, localXMLNode._attr)) && (match(this._nested, localXMLNode._nested)) && (match(this._next, localXMLNode._next));
    return bool;
  }
