...
public class UIFactory
{
  ...
  public static int showSecurityDialog(AppInfo paramAppInfo, String paramString1, String paramString2, String paramString3, URL paramURL, boolean paramBoolean1, boolean paramBoolean2, String paramString4, String paramString5, String[] paramArrayOfString1, String[] paramArrayOfString2, boolean paramBoolean3, Certificate[] paramArrayOfCertificate, int paramInt1, int paramInt2, boolean paramBoolean4, boolean paramBoolean5, boolean paramBoolean6)
  {
    ...
    try
    {
      int i = ((Integer)DeploySysRun.executePrivileged(new DeploySysAction()
      {
        ...
        private final boolean val$sandboxApp;
          ...
          throws Exception
        {
          ...
          arrayOfString = UIFactory.addDetail(arrayOfString, this.val$ainfo, true, true);
          ...
          else
          {
            String str1 = "";
            String str2 = "";
            if ((this.val$majorWarning) && (!this.val$httpsDialog))
            {
              str1 = ResourceManager.getString("security.dialog.accept.title");
              str2 = ResourceManager.getString("security.dialog.accept.text");
            }
            localDialogTemplate.setNewSecurityContent(this.val$showAlways, this.val$checkAlways, this.val$okBtnStr, this.val$cancelBtnStr, this.val$securityAlerts, arrayOfString, i, this.val$showMoreInfo, this.val$certs, this.val$start, this.val$end, this.val$majorWarning, str1, str2, this.val$httpsDialog, this.val$sandboxApp);
          }
  ...
  public static int showIntegrationDialog(Component paramComponent, AppInfo paramAppInfo)
  {
    ...
    try
    {
      int i = ((Integer)DeploySysRun.execute(new DeploySysAction()
      {
        private final AppInfo val$ainfo;
          ...
          throws Exception
        {
          ...
          arrayOfString2 = UIFactory.addDetail(arrayOfString2, this.val$ainfo, false, true);
          String[] arrayOfString3 = new String[0];
          arrayOfString3 = UIFactory.addDetail(arrayOfString3, this.val$ainfo, true, false);
  ...
  public static int showPublisherInfo(Component paramComponent, AppInfo paramAppInfo, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, JPanel paramJPanel)
  {
    Component localComponent = beforeDialog(paramComponent);
    try
    {
      int i = ((Integer)DeploySysRun.executePrivileged(new DeploySysAction()
      {
        ...
        {
          DialogTemplate localDialogTemplate = new DialogTemplate(this.val$ainfo, this.val$fOwner, this.val$title, this.val$masthead, false);
          localDialogTemplate.setPublisherInfo(this.val$message, this.val$okBtnStr, this.val$detailBtnStr, this.val$detailPanel, false);
          UIFactory.placeWindow(localDialogTemplate.getDialog());
          localDialogTemplate.setVisible(true);
          int i = localDialogTemplate.getUserAnswer();
          localDialogTemplate.disposeDialog();
  ...
  public static CredentialInfo showPasswordDialog(Component paramComponent, String paramString1, String paramString2, boolean paramBoolean1, boolean paramBoolean2, CredentialInfo paramCredentialInfo, boolean paramBoolean3, String paramString3)
  {
    ...
    try
    {
      CredentialInfo localCredentialInfo = (CredentialInfo)DeploySysRun.executePrivileged(new DeploySysAction()
      {
  ...
  public static void showExceptionDialog(Component paramComponent, Throwable paramThrowable, String paramString1, String paramString2, String paramString3)
  {
    ...
    String str2 = ResourceManager.getString("common.detail.button");
    if (paramString2 == null)
      paramString2 = SystemUtils.getSimpleName(paramThrowable.getClass()) + ": " + paramThrowable.getLocalizedMessage();
  ...
  public static int showWarningDialog(Component paramComponent, AppInfo paramAppInfo, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, URL paramURL, String paramString6, int paramInt)
  {
    AppInfo localAppInfo = paramAppInfo == null ? new AppInfo() : paramAppInfo;
    Component localComponent = beforeDialog(paramComponent);
    try
    {
      int i = ((Integer)DeploySysRun.executePrivileged(new DeploySysAction()
      {
        ...
        private final String val$title;
        private final String val$masthead;
        private final int val$defaultButton;
        private final String val$okBtnStr;
        private final String val$cancelBtnStr;
        private final String val$message;
          ...
          throws Exception
        {
          ...
          DialogTemplate localDialogTemplate = new DialogTemplate(this.val$ainfo, this.val$fOwner, this.val$title, this.val$masthead, bool, true, this.val$defaultButton);
          if (bool)
  ...
  public static int showSSV3Dialog(Object paramObject, AppInfo paramAppInfo, int paramInt, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7, String paramString8, String paramString9, String paramString10, String paramString11, URL paramURL)
  {
    ...
    try
    {
      int i = ((Integer)DeploySysRun.executePrivileged(new DeploySysAction()
      {
        ...
        private final String val$mastheadKey;
        private final String val$mainTextKey;
        private final String val$locationKey;
        private final String val$promptKey;
        private final String val$multiPromptKey;
        private final String val$multiTextKey;
        private final String val$runKey;
        private final String val$updateKey;
        private final String val$cancelKey;
        private final String val$alwaysTextKey;
        private final URL val$updateURL;

        public Object execute()
          throws Exception
        {
          DialogTemplate localDialogTemplate = new DialogTemplate(this.val$ainfo, this.val$parent, ResourceManager.getMessage(this.val$titleKey), ResourceManager.getMessage(this.val$mastheadKey), true);
          SSV3DialogContent localSSV3DialogContent = new SSV3DialogContent(this.val$ainfo, this.val$titleKey, this.val$mastheadKey, this.val$mainTextKey, this.val$locationKey, this.val$promptKey, this.val$multiPromptKey, this.val$multiTextKey, this.val$runKey, this.val$updateKey, this.val$cancelKey, this.val$alwaysTextKey, this.val$updateURL, localDialogTemplate);
          localDialogTemplate.setSSV3Content(localSSV3DialogContent);
          UIFactory.placeWindow(localDialogTemplate.getDialog());
          localDialogTemplate.setVisible(true);
          int i = localSSV3DialogContent.getAnswer();
          localDialogTemplate.disposeDialog();
          return new Integer(i);
        }
      }
  ...
  public static JPanel getDetailPanel(String paramString)
  {
    ...
    local22.setLayout(new BorderLayout());
    JTabbedPane localJTabbedPane = new JTabbedPane();
    local22.add(localJTabbedPane, "Center");
    ...
    local22.add(localJPanel1, "North");
    int i = 1;
