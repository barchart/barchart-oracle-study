  ...
  implements DialogInterface
{
  ...
  {
    this.noBorder = paramBoolean;
  }

  public void setMouseListener(boolean paramBoolean)
  {
    this.setMouseListener = paramBoolean;
  }
  ...
  private void addMouseListener()
  {
    if ((this.dialog != null) && (this.setMouseListener))
    {
      ...
      this.dialog.addMouseListener(new MouseAdapter()
      {
        ...
        {
          this.val$point.x = paramAnonymousMouseEvent.getX();
          this.val$point.y = paramAnonymousMouseEvent.getY();
        }
      });
      this.dialog.addMouseMotionListener(new MouseMotionAdapter()
      {
        ...
        {
          Point localPoint = DialogHelper.this.dialog.getLocationOnScreen();
          DialogHelper.this.dialog.setLocation(localPoint.x + paramAnonymousMouseEvent.getX() - this.val$point.x, localPoint.y + paramAnonymousMouseEvent.getY() - this.val$point.y);
        }
      });
    }
  }
