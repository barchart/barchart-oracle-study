  ...
  implements ActionListener, ImageLoaderCallback
{
  ...
  {
    this(paramAppInfo, paramComponent, paramString1, paramString2, paramBoolean1, paramBoolean2, 0);
  }

  DialogTemplate(AppInfo paramAppInfo, Component paramComponent, String paramString1, String paramString2, boolean paramBoolean1, boolean paramBoolean2, int paramInt)
  {
    ...
    this.defaultButton = paramInt;
    this.appFrom = paramAppInfo.getDisplayFrom();
  }
  ...
  void setSecurityContent(boolean paramBoolean1, boolean paramBoolean2, String paramString1, String paramString2, String[] paramArrayOfString1, String[] paramArrayOfString2, int paramInt1, boolean paramBoolean3, Certificate[] paramArrayOfCertificate, int paramInt2, int paramInt3, boolean paramBoolean4)
  {
    ...
    try
    {
      ...
      if (paramBoolean1)
        this.alwaysString = getMessage("security.dialog.always");
  ...
  void setNewSecurityContent(boolean paramBoolean1, boolean paramBoolean2, String paramString1, String paramString2, String[] paramArrayOfString1, String[] paramArrayOfString2, int paramInt1, boolean paramBoolean3, Certificate[] paramArrayOfCertificate, int paramInt2, int paramInt3, boolean paramBoolean4, String paramString3, String paramString4, boolean paramBoolean5, boolean paramBoolean6)
  {
    ...
    this.sandboxApp = paramBoolean6;
    try
    {
      this.alwaysString = getMessage(paramBoolean6 ? "sandbox.security.dialog.always" : "security.dialog.always");
      ssvSetFonts();
      JPanel localJPanel1 = new JPanel();
      if ((this.alertStrs == null) || (this.alertStrs.length == 0))
      {
        localJPanel1 = createShadedContentBorderPanel(true);
        this.dialogInterface.setUndecorated(true);
        this.dialogInterface.setMouseListener(true);
      }
      else
      {
        localJPanel1 = createShadedContentPanel();
      }
      this.dialogInterface.setContentPane(localJPanel1);
      localJPanel1.setLayout(new BorderLayout());
      localJPanel1.setOpaque(false);
      this.dialogInterface.setModalOnTop(true);
      JPanel localJPanel2 = createSecurityTopPanel(paramBoolean5);
      ...
      {
        if ((this.alertStrs == null) || (this.alertStrs.length == 0))
          localObject = getMessage("security.dialog.https.valid.risk");
        else
          localObject = getMessage("security.dialog.https.mismatch.risk");
        localJPanel3 = createSecurityRiskPanel((String)localObject, true);
        localJPanel4 = createButtonsPanel(paramString1, paramString2);
        localJPanel4.setOpaque(false);
        localJPanel4.setBorder(BorderFactory.createEmptyBorder(0, 0, 0, 16));
      }
      else if (!paramBoolean4)
      {
        localObject = getMessage(paramBoolean6 ? "sandbox.security.dialog.valid.signed.risk" : "security.dialog.valid.signed.risk");
        localJPanel3 = createTrustSecurityRiskPanel((String)localObject);
        localJPanel4 = createTrustSecurityAlwaysPanel(paramBoolean2);
      }
      else
      {
        localJPanel3 = createSecurityRiskPanel(paramArrayOfString1[0], false);
        localJPanel4 = createSecurityAcceptPanel(paramString1, paramString2, paramBoolean2);
      }
      Object localObject = new JPanel(new BorderLayout());
      ((JPanel)localObject).add(localJPanel3, "North");
      ((JPanel)localObject).add(localJPanel4, "South");
      ((JPanel)localObject).setOpaque(false);
      localJPanel1.add((Component)localObject, "Center");
      JPanel localJPanel5 = new JPanel();
      if ((!paramBoolean5) && (!paramBoolean4))
        localJPanel5 = createTrustSecurityBottomPanel(paramString1, paramString2);
      else
        localJPanel5 = createSecurityBottomPanel(paramBoolean5);
  ...
  void setSSV3Content(SSV3DialogContent paramSSV3DialogContent)
  {
    try
    {
      JPanel localJPanel = createShadedContentBorderPanel(false);
      localJPanel.setLayout(new BorderLayout());
      localJPanel.setOpaque(false);
      localJPanel.add(paramSSV3DialogContent.getContent(), "Center");
      this.dialogInterface.setContentPane(localJPanel);
      this.dialogInterface.setModalOnTop(true);
      this.dialogInterface.setResizable(false);
    }
    catch (Throwable localThrowable)
  ...
  void setMixedCodeContent(String paramString1, boolean paramBoolean1, String paramString2, String paramString3, String paramString4, String paramString5, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    String str1 = getMessage("security.dialog.mixcode.info1");
    String str2 = getMessage("security.dialog.mixcode.info2");
    String str3 = getMessage("security.dialog.mixcode.info3");
  ...
  void setPublisherInfo(String paramString1, String paramString2, String paramString3, JPanel paramJPanel, boolean paramBoolean)
  {
    this.contentString = paramString1;
  ...
  private JPanel createThreeButtonsPanel(String paramString1, String paramString2, String paramString3, boolean paramBoolean)
  {
    ...
    localJButton1.setMnemonic(ResourceManager.getMnemonic(paramString1));
    ...
    localJButton2.setMnemonic(ResourceManager.getMnemonic(paramString2));
    ...
    if (paramString3 != null)
    {
      ...
      localJButton3.setMnemonic(ResourceManager.getMnemonic(paramString3));
    ...
    if (paramBoolean)
      localJButton3.setToolTipText(getMessage("autoupdatecheck.masthead"));
  ...
  private JPanel createCenterPanel(boolean paramBoolean1, String paramString1, String paramString2, int paramInt, boolean paramBoolean2)
  {
    ...
    setInfo(this.appTitle, this.appPublisher, this.appURL, this.appFrom);
    ...
    if (this.alwaysString != null)
    {
      ...
      int j = this.always.getBorder().getBorderInsets(this.always).left;
      localJPanel1.setBorder(BorderFactory.createEmptyBorder(0, j, 0, 0));
    ...
    if (this.mixedCodeString != null)
    {
      ...
      localObject1 = new FancyButton(getMessage(str), ResourceManager.getMnemonic(str));
      localObject3 = localFont1.deriveFont(i);
      ((FancyButton)localObject1).setFont((Font)localObject3);
      ((FancyButton)localObject1).addMouseListener(new MouseListener()
      {
        public void mouseClicked(MouseEvent paramAnonymousMouseEvent)
        {
          if ((paramAnonymousMouseEvent.getComponent() instanceof FancyButton))
      ...
      ((FancyButton)localObject1).addActionListener(new ActionListener()
      {
        public void actionPerformed(ActionEvent paramAnonymousActionEvent)
        {
          DialogTemplate.this.showMixedcodeMoreInfo();
      ...
      localJPanel5.add((Component)localObject1, "West");
    ...
    if (this.contentString != null)
    {
      ...
      {
        localObject1 = new JPanel(new BorderLayout());
        ((JPanel)localObject1).add(new JLabel(this.contentLabel), "West");
        localJPanel4.add((Component)localObject1, "North");
      }
      if (this.contentScroll)
      {
        boolean bool = this.largeScroll;
        if (this.largeScroll)
          localObject1 = new JTextArea(this.contentString, 20, 80);
        else
          localObject1 = new JTextArea(this.contentString, 4, 40);
        ((JTextArea)localObject1).setEditable(false);
        localObject3 = new JScrollPane((Component)localObject1, 20, 30)
        {
        ...
        localJPanel4.add((Component)localObject3, "Center");
      }
      else
      {
        localObject1 = new UITextArea(this.contentString);
        ((UITextArea)localObject1).setSize(((UITextArea)localObject1).getPreferredSize());
        localJPanel4.add((Component)localObject1, "Center");
      }
    ...
    if (this.scrollList != null)
    {
      ...
      if (this.contentScroll)
      {
        localObject1 = new JScrollPane(this.scrollList, 20, 30);
        localJPanel4.add((Component)localObject1, "Center");
      }
      if (this.showDetails)
      {
        localObject1 = "security.more.info.details";
        localObject2 = new FancyButton(getMessage((String)localObject1), ResourceManager.getMnemonic((String)localObject1));
        ((FancyButton)localObject2).setFont(localFont2);
        ...
        ((JPanel)localObject3).setBorder(BorderFactory.createEmptyBorder(12, 0, 12, 0));
        ((JPanel)localObject3).setLayout(new FlowLayout(4, 0, 0));
        ((JPanel)localObject3).add((Component)localObject2);
        ((JPanel)localObject3).add(Box.createGlue());
        localJPanel4.add((Component)localObject3, "South");
      }
    }
    Object localObject1 = createButtonsPanel(paramString1, paramString2);
    if (this.cacheUpgradeContentString != null)
    {
      localObject2 = new UITextArea(this.cacheUpgradeContentString);
      ((UITextArea)localObject2).setBorder(null);
    ...
    Object localObject2 = new JPanel(new BorderLayout());
    this.centerPanel.add((Component)localObject2);
    Object localObject3 = new JPanel(new BorderLayout());
    if (k != 0)
    {
      this.progressStatusLabel = new JLabel(" ");
      this.progressStatusLabel.setFont(localFont2);
      ((JPanel)localObject2).add(this.progressStatusLabel, "West");
      this.progressBar.setBorder(BorderFactory.createEmptyBorder(2, 0, 2, 0));
      ((JPanel)localObject3).add(this.progressBar, "Center");
    }
    ((JPanel)localObject3).add((Component)localObject1, "East");
    this.centerPanel.add((Component)localObject3);
    this.dialogInterface.setCancelAction(new AbstractAction()
    {
      public void actionPerformed(ActionEvent paramAnonymousActionEvent)
      {
  ...
  private JPanel createBottomPanel(boolean paramBoolean)
  {
    ...
    if ((this.alertStrs != null) || (this.infoStrs != null))
    {
      ...
      if (paramBoolean)
      {
        ...
        localFancyButton = new FancyButton(getMessage(str2), ResourceManager.getMnemonic(str2));
      ...
      if (((this.alertStrs == null) || (this.alertStrs.length == 0)) && (this.infoStrs != null) && (this.infoStrs.length != 0))
      {
        ...
        {
          arrayOfString = new String[this.infoStrs.length - 1];
          for (m = 0; m < arrayOfString.length; m++)
            arrayOfString[m] = this.infoStrs[(m + 1)];
      ...
      else if ((this.alertStrs != null) && (this.alertStrs.length != 0))
      {
        ...
        {
          arrayOfString = new String[this.alertStrs.length - 1];
          for (m = 0; m < arrayOfString.length; m++)
            arrayOfString[m] = this.alertStrs[(m + 1)];
  ...
  JPanel createButtonsPanel(String paramString1, String paramString2)
  {
    JPanel localJPanel = new JPanel();
    localJPanel.setLayout(new FlowLayout(4, 0, 0));
    this.okBtn = new JButton(paramString1 == null ? "" : getMessage(paramString1));
    this.okBtn.addActionListener(this);
    this.okBtn.setActionCommand("OK");
    localJPanel.add(this.okBtn);
    ...
    localJPanel.add(this.cancelBtn);
  ...
  private void ssvSetFonts()
  {
    if (this.ssvFont == null)
    {
      ...
      this.ssvBold = localJLabel.getFont().deriveFont(1, k);
      this.ssvBigFont = localJLabel.getFont().deriveFont(0, m);
      this.ssvBigBoldFont = localJLabel.getFont().deriveFont(1, m);
    }
  }

  static JPanel createShadedContentBorderPanel(boolean paramBoolean)
  {
    JPanel local15 = new JPanel()
    {
      private final boolean val$roundedBorders;
      ...
      protected void paintBorder(Graphics paramAnonymousGraphics)
      {
        if (this.val$roundedBorders)
        {
          Graphics2D localGraphics2D = (Graphics2D)paramAnonymousGraphics;
          localGraphics2D.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
          localGraphics2D.setColor(new Color(116, 116, 116));
          localGraphics2D.drawRoundRect(0, 0, getWidth() - 2, getHeight() - 2, 20, 20);
        }
        super.paintBorder(paramAnonymousGraphics);
      }
    };
    return local15;
  }
  ...
  private JPanel createMessageClosePanel(JLabel paramJLabel)
  {
    JPanel localJPanel1 = new JPanel(new BorderLayout());
    localJPanel1.setOpaque(false);
    localJPanel1.setBorder(BorderFactory.createEmptyBorder());
    ImageIcon localImageIcon = ResourceManager.getIcon("close_box_normal.image");
    ...
    localJButton.setPreferredSize(new Dimension(10, 10));
    ...
    JPanel localJPanel3 = new JPanel(new BorderLayout());
    localJPanel3.setOpaque(false);
    localJPanel3.setPreferredSize(new Dimension(300, 20));
    localJPanel3.add(paramJLabel, "West");
    localJPanel1.add(localJPanel2, "North");
    localJPanel1.add(localJPanel3, "Center");
    return localJPanel1;
  }

  private JPanel createSecurityTopPanel(boolean paramBoolean)
  {
    JPanel localJPanel1 = new JPanel(new BorderLayout());
    localJPanel1.setOpaque(false);
    ...
    if (paramBoolean)
    {
      ...
      localObject2 = new JLabel(getMessage("dialog.template.continue"));
      ((JLabel)localObject2).setOpaque(false);
      ((JLabel)localObject2).setFont(this.ssvBigBoldFont);
      localJLabel1.setFont(this.ssvFont);
      ((JPanel)localObject1).add((Component)localObject2, "North");
      ((JPanel)localObject1).add(localJLabel1, "South");
      localJPanel1.setBorder(BorderFactory.createEmptyBorder(16, 16, 0, 16));
      localJPanel1.add((Component)localObject1, "North");
    }
    else
    {
      ...
      {
        localJPanel1.setBorder(BorderFactory.createEmptyBorder(8, 16, 0, 8));
        localObject1 = createMessageClosePanel(localJLabel1);
        localJPanel1.add((Component)localObject1, "North");
      }
      else
      {
    ...
    Object localObject2 = new GridBagConstraints();
    JPanel localJPanel2 = new JPanel();
    localJPanel2.setOpaque(false);
    localJPanel2.setLayout((LayoutManager)localObject1);
    ...
    String str = getMessage(paramBoolean ? "dialog.template.website" : "dialog.template.from");
    JLabel localJLabel4 = new JLabel(str);
    ...
    ((GridBagConstraints)localObject2).gridwidth = 1;
    ((GridBagConstraints)localObject2).anchor = 17;
    ((GridBagConstraints)localObject2).insets = new Insets(0, 32, 0, 12);
    ((GridBagConstraints)localObject2).weightx = 0.0D;
    if ((this.appTitle != null) && (!paramBoolean))
    {
      ((GridBagLayout)localObject1).setConstraints(localJLabel2, (GridBagConstraints)localObject2);
      localJPanel2.add(localJLabel2);
      ((GridBagConstraints)localObject2).insets = new Insets(0, 0, 0, 12);
      ((GridBagConstraints)localObject2).gridx = -1;
      ((GridBagConstraints)localObject2).gridwidth = 0;
      ((GridBagConstraints)localObject2).weightx = 1.0D;
      ((GridBagLayout)localObject1).setConstraints(this.nameInfo, (GridBagConstraints)localObject2);
      localJPanel2.add(this.nameInfo);
    }
    if ((this.appPublisher != null) && (!paramBoolean))
    {
      ((GridBagConstraints)localObject2).fill = 2;
      ((GridBagConstraints)localObject2).insets = new Insets(12, 32, 0, 12);
      ((GridBagConstraints)localObject2).gridwidth = 1;
      ((GridBagConstraints)localObject2).weightx = 0.0D;
      ((GridBagConstraints)localObject2).anchor = 17;
      ((GridBagLayout)localObject1).setConstraints(localJLabel3, (GridBagConstraints)localObject2);
      localJPanel2.add(localJLabel3);
      ((GridBagConstraints)localObject2).insets = new Insets(12, 0, 0, 12);
      ((GridBagConstraints)localObject2).gridwidth = 0;
      ((GridBagConstraints)localObject2).weightx = 1.0D;
      ((GridBagLayout)localObject1).setConstraints(this.publisherInfo, (GridBagConstraints)localObject2);
      localJPanel2.add(this.publisherInfo);
    }
    if (((paramBoolean) || (this.appTitle != null)) && (this.appURL != null))
    {
      ((GridBagConstraints)localObject2).fill = 2;
      ((GridBagConstraints)localObject2).weightx = 0.0D;
      ((GridBagConstraints)localObject2).gridwidth = 1;
      ((GridBagConstraints)localObject2).anchor = 17;
      ((GridBagConstraints)localObject2).insets = new Insets(12, 32, 0, 12);
      ((GridBagLayout)localObject1).setConstraints(localJLabel4, (GridBagConstraints)localObject2);
      localJPanel2.add(localJLabel4);
      ((GridBagConstraints)localObject2).insets = new Insets(12, 0, 0, 12);
      ((GridBagConstraints)localObject2).gridwidth = 0;
      ((GridBagConstraints)localObject2).weightx = 1.0D;
      ((GridBagLayout)localObject1).setConstraints(this.urlInfo, (GridBagConstraints)localObject2);
    ...
    if (this.alertStrs != null)
      ...
      localJLabel5.setIcon(ResourceManager.getIcon("java48s.image"));
  ...
  private JPanel createTrustSecurityRiskPanel(String paramString)
  {
    JPanel localJPanel = new JPanel(new BorderLayout());
    localJPanel.setOpaque(false);
    localJPanel.setBorder(BorderFactory.createEmptyBorder(0, 16, 16, 16));
    JSmartTextArea localJSmartTextArea = new JSmartTextArea(paramString);
    ...
    localJPanel.add(localJSmartTextArea, "North");
    return localJPanel;
  }

  private JPanel createSecurityRiskPanel(String paramString, boolean paramBoolean)
  {
    JPanel localJPanel1 = new JPanel(new BorderLayout());
    localJPanel1.setOpaque(false);
    localJPanel1.setBorder(BorderFactory.createEmptyBorder(0, 8, 8, 12));
    ...
    if (i < paramString.length() - 2)
    {
      ...
      JPanel localJPanel3 = new JPanel(new BorderLayout());
      localJPanel3.setOpaque(false);
      JSmartTextArea localJSmartTextArea1 = new JSmartTextArea(str2);
      localJSmartTextArea1.setFont(this.ssvSmallFont);
      localJSmartTextArea1.setLineWrap(true);
      localJSmartTextArea1.setWrapStyleWord(true);
      localJSmartTextArea1.setOpaque(false);
      localJSmartTextArea1.setBorder(BorderFactory.createEmptyBorder(0, 5, 0, 0));
      localJPanel3.add(localJSmartTextArea1, "North");
      String str3 = "dialog.template.more.info2";
      FancyButton localFancyButton = new FancyButton(getMessage(str3), ResourceManager.getMnemonic(str3));
      ...
      if (!paramBoolean)
      {
        JSmartTextArea localJSmartTextArea2 = new JSmartTextArea(getMessage("dialog.security.risk.warning"));
        localJSmartTextArea2.setFont(this.ssvBold);
        localJSmartTextArea2.setForeground(new Color(204, 0, 0));
        localJSmartTextArea2.setLineWrap(true);
        localJSmartTextArea2.setWrapStyleWord(true);
        localJSmartTextArea2.setOpaque(false);
        Box localBox1 = Box.createVerticalBox();
        localBox1.add(localJSmartTextArea2);
        localBox1.add(Box.createVerticalStrut(10));
        Box localBox2 = Box.createHorizontalBox();
        localBox2.add(Box.createHorizontalStrut(8));
        localBox2.add(localBox1);
        localJPanel1.add(localBox2, "North");
      }
  ...
  private JPanel createTrustSecurityAlwaysPanel(boolean paramBoolean)
  {
    JPanel localJPanel = new JPanel(new BorderLayout());
    localJPanel.setOpaque(false);
    localJPanel.setBorder(BorderFactory.createEmptyBorder(0, 16, 0, 16));
    this.always = new JCheckBox(this.alwaysString);
    this.always.setMnemonic(ResourceManager.getMnemonic("security.dialog.always"));
    this.always.setFont(this.ssvSmallFont);
    this.always.setOpaque(false);
    this.always.setSelected(paramBoolean);
    localJPanel.add(this.always, "North");
    return localJPanel;
  }

  private JPanel createSecurityAcceptPanel(String paramString1, String paramString2, boolean paramBoolean)
  {
    JPanel localJPanel1 = new JPanel(new BorderLayout());
    localJPanel1.setOpaque(false);
    ...
    localJCheckBox.setMnemonic(ResourceManager.getMnemonic(str));
    localJCheckBox.setSelected(paramBoolean);
    JPanel localJPanel4 = new JPanel();
  ...
  private JPanel createTrustSecurityBottomPanel(String paramString1, String paramString2)
  {
    JPanel localJPanel1 = new JPanel(new BorderLayout());
    localJPanel1.setOpaque(false);
    localJPanel1.setBorder(BorderFactory.createEmptyBorder(16, 16, 16, 16));
    String str = "dialog.template.more.info2";
    FancyButton localFancyButton = new FancyButton(getMessage(str), ResourceManager.getAcceleratorKey(str));
    localFancyButton.setOpaque(false);
    localFancyButton.setFont(this.ssvSmallFont);
    localFancyButton.addMouseListener(new MouseListener()
    {
    ...
    if (this.alertStrs != null)
    {
      localObject1 = getMessage(this.sandboxApp ? "sandbox.security.dialog.expired.signed.label" : "security.dialog.expired.signed.label");
      localObject2 = new JLabel((String)localObject1);
      ((JLabel)localObject2).setOpaque(false);
      ((JLabel)localObject2).setFont(this.ssvSmallFont);
      localJPanel2.add((Component)localObject2, "North");
    }
    localJPanel2.setOpaque(false);
    localJPanel2.add(localFancyButton, "West");
    localJPanel2.setBorder(BorderFactory.createEmptyBorder(0, 10, 0, 10));
    Object localObject1 = new JLabel();
    ((JLabel)localObject1).setOpaque(false);
    if (this.alertStrs != null)
      ((JLabel)localObject1).setIcon(ResourceManager.getIcon("yellowShield.image"));
    else
      ((JLabel)localObject1).setIcon(ResourceManager.getIcon("blueShield.image"));
    Object localObject2 = new JPanel(new BorderLayout());
    ((JPanel)localObject2).setOpaque(false);
    ((JPanel)localObject2).add((Component)localObject1, "West");
    ((JPanel)localObject2).add(localJPanel2, "Center");
    JPanel localJPanel3 = new JPanel();
    localJPanel3.setLayout(new FlowLayout(4, 0, 0));
    localJPanel3.setOpaque(false);
    localJPanel3.setBorder(BorderFactory.createEmptyBorder(8, 0, 8, 0));
    this.okBtn = new JButton(paramString1);
    this.okBtn.addActionListener(this);
    this.okBtn.setActionCommand("OK");
    this.okBtn.setOpaque(false);
    localJPanel3.add(this.okBtn);
    this.cancelBtn = new JButton(paramString2);
    this.cancelBtn.addActionListener(this);
    this.cancelBtn.setOpaque(false);
    localJPanel3.add(Box.createHorizontalStrut(10));
    localJPanel3.add(this.cancelBtn);
    JButton[] arrayOfJButton = { this.okBtn, this.cancelBtn };
    resizeButtons(arrayOfJButton);
    localJPanel1.add((Component)localObject2, "West");
  ...
  private JPanel createSecurityBottomPanel(boolean paramBoolean)
  {
    JPanel localJPanel1 = new JPanel(new BorderLayout());
    localJPanel1.setOpaque(false);
    ...
    localJButton.setContentAreaFilled(false);
    localJButton.setBorderPainted(false);
    String str3 = "security.dialog.show.options";
    localJButton.setMnemonic(ResourceManager.getMnemonic(str3));
    localJPanel2.add(localJButton, "West");
    if (paramBoolean)
    {
      str3 = "https.dialog.always";
      this.always = new JCheckBox(getMessage(str3));
      this.always.setMnemonic(ResourceManager.getMnemonic(str3));
    ...
    localJButton.addActionListener(new ActionListener()
    {
      ...
      public void actionPerformed(ActionEvent paramAnonymousActionEvent)
      {
        ...
        if (str.equals(this.val$showStr))
        {
          ...
          this.val$showBtn.setMnemonic(ResourceManager.getMnemonic("security.dialog.hide.options"));
        ...
        else
        {
          ...
          this.val$showBtn.setMnemonic(ResourceManager.getMnemonic("security.dialog.show.options"));
  ...
  private JPanel createPasswordPanel(String paramString1, boolean paramBoolean1, boolean paramBoolean2, String paramString2, String paramString3, boolean paramBoolean3, char[] paramArrayOfChar, String paramString4)
  {
    ...
    if (paramBoolean1)
    {
      ...
      localJLabel1.setDisplayedMnemonic(ResourceManager.getMnemonic(str));
    ...
    localJLabel4.setDisplayedMnemonic(ResourceManager.getMnemonic(str));
    ...
    if (paramBoolean2)
    {
      ...
      localJLabel2.setDisplayedMnemonic(ResourceManager.getMnemonic((String)localObject1));
  ...
  void showMoreInfo()
  {
    ...
    {
      String[] arrayOfString = this.sandboxApp ? null : this.alertStrs;
      localMoreInfoDialog = new MoreInfoDialog(this.dialogInterface.getDialog(), arrayOfString, this.infoStrs, this.securityInfoCount, this.certs, this.start, this.end, this.majorWarning, this.sandboxApp);
    }
    else
    {
  ...
  {
    MoreInfoDialog localMoreInfoDialog = new MoreInfoDialog(this.dialogInterface.getDialog(), null, this.infoStrs, 0, null, 0, 0, false, this.sandboxApp);
    localMoreInfoDialog.setVisible(true);
  }
  ...
  public void setVisible(boolean paramBoolean)
  {
    if (paramBoolean)
    {
      ...
      if (SwingUtilities.isEventDispatchThread())
        ...
        try
        {
          SwingUtilities.invokeAndWait(local27);
        }
  ...
  public void setInfo(String paramString1, String paramString2, URL paramURL, String paramString3)
  {
    ...
    {
      String str1 = paramURL == null ? " " : paramURL.toString();
      String str2 = paramString3 == null ? "" : paramString3;
      this.urlInfo.setText(str2);
      this.urlInfo.setToolTipText(str1);
    }
  }
