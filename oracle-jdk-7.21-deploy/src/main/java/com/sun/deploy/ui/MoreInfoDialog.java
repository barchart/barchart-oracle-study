...
class MoreInfoDialog extends JDialog
{
  ...
  MoreInfoDialog(JDialog paramJDialog, String[] paramArrayOfString1, String[] paramArrayOfString2, int paramInt1, Certificate[] paramArrayOfCertificate, int paramInt2, int paramInt3, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    this.end = paramInt3;
    this.majorWarning = paramBoolean1;
    this.sandboxApp = paramBoolean2;
    initComponents(null, null);
    setResizable(false);
    if ((Config.isJavaVersionAtLeast15()) && (paramJDialog != null) && (paramJDialog.isAlwaysOnTop()))
      setAlwaysOnTop(true);
  }
  ...
  private JPanel getSecurityPanel()
  {
    ...
    int i = this.alerts == null ? 0 : this.alerts.length;
    localJPanel.add(blockPanel("com/sun/deploy/resources/image/icon-warning16.png", this.alerts, 0, i));
    String str = null;
    if (i == 0)
      str = "com/sun/deploy/resources/image/icon-info16.png";
    i = this.securityInfoCount;
    localJPanel.add(blockPanel(str, this.infos, 0, i));
    return localJPanel;
  }
  ...
  private JPanel blockPanel(String paramString, String[] paramArrayOfString, int paramInt1, int paramInt2)
  {
    ...
    if (paramArrayOfString != null)
      for (int i = paramInt1; i < paramInt2; i++)
      {
        ...
        if ((i == paramInt1) && (paramString != null))
          localJLabel.setIcon(new ImageIcon(ClassLoader.getSystemResource(paramString)));
        else
          localJLabel.setBorder(BorderFactory.createEmptyBorder(8, 8, 8, 8));
