  ...
  implements JNLPClassLoaderIf
{
  ...
  public void initialize(LaunchDesc paramLaunchDesc, AppPolicy paramAppPolicy)
  {
    ...
    if (localResourcesDesc != null)
    {
      ...
      for (i = 0; i < this._jarsInURLClassLoader.size(); i++)
      {
        ...
        {
          com.sun.deploy.model.Resource localResource = ResourceProvider.get().getSystemResource(localJARDesc.getLocation(), localJARDesc.getVersion());
          if ((localResource != null) && (localResource.getClassesVerificationStatus() == 1) && (localResource.isKnownToBeSigned()))
          {
    ...
    for (int i = 0; i < localObject1.length; i++)
      if (localObject1[i].isNativeLib())
        try
        {
          ...
          if (str1 != null)
          {
            com.sun.deploy.model.Resource localResource = ResourceProvider.get().getSystemResource(localObject1[i].getLocation(), localObject1[i].getVersion());
            if (localResource != null)
            {
              JarFile localJarFile = localResource.getJarFile();
  ...
  private static Method getDefineClassMethod(String paramString)
  {
    return (Method)AccessController.doPrivileged(new PrivilegedAction()
    {
      ...
      public Object run()
      {
        try
        {
          Method localMethod = JNLPPreverifyClassLoader.class$java$net$URLClassLoader.getDeclaredMethod(this.val$name, new Class[] { String.class, sun.misc.Resource.class, Boolean.TYPE });
    ...
    throws IOException
  {
    try
    {
      ...
      if (Cache.isCacheEnabled())
      {
        localObject2 = ResourceProvider.get().getSystemResource(localJARDesc.getLocation(), localJARDesc.getVersion());
        if ((localObject2 != null) && (((com.sun.deploy.model.Resource)localObject2).getClassesVerificationStatus() == 1))
  ...
  protected PermissionCollection getPermissions(CodeSource paramCodeSource)
  {
    ...
    if (localJARDesc != null)
    {
      ...
      if (localResource != null)
      {
        File localFile = localResource.getDataFile();
        if (localFile != null)
        {
    ...
    if (localJARDesc != null)
    {
      ...
      localJarFile = (JarFile)AccessController.doPrivileged(new PrivilegedAction()
      {
          ...
          throws SecurityException
        {
          try
          {
            com.sun.deploy.model.Resource localResource1 = ResourceProvider.get().getSystemResource(this.val$jd.getLocation(), this.val$jd.getVersion());
            if (localResource1 == null)
              return null;
            JarFile localJarFile = localResource1.getJarFile();
            if (localJarFile != null)
              return localJarFile;
            com.sun.deploy.model.Resource localResource2 = ResourceProvider.get().getResource(this.val$jd.getLocation(), this.val$jd.getVersion(), true, this.val$contentType, null);
            return localResource2 != null ? localResource2.getJarFile() : null;
          }
          catch (IOException localIOException)
          {
            Trace.ignoredException(localIOException);
  ...
  private class PreverifiedResource extends sun.misc.Resource
  {
    private sun.misc.Resource res = null;
    private byte[] cbytes;

    public PreverifiedResource(sun.misc.Resource arg2)
    {
      Object localObject;
