  ...
  implements XMLable
{
  ...
  public JREInfo selectJRE(boolean paramBoolean)
  {
    ...
    this._selectedJRE = LaunchSelection.selectJRE(this, this._matchImpl, paramBoolean);
  ...
  public AppInfo getAppInfo()
  {
    ...
    localAppInfo.setSecurity(isSecure() ? 1 : 2);
    localAppInfo.setLapURL(getCanonicalHome());
  ...
  public JavaFXRuntimeDesc getJavaFXRuntimeDescriptor()
  {
    ...
    if (getResources() != null)
      getResources().visit(new ResourceVisitor()
      {
        ...
        public void visitJFXDesc(JavaFXRuntimeDesc paramAnonymousJavaFXRuntimeDesc)
        {
          this.val$jfxd[0] = paramAnonymousJavaFXRuntimeDesc;
        }
      });
