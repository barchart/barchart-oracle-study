...
public class SigningInfo
{
  ...
  private static boolean setContains(List paramList, Object paramObject)
  {
    ...
    if (Config.isJavaVersionAtLeast15())
    {
      ...
      while (localIterator.hasNext())
      {
        localCertPath1 = ((CodeSigner)localIterator.next()).getSignerCertPath();
  ...
  public SigningInfo(URL paramURL, String paramString)
  {
    ...
    if ((this.fileInCache) && (ResourceProvider.get().canCache(null)))
      this.ce = ResourceProvider.get().getCachedResource(paramURL, i != 0 ? null : paramString);
  }
    ...
    throws IOException, JARSigningException
  {
    ...
    if (this.ce != null)
    {
      localObject1 = this.ce.getJarFile();
      Trace.println("Validating cached jar url=" + this.ce.getURL() + " ffile=" + this.ce.getResourceFilename() + " " + localObject1, TraceLevel.SECURITY);
      localList = getCommonCodeSignersForJar((JarFile)localObject1);
    ...
    else
    {
      ...
      try
      {
        JarFile localJarFile = ResourceProvider.get().getCachedJarFile(this.location, this.version);
  ...
  {
    if (this.ce != null)
      return this.ce.getValidationTimestamp();
    return 0L;
  }
  ...
  {
    return (this.ce != null) && (this.ce.getValidationTimestamp() != 0L);
  }
  ...
  {
    if (this.ce != null)
      this.ce.updateValidationResults(paramBoolean, paramMap, paramLong1, paramLong2, false);
  }
    ...
    throws IOException
  {
    ...
    try
    {
      ...
      if (jarAccess != null)
      {
        ...
        localEnumeration = jarAccess.entryNames(paramJarFile, (CodeSource[])localObject1);
        while ((localEnumeration.hasMoreElements()) && ((localList == null) || (!localList.isEmpty())))
        {
          ...
          if (bool)
          {
            ...
            if (localObject4 == null)
            {
              ...
              localList = overlapSigners(localList, (CodeSigner[])localObject4);
          }
          else
          {
            ...
            if (localObject4 == null)
            {
              ...
              localList = overlapCertificateChains(localList, (Certificate[])localObject4);
          }
        }
      }
      else
      {
        ...
        while ((localEnumeration.hasMoreElements()) && ((localList == null) || (!localList.isEmpty())))
        {
          ...
          if ((!JarUtil.isSigningRelated((String)localObject3)) && (!((String)localObject3).endsWith("/")))
          {
            i = 1;
            localObject4 = paramJarFile.getInputStream((ZipEntry)localObject2);
            while (((InputStream)localObject4).read((byte[])localObject1, 0, localObject1.length) != -1);
            ...
            if (bool)
            {
              ...
              if (localObject5 == null)
              {
                ...
                localList = overlapSigners(localList, (CodeSigner[])localObject5);
            }
            else
            {
              ...
              if (localObject5 == null)
              {
                ...
                localList = overlapCertificateChains(localList, (Certificate[])localObject5);
            }
          }
        }
      }
