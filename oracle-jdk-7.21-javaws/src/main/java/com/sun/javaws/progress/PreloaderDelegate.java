  ...
  implements DownloadServiceListener
{
  ...
  {
    this._listener = paramPreloaderPostEventListener;
  }
    ...
    throws CancelException
  {
    if (this.disposed)
    {
      Trace.println("Preloader disposed, dropping: " + paramPreloaderEvent, TraceLevel.PRELOADER);
      return;
    }
      ...
      enQueue(new Runnable()
      {
        ...
        public void run()
        {
          ...
          if (PreloaderDelegate.this._listener != null)
            PreloaderDelegate.this._listener.eventHandled(this.val$pe);
