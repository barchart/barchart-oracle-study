...
class CacheTable extends JTable
{
  ...
  public CacheTable(CacheViewer paramCacheViewer, int paramInt, boolean paramBoolean)
  {
    ...
    addMouseListener(new MouseAdapter()
    {
      public void mousePressed(MouseEvent paramAnonymousMouseEvent)
      {
        if (paramAnonymousMouseEvent.isPopupTrigger())
        {
          ...
          if (j < CacheTable.this.getModel().getRowCount())
          {
            ...
            CacheTable.this.viewer.popupApplicationMenu(CacheTable.this, paramAnonymousMouseEvent.getX(), i);
          }
        }
      }
      ...
      public void mouseClicked(MouseEvent paramAnonymousMouseEvent)
      {
        ...
        if ((paramAnonymousMouseEvent.getClickCount() == 2) && (CacheTable.this.getSelectedRows().length == 1) && (paramAnonymousMouseEvent.getButton() == 1))
        {
    ...
    addKeyListener(new KeyAdapter()
    {
      public void keyPressed(KeyEvent paramAnonymousKeyEvent)
      {
        ...
        int j = paramAnonymousKeyEvent.getModifiers();
        int k;
        if ((i == 121) && ((j & 0x1) != 0))
        {
  ...
  private class CacheTableHeaderRenderer extends DefaultTableCellRenderer
  {
    ...
    public Component getTableCellRendererComponent(JTable paramJTable, Object paramObject, boolean paramBoolean1, boolean paramBoolean2, int paramInt1, int paramInt2)
    {
      ...
      Object localObject = CacheObject.getHeaderToolTipText(paramInt2, CacheTable.this.tableType);
    ...
    implements TableCellRenderer
  {
    ...
    public void refresh()
    {
      ...
      this.rows = ((CacheObject[])localArrayList.toArray(new CacheObject[0]));
