...
public class LaunchErrorDialog
{
  ...
  public static void show(Object paramObject, Throwable paramThrowable, boolean paramBoolean)
  {
    ...
    if (i != 0)
    {
      DeploySysAction local1 = new DeploySysAction()
      {
        ...
        public Object execute()
        {
          ...
          {
            String str1 = null;
            String str2 = LaunchErrorDialog.getErrorCategory(this.val$throwable);
            ...
            ToolkitStore.getUI();
            ToolkitStore.getUI().showMessageDialog(this.val$owner, (AppInfo)localObject, 0, str5, null, str1, LaunchErrorDialog.getMoreInfo(localThrowable), str3, str4, null);
          }
          catch (Exception localException)
          {
            Trace.ignored(localException);
