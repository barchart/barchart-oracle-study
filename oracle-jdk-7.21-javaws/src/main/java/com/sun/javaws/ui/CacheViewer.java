  ...
  implements ListSelectionListener, PopupMenuListener
{
  ...
  private void initComponents()
  {
    ...
    localJButton.setMnemonic(ResourceManager.getMnemonic("viewer.help"));
    ...
    {
      public void menuKeyPressed(MenuKeyEvent paramAnonymousMenuKeyEvent)
      {
        int i = paramAnonymousMenuKeyEvent.getKeyCode();
        if ((i == 9) || (i == 39) || (i == 37))
          CacheViewer.this.runPopup.setVisible(false);
      }

      public void menuKeyReleased(MenuKeyEvent paramAnonymousMenuKeyEvent)
      {
      }

      public void menuKeyTyped(MenuKeyEvent paramAnonymousMenuKeyEvent)
      {
      }
    });
        ...
        for (int i = 0; i < this.val$co.length; i++)
          try
          {
            ...
            else
            {
              ...
              localObject3 = Runtime.getRuntime().exec((String[])localObject2);
  ...
  public JButton createRunButton(String paramString)
  {
    ...
    localJButton.addKeyListener(new KeyAdapter()
    {
      ...
      {
        if ((paramAnonymousKeyEvent.getKeyCode() == 40) || (paramAnonymousKeyEvent.getKeyCode() == 225))
        {
