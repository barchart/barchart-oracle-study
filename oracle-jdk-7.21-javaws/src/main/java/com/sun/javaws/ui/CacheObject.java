...
class CacheObject
{
  ...
  public long getSize()
  {
    if (this.sizeString == null)
    {
      ...
      if (this.theSize > 10240L)
        this.sizeString = (" " + ResourceManager.getString("viewer.measure.units.kb", String.valueOf(this.theSize / 1024L)));
      else
        this.sizeString = (" " + this.theSize / 1024L + "." + ResourceManager.getString("viewer.measure.units.kb", String.valueOf(this.theSize % 1024L / 102L)));
    }
    return this.theSize;
  }
  ...
  public File getIconFile()
  {
    try
    {
      ...
      Resource localResource = ResourceProvider.get().getCachedResource(localIconDesc.getLocation(), localIconDesc.getVersion());
