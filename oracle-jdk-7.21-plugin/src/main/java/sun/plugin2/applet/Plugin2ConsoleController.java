  ...
  implements ConsoleController14
{
  ...
  public Plugin2ConsoleController(Applet2ClassLoaderCache paramApplet2ClassLoaderCache, Applet2ManagerCache paramApplet2ManagerCache)
  {
    this.cache = paramApplet2ClassLoaderCache;
  ...
  {
    if (!this.initializedIconifiedOnClose)
    {
  ...
  public String dumpClassLoaders()
  {
    ...
    if (this.cache != null)
      this.cache.dump(localPrintWriter);
    else
      localPrintWriter.println("No class loader cache installed.");
  ...
  {
    return ResourceManager.getString("product.javapi.name", SecurityBaseline.getDeployVersion());
  }
 ...
 * Qualified Name:     sun.plugin2.applet.Plugin2ConsoleController
