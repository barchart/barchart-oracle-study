    ...
    try
    {
      ...
      case 'A':
        ...
        if (paramString.equals("getAttribute"))
        {
          ...
          try
          {
            localObject7 = this.target.getAttribute((ObjectName)localObject1, (String)localObject2, (Subject)localObject4);
          }
        ...
        if (paramString.equals("getAttributes"))
        {
          ...
          try
          {
            localObject7 = this.target.getAttributes((ObjectName)localObject1, (String[])localObject2, (Subject)localObject4);
          }
        ...
        if (paramString.equals("setAttribute"))
        {
          ...
          try
          {
            this.target.setAttribute((ObjectName)localObject1, (MarshalledObject)localObject2, (Subject)localObject4);
          }
        ...
        if (paramString.equals("setAttributes"))
        {
          ...
          try
          {
            localObject8 = this.target.setAttributes((ObjectName)localObject1, (MarshalledObject)localObject2, (Subject)localObject4);
          }
      ...
      case 'C':
        if (paramString.equals("getConnectionId"))
        {
          try
          {
            localObject1 = this.target.getConnectionId();
          }
      ...
      case 'D':
        if (paramString.equals("getDefaultDomain"))
        {
          ...
          try
          {
            localObject3 = this.target.getDefaultDomain((Subject)localObject1);
          }
        ...
        if (paramString.equals("getDomains"))
        {
          ...
          try
          {
            localObject3 = this.target.getDomains((Subject)localObject1);
          }
      ...
      case 'M':
        if (paramString.equals("getMBeanCount"))
        {
          ...
          try
          {
            localObject3 = this.target.getMBeanCount((Subject)localObject1);
          }
        ...
        if (paramString.equals("getMBeanInfo"))
        {
          ...
          try
          {
            localObject5 = this.target.getMBeanInfo((ObjectName)localObject1, (Subject)localObject3);
          }
      ...
      case 'N':
        if (paramString.equals("addNotificationListener"))
        {
          ...
          try
          {
            this.target.addNotificationListener((ObjectName)localObject1, (ObjectName)localObject3, (MarshalledObject)localObject5, (MarshalledObject)localObject9, (Subject)localObject14);
          }
        ...
        if (paramString.equals("addNotificationListeners"))
        {
          ...
          try
          {
            localObject9 = this.target.addNotificationListeners((ObjectName[])localObject1, (MarshalledObject[])localObject3, (Subject[])localObject5);
          }
      ...
      case 'O':
        if (paramString.equals("getObjectInstance"))
        {
          ...
          try
          {
            localObject5 = this.target.getObjectInstance((ObjectName)localObject1, (Subject)localObject3);
          }
      ...
      case 'a':
        if (paramString.equals("createMBean__CORBA_WStringValue__javax_management_ObjectName__javax_security_auth_Subject"))
        {
          ...
          try
          {
            localObject10 = this.target.createMBean((String)localObject1, (ObjectName)localObject3, (Subject)localObject5);
          }
        ...
        if (paramString.equals("createMBean__CORBA_WStringValue__javax_management_ObjectName__javax_management_ObjectName__javax_security_auth_Subject"))
        {
          ...
          try
          {
            localObject16 = this.target.createMBean((String)localObject1, (ObjectName)localObject3, (ObjectName)localObject5, (Subject)localObject10);
          }
        ...
        if (paramString.equals("createMBean__CORBA_WStringValue__javax_management_ObjectName__java_rmi_MarshalledObject__org_omg_boxedRMI_CORBA_seq1_WStringValue__javax_security_auth_Subject"))
        {
          ...
          try
          {
            localObject20 = this.target.createMBean((String)localObject1, (ObjectName)localObject3, (MarshalledObject)localObject5, (String[])localObject10, (Subject)localObject16);
          }
        ...
        if (paramString.equals("createMBean__CORBA_WStringValue__javax_management_ObjectName__javax_management_ObjectName__java_rmi_MarshalledObject__org_omg_boxedRMI_CORBA_seq1_WStringValue__javax_security_auth_Subject"))
        {
          ...
          try
          {
            localObject23 = this.target.createMBean((String)localObject1, (ObjectName)localObject3, (ObjectName)localObject5, (MarshalledObject)localObject10, (String[])localObject16, (Subject)localObject20);
          }
      ...
      case 'c':
        if (paramString.equals("fetchNotifications"))
        {
          ...
          try
          {
            localObject20 = this.target.fetchNotifications(l1, i, l2);
          }
      ...
      case 'e':
        if (paramString.equals("unregisterMBean"))
        {
          ...
          try
          {
            this.target.unregisterMBean(localObjectName, (Subject)localObject3);
          }
        ...
        if (paramString.equals("isRegistered"))
        {
          ...
          try
          {
            bool1 = this.target.isRegistered(localObjectName, (Subject)localObject3);
          }
      ...
      case 'n':
        if (paramString.equals("isInstanceOf"))
        {
          ...
          try
          {
            bool2 = this.target.isInstanceOf(localObjectName, (String)localObject3, (Subject)localObject6);
          }
      ...
      case 'o':
        if (paramString.equals("invoke"))
        {
          ...
          try
          {
            localObject20 = this.target.invoke(localObjectName, (String)localObject3, (MarshalledObject)localObject6, arrayOfString, (Subject)localObject17);
          }
        ...
        if (paramString.equals("removeNotificationListener__javax_management_ObjectName__javax_management_ObjectName__javax_security_auth_Subject"))
        {
          ...
          try
          {
            this.target.removeNotificationListener(localObjectName, (ObjectName)localObject3, (Subject)localObject6);
          }
        ...
        if (paramString.equals("removeNotificationListener__javax_management_ObjectName__javax_management_ObjectName__java_rmi_MarshalledObject__java_rmi_MarshalledObject__javax_security_auth_Subject"))
        {
          ...
          try
          {
            this.target.removeNotificationListener(localObjectName, (ObjectName)localObject3, (MarshalledObject)localObject6, (MarshalledObject)localObject11, (Subject)localObject17);
          }
        ...
        if (paramString.equals("removeNotificationListeners"))
        {
          ...
          try
          {
            this.target.removeNotificationListeners(localObjectName, (Integer[])localObject3, (Subject)localObject6);
          }
      ...
      case 'r':
        if (paramString.equals("queryMBeans"))
        {
          ...
          try
          {
            localObject12 = this.target.queryMBeans(localObjectName, (MarshalledObject)localObject3, (Subject)localObject6);
          }
        ...
        if (paramString.equals("queryNames"))
        {
          ...
          try
          {
            localObject12 = this.target.queryNames(localObjectName, (MarshalledObject)localObject3, (Subject)localObject6);
          }
