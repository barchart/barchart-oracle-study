...
/* 320 */     int j = localXPStyle.getInt(this.progressBar, TMSchema.Part.PP_PROGRESS, null, TMSchema.Prop.PROGRESSSPACESIZE, 0);
/*     */ 
/* 323 */     if (i == 0) {
/* 324 */       k = paramRectangle.width + j;
/* 325 */       return new Rectangle(paramRectangle.x - k * 2, paramRectangle.y, k * 3, paramRectangle.height);
/*     */     }
/* 327 */     int k = paramRectangle.height + j;
/* 328 */     return new Rectangle(paramRectangle.x, paramRectangle.y - k * 2, paramRectangle.width, k * 3);
/*     */   }
/*     */ 
...
/*     */   {
/* 335 */     XPStyle localXPStyle = XPStyle.getXP();
/*     */ 
/* 338 */     Graphics2D localGraphics2D = (Graphics2D)paramGraphics2D.create();
/*     */ 
/* 340 */     TMSchema.Part localPart1 = paramBoolean ? TMSchema.Part.PP_BARVERT : TMSchema.Part.PP_BAR;
/* 341 */     TMSchema.Part localPart2 = paramBoolean ? TMSchema.Part.PP_CHUNKVERT : TMSchema.Part.PP_CHUNK;
/*     */ 
/* 344 */     int i = localXPStyle.getInt(this.progressBar, TMSchema.Part.PP_PROGRESS, null, TMSchema.Prop.PROGRESSSPACESIZE, 0);
/*     */ 
/* 346 */     int j = 0;
/* 347 */     int k = 0;
/* 348 */     if (!paramBoolean) {
/* 349 */       j = -paramRectangle.width - i;
/* 350 */       k = 0;
/*     */     } else {
/* 352 */       j = 0;
/* 353 */       k = -paramRectangle.height - i;
/*     */     }
/*     */ 
/* 357 */     Rectangle localRectangle1 = getFullChunkBounds(paramRectangle);
/*     */ 
/* 360 */     this.previousFullBox = localRectangle1;
/*     */ 
/* 363 */     Insets localInsets = this.indeterminateInsets;
/* 364 */     Rectangle localRectangle2 = new Rectangle(localInsets.left, localInsets.top, paramInt1 - localInsets.left - localInsets.right, paramInt2 - localInsets.top - localInsets.bottom);
/*     */ 
/* 369 */     Rectangle localRectangle3 = localRectangle2.intersection(localRectangle1);
/*     */ 
/* 372 */     localGraphics2D.clip(localRectangle3);
/*     */ 
/* 375 */     XPStyle.Skin localSkin = localXPStyle.getSkin(this.progressBar, localPart2);
/*     */ 
/* 378 */     localGraphics2D.setComposite(AlphaComposite.getInstance(3, 0.8F));
/* 379 */     localSkin.paintSkin(localGraphics2D, paramRectangle.x, paramRectangle.y, paramRectangle.width, paramRectangle.height, null);
/* 380 */     paramRectangle.translate(j, k);
/* 381 */     localGraphics2D.setComposite(AlphaComposite.getInstance(3, 0.5F));
/* 382 */     localSkin.paintSkin(localGraphics2D, paramRectangle.x, paramRectangle.y, paramRectangle.width, paramRectangle.height, null);
/* 383 */     paramRectangle.translate(j, k);
/* 384 */     localGraphics2D.setComposite(AlphaComposite.getInstance(3, 0.2F));
/* 385 */     localSkin.paintSkin(localGraphics2D, paramRectangle.x, paramRectangle.y, paramRectangle.width, paramRectangle.height, null);
/*     */ 
/* 388 */     localGraphics2D.dispose();
/*     */   }
/*     */ 
/*     */   private void paintXPBackground(Graphics paramGraphics, boolean paramBoolean, int paramInt1, int paramInt2)
/*     */   {
/* 393 */     XPStyle localXPStyle = XPStyle.getXP();
/* 394 */     TMSchema.Part localPart = paramBoolean ? TMSchema.Part.PP_BARVERT : TMSchema.Part.PP_BAR;
/* 395 */     XPStyle.Skin localSkin = localXPStyle.getSkin(this.progressBar, localPart);
/*     */ 
/* 398 */     localSkin.paintSkin(paramGraphics, 0, 0, paramInt1, paramInt2, null);
/*     */   }
/*     */ }
