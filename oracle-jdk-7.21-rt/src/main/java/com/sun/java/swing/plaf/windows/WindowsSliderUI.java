...
/*     */   {
/* 218 */     XPStyle localXPStyle = XPStyle.getXP();
/*     */ 
/* 220 */     int i = this.slider.getOrientation() == 1 ? 1 : 0;
/* 221 */     boolean bool = this.slider.getComponentOrientation().isLeftToRight();
/* 222 */     Boolean localBoolean = (Boolean)this.slider.getClientProperty("Slider.paintThumbArrowShape");
/*     */     TMSchema.Part localPart;
/* 224 */     if (((!this.slider.getPaintTicks()) && (localBoolean == null)) || (localBoolean == Boolean.FALSE))
/*     */     {
/* 226 */       localPart = i != 0 ? TMSchema.Part.TKP_THUMBVERT : TMSchema.Part.TKP_THUMB;
/*     */     }
/*     */     else {
/* 229 */       localPart = i != 0 ? TMSchema.Part.TKP_THUMBLEFT : bool ? TMSchema.Part.TKP_THUMBRIGHT : TMSchema.Part.TKP_THUMBBOTTOM;
/*     */     }
/*     */ 
