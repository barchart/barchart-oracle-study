...
/*      */     {
/* 1798 */       localCDROutputObject = new CDROutputObject((ORB)paramCorbaMessageMediator.getBroker(), this, GIOPVersion.V1_0, (CorbaConnection)paramCorbaMessageMediator.getConnection(), paramLocateReplyMessage, (byte)1);
/*      */     }
/*      */     else
/*      */     {
/* 1808 */       localCDROutputObject = new CDROutputObject((ORB)paramCorbaMessageMediator.getBroker(), paramCorbaMessageMediator, paramLocateReplyMessage, (byte)1);
/*      */     }
/*      */ 
/* 1814 */     return localCDROutputObject;
/*      */   }
/*      */ 
...
/*      */   {
/* 1822 */     if (((ORB)paramCorbaMessageMediator.getBroker()).subcontractDebugFlag) {
/* 1823 */       dprint(".handleThrowableDuringServerDispatch: " + opAndId(paramCorbaMessageMediator) + ": " + paramThrowable);
/*      */     }
/*      */ 
/* 1841 */     handleThrowableDuringServerDispatch(paramCorbaMessageMediator, paramThrowable, paramCompletionStatus, 1);
/*      */   }
/*      */ 
...
/*      */     Object localObject;
/* 1856 */     if (paramInt > 10) {
/* 1857 */       if (((ORB)paramCorbaMessageMediator.getBroker()).subcontractDebugFlag) {
/* 1858 */         dprint(".handleThrowableDuringServerDispatch: " + opAndId(paramCorbaMessageMediator) + ": cannot handle: " + paramThrowable);
/*      */       }
/*      */ 
/* 1865 */       localObject = new RuntimeException("handleThrowableDuringServerDispatch: cannot create response.");
/*      */ 
/* 1868 */       ((RuntimeException)localObject).initCause(paramThrowable);
/* 1869 */       throw ((Throwable)localObject);
/*      */     }
/*      */     try
/*      */     {
/* 1873 */       if ((paramThrowable instanceof ForwardException)) {
/* 1874 */         localObject = (ForwardException)paramThrowable;
/* 1875 */         createLocationForward(paramCorbaMessageMediator, ((ForwardException)localObject).getIOR(), null);
/* 1876 */         return;
/*      */       }
/*      */ 
/* 1879 */       if ((paramThrowable instanceof AddressingDispositionException)) {
/* 1880 */         handleAddressingDisposition(paramCorbaMessageMediator, (AddressingDispositionException)paramThrowable);
/*      */ 
/* 1883 */         return;
/*      */       }
/*      */ 
/* 1888 */       localObject = convertThrowableToSystemException(paramThrowable, paramCompletionStatus);
/*      */ 
/* 1891 */       createSystemExceptionResponse(paramCorbaMessageMediator, (SystemException)localObject, null);
/* 1892 */       return;
/*      */     }
/*      */     catch (Throwable localThrowable)
/*      */     {
/* 1900 */       handleThrowableDuringServerDispatch(paramCorbaMessageMediator, localThrowable, paramCompletionStatus, paramInt + 1);
/*      */     }
/*      */   }
/*      */ 
...
/*      */   {
/* 1912 */     if ((paramThrowable instanceof SystemException)) {
/* 1913 */       return (SystemException)paramThrowable;
/*      */     }
/*      */ 
/* 1916 */     if ((paramThrowable instanceof RequestCanceledException))
/*      */     {
/* 1922 */       return this.wrapper.requestCanceled(paramThrowable);
/*      */     }
/*      */ 
/* 1938 */     return this.wrapper.runtimeexception(CompletionStatus.COMPLETED_MAYBE, paramThrowable);
/*      */   }
/*      */ 
...
/* 1946 */     short s = -1;
/*      */     CDROutputObject localCDROutputObject;
/* 1952 */     switch (paramCorbaMessageMediator.getRequestHeader().getType()) {
/*      */     case 0:
/* 1954 */       ReplyMessage localReplyMessage = MessageBase.createReply((ORB)paramCorbaMessageMediator.getBroker(), paramCorbaMessageMediator.getGIOPVersion(), paramCorbaMessageMediator.getEncodingVersion(), paramCorbaMessageMediator.getRequestId(), 5, null, null);
/*      */ 
/* 1962 */       localCDROutputObject = new CDROutputObject((ORB)paramCorbaMessageMediator.getBroker(), this, paramCorbaMessageMediator.getGIOPVersion(), (CorbaConnection)paramCorbaMessageMediator.getConnection(), localReplyMessage, (byte)1);
/*      */ 
/* 1969 */       paramCorbaMessageMediator.setOutputObject(localCDROutputObject);
/* 1970 */       localCDROutputObject.setMessageMediator(paramCorbaMessageMediator);
/* 1971 */       localReplyMessage.write(localCDROutputObject);
/* 1972 */       AddressingDispositionHelper.write(localCDROutputObject, paramAddressingDispositionException.expectedAddrDisp());
/*      */ 
/* 1974 */       return;
/*      */     case 3:
/* 1977 */       LocateReplyMessage localLocateReplyMessage = MessageBase.createLocateReply((ORB)paramCorbaMessageMediator.getBroker(), paramCorbaMessageMediator.getGIOPVersion(), paramCorbaMessageMediator.getEncodingVersion(), paramCorbaMessageMediator.getRequestId(), 5, null);
/*      */ 
/* 1985 */       s = paramAddressingDispositionException.expectedAddrDisp();
/*      */ 
/* 1988 */       localCDROutputObject = createAppropriateOutputObject(paramCorbaMessageMediator, paramCorbaMessageMediator.getRequestHeader(), localLocateReplyMessage);
/*      */ 
/* 1992 */       paramCorbaMessageMediator.setOutputObject(localCDROutputObject);
/* 1993 */       localCDROutputObject.setMessageMediator(paramCorbaMessageMediator);
/* 1994 */       localLocateReplyMessage.write(localCDROutputObject);
/* 1995 */       Object localObject = null;
/* 1996 */       if (localObject != null) {
/* 1997 */         localObject.write(localCDROutputObject);
/*      */       }
/* 1999 */       if (s != -1) {
/* 2000 */         AddressingDispositionHelper.write(localCDROutputObject, s);
/*      */       }
/* 2002 */       return;
/*      */     }
/*      */   }
...
/*      */   {
/* 2014 */     return createResponseHelper(paramCorbaMessageMediator, getServiceContextsForReply(paramCorbaMessageMediator, null));
/*      */   }
/*      */ 
...
/*      */   {
/* 2023 */     return createResponseHelper(paramCorbaMessageMediator, getServiceContextsForReply(paramCorbaMessageMediator, null), true);
/*      */   }
/*      */ 
...
/*      */   {
/* 2034 */     ServiceContexts localServiceContexts = null;
/* 2035 */     UNKNOWN localUNKNOWN = new UNKNOWN(0, CompletionStatus.COMPLETED_MAYBE);
/*      */ 
/* 2037 */     localServiceContexts = new ServiceContexts((ORB)paramCorbaMessageMediator.getBroker());
/* 2038 */     UEInfoServiceContext localUEInfoServiceContext = new UEInfoServiceContext(localUNKNOWN);
/* 2039 */     localServiceContexts.put(localUEInfoServiceContext);
/* 2040 */     return createSystemExceptionResponse(paramCorbaMessageMediator, localUNKNOWN, localServiceContexts);
/*      */   }
/*      */ 
...
/*      */   {
/* 2048 */     if (paramCorbaMessageMediator.getConnection() != null)
/*      */     {
/* 2058 */       localObject1 = (CorbaMessageMediatorImpl)((CorbaConnection)paramCorbaMessageMediator.getConnection()).serverRequestMapGet(paramCorbaMessageMediator.getRequestId());
/*      */ 
/* 2062 */       localObject2 = null;
/* 2063 */       if (localObject1 != null) {
/* 2064 */         localObject2 = ((CorbaMessageMediatorImpl)localObject1).getOutputObject();
/*      */       }
/*      */ 
/* 2069 */       if ((localObject2 != null) && (((CorbaMessageMediatorImpl)localObject1).sentFragment()) && (!((CorbaMessageMediatorImpl)localObject1).sentFullMessage()))
/*      */       {
/* 2073 */         return localObject1;
/*      */       }
/*      */ 
/*      */     }
/*      */ 
/* 2080 */     if (paramCorbaMessageMediator.executePIInResponseConstructor())
/*      */     {
/* 2087 */       ((ORB)paramCorbaMessageMediator.getBroker()).getPIHandler().setServerPIInfo(paramSystemException);
/*      */     }
/*      */ 
/* 2090 */     if ((((ORB)paramCorbaMessageMediator.getBroker()).subcontractDebugFlag) && (paramSystemException != null))
/*      */     {
/* 2093 */       dprint(".createSystemExceptionResponse: " + opAndId(paramCorbaMessageMediator), paramSystemException);
/*      */     }
/*      */ 
/* 2098 */     Object localObject1 = getServiceContextsForReply(paramCorbaMessageMediator, paramServiceContexts);
/*      */ 
/* 2105 */     addExceptionDetailMessage(paramCorbaMessageMediator, paramSystemException, (ServiceContexts)localObject1);
/*      */ 
/* 2107 */     Object localObject2 = createResponseHelper(paramCorbaMessageMediator, (ServiceContexts)localObject1, false);
/*      */ 
/* 2114 */     ORBUtility.writeSystemException(paramSystemException, (org.omg.CORBA_2_3.portable.OutputStream)((MessageHandler)localObject2).getOutputObject());
/*      */ 
/* 2117 */     return localObject2;
/*      */   }
/*      */ 
...
/*      */   {
/* 2124 */     ByteArrayOutputStream localByteArrayOutputStream = new ByteArrayOutputStream();
/* 2125 */     PrintWriter localPrintWriter = new PrintWriter(localByteArrayOutputStream);
/* 2126 */     paramSystemException.printStackTrace(localPrintWriter);
/* 2127 */     localPrintWriter.flush();
/* 2128 */     EncapsOutputStream localEncapsOutputStream = new EncapsOutputStream((ORB)paramCorbaMessageMediator.getBroker());
/*      */ 
/* 2130 */     localEncapsOutputStream.putEndian();
/* 2131 */     localEncapsOutputStream.write_wstring(localByteArrayOutputStream.toString());
/* 2132 */     UnknownServiceContext localUnknownServiceContext = new UnknownServiceContext(14, localEncapsOutputStream.toByteArray());
/*      */ 
/* 2135 */     paramServiceContexts.put(localUnknownServiceContext);
/*      */   }
/*      */ 
...
/*      */   {
/* 2141 */     ReplyMessage localReplyMessage = MessageBase.createReply((ORB)paramCorbaMessageMediator.getBroker(), paramCorbaMessageMediator.getGIOPVersion(), paramCorbaMessageMediator.getEncodingVersion(), paramCorbaMessageMediator.getRequestId(), 3, getServiceContextsForReply(paramCorbaMessageMediator, paramServiceContexts), paramIOR);
/*      */ 
/* 2151 */     return createResponseHelper(paramCorbaMessageMediator, localReplyMessage, paramIOR);
/*      */   }
/*      */ 
...
/*      */   {
/* 2157 */     ReplyMessage localReplyMessage = MessageBase.createReply((ORB)paramCorbaMessageMediator.getBroker(), paramCorbaMessageMediator.getGIOPVersion(), paramCorbaMessageMediator.getEncodingVersion(), paramCorbaMessageMediator.getRequestId(), 0, paramServiceContexts, null);
/*      */ 
/* 2166 */     return createResponseHelper(paramCorbaMessageMediator, localReplyMessage, null);
/*      */   }
/*      */ 
...
/*      */   {
/* 2172 */     ReplyMessage localReplyMessage = MessageBase.createReply((ORB)paramCorbaMessageMediator.getBroker(), paramCorbaMessageMediator.getGIOPVersion(), paramCorbaMessageMediator.getEncodingVersion(), paramCorbaMessageMediator.getRequestId(), paramBoolean ? 1 : 2, paramServiceContexts, null);
/*      */ 
/* 2182 */     return createResponseHelper(paramCorbaMessageMediator, localReplyMessage, null);
/*      */   }
/*      */ 
...
/*      */   {
/* 2190 */     runServantPostInvoke(paramCorbaMessageMediator);
/* 2191 */     runInterceptors(paramCorbaMessageMediator, paramReplyMessage);
/* 2192 */     runRemoveThreadInfo(paramCorbaMessageMediator);
/*      */ 
/* 2194 */     if (((ORB)paramCorbaMessageMediator.getBroker()).subcontractDebugFlag) {
/* 2195 */       dprint(".createResponseHelper: " + opAndId(paramCorbaMessageMediator) + ": " + paramReplyMessage);
/*      */     }
/*      */ 
/* 2200 */     paramCorbaMessageMediator.setReplyHeader(paramReplyMessage);
/*      */     Object localObject;
/* 2205 */     if (paramCorbaMessageMediator.getConnection() == null)
/*      */     {
/* 2207 */       localObject = new CDROutputObject(this.orb, paramCorbaMessageMediator, paramCorbaMessageMediator.getReplyHeader(), paramCorbaMessageMediator.getStreamFormatVersion(), 0);
/*      */     }
/*      */     else
/*      */     {
/* 2213 */       localObject = paramCorbaMessageMediator.getConnection().getAcceptor().createOutputObject(paramCorbaMessageMediator.getBroker(), paramCorbaMessageMediator);
/*      */     }
/*      */ 
/* 2216 */     paramCorbaMessageMediator.setOutputObject((OutputObject)localObject);
/* 2217 */     paramCorbaMessageMediator.getOutputObject().setMessageMediator(paramCorbaMessageMediator);
/*      */ 
/* 2219 */     paramReplyMessage.write((org.omg.CORBA_2_3.portable.OutputStream)paramCorbaMessageMediator.getOutputObject());
/* 2220 */     if (paramReplyMessage.getIOR() != null) {
/* 2221 */       paramReplyMessage.getIOR().write((org.omg.CORBA_2_3.portable.OutputStream)paramCorbaMessageMediator.getOutputObject());
/*      */     }
/*      */ 
/* 2228 */     return paramCorbaMessageMediator;
/*      */   }
/*      */ 
/*      */   protected void runServantPostInvoke(CorbaMessageMediator paramCorbaMessageMediator)
/*      */   {
/* 2238 */     ORB localORB = null;
/*      */ 
/* 2241 */     if (paramCorbaMessageMediator.executeReturnServantInResponseConstructor())
/*      */     {
/* 2247 */       paramCorbaMessageMediator.setExecuteReturnServantInResponseConstructor(false);
/* 2248 */       paramCorbaMessageMediator.setExecuteRemoveThreadInfoInResponseConstructor(true);
/*      */       try
/*      */       {
/* 2251 */         localORB = (ORB)paramCorbaMessageMediator.getBroker();
/* 2252 */         OAInvocationInfo localOAInvocationInfo = localORB.peekInvocationInfo();
/* 2253 */         ObjectAdapter localObjectAdapter = localOAInvocationInfo.oa();
/*      */         try {
/* 2255 */           localObjectAdapter.returnServant();
/*      */         } catch (Throwable localThrowable) {
/* 2257 */           this.wrapper.unexpectedException(localThrowable);
/*      */ 
/* 2259 */           if ((localThrowable instanceof Error))
/* 2260 */             throw ((Error)localThrowable);
/* 2261 */           if ((localThrowable instanceof RuntimeException))
/* 2262 */             throw ((RuntimeException)localThrowable);
/*      */         } finally {
/* 2264 */           localObjectAdapter.exit();
/*      */         }
/*      */       } catch (EmptyStackException localEmptyStackException) {
/* 2267 */         throw this.wrapper.emptyStackRunServantPostInvoke(localEmptyStackException);
/*      */       }
/*      */     }
/*      */   }
/*      */ 
...
/*      */   {
/* 2275 */     if (paramCorbaMessageMediator.executePIInResponseConstructor())
/*      */     {
/* 2279 */       ((ORB)paramCorbaMessageMediator.getBroker()).getPIHandler().invokeServerPIEndingPoint(paramReplyMessage);
/*      */ 
/* 2285 */       ((ORB)paramCorbaMessageMediator.getBroker()).getPIHandler().cleanupServerPIRequest();
/*      */ 
/* 2289 */       paramCorbaMessageMediator.setExecutePIInResponseConstructor(false);
/*      */     }
/*      */   }
/*      */ 
/*      */   protected void runRemoveThreadInfo(CorbaMessageMediator paramCorbaMessageMediator)
/*      */   {
/* 2297 */     if (paramCorbaMessageMediator.executeRemoveThreadInfoInResponseConstructor()) {
/* 2298 */       paramCorbaMessageMediator.setExecuteRemoveThreadInfoInResponseConstructor(false);
/* 2299 */       ((ORB)paramCorbaMessageMediator.getBroker()).popInvocationInfo();
/*      */     }
/*      */   }
/*      */ 
...
/*      */   {
/* 2306 */     CorbaConnection localCorbaConnection = (CorbaConnection)paramCorbaMessageMediator.getConnection();
/*      */ 
/* 2308 */     if (((ORB)paramCorbaMessageMediator.getBroker()).subcontractDebugFlag) {
/* 2309 */       dprint(".getServiceContextsForReply: " + opAndId(paramCorbaMessageMediator) + ": " + localCorbaConnection);
/*      */     }
/*      */ 
/* 2314 */     if (paramServiceContexts == null) {
/* 2315 */       paramServiceContexts = new ServiceContexts((ORB)paramCorbaMessageMediator.getBroker());
/*      */     }
/*      */ 
/* 2320 */     if ((localCorbaConnection != null) && (!localCorbaConnection.isPostInitialContexts())) {
/* 2321 */       localCorbaConnection.setPostInitialContexts();
/* 2322 */       localObject = new SendingContextServiceContext(((ORB)paramCorbaMessageMediator.getBroker()).getFVDCodeBaseIOR());
/*      */ 
/* 2326 */       if (paramServiceContexts.get(((SendingContextServiceContext)localObject).getId()) != null) {
/* 2327 */         throw this.wrapper.duplicateSendingContextServiceContext();
/*      */       }
/* 2329 */       paramServiceContexts.put((ServiceContext)localObject);
/*      */ 
/* 2331 */       if (((ORB)paramCorbaMessageMediator.getBroker()).subcontractDebugFlag) {
/* 2332 */         dprint(".getServiceContextsForReply: " + opAndId(paramCorbaMessageMediator) + ": added SendingContextServiceContext");
/*      */       }
/*      */ 
/*      */     }
/*      */ 
/* 2339 */     Object localObject = new ORBVersionServiceContext(ORBVersionFactory.getORBVersion());
/*      */ 
/* 2342 */     if (paramServiceContexts.get(((ORBVersionServiceContext)localObject).getId()) != null) {
/* 2343 */       throw this.wrapper.duplicateOrbVersionServiceContext();
/*      */     }
/* 2345 */     paramServiceContexts.put((ServiceContext)localObject);
/*      */ 
/* 2347 */     if (((ORB)paramCorbaMessageMediator.getBroker()).subcontractDebugFlag) {
/* 2348 */       dprint(".getServiceContextsForReply: " + opAndId(paramCorbaMessageMediator) + ": added ORB version service context");
/*      */     }
/*      */ 
/* 2352 */     return paramServiceContexts;
/*      */   }
/*      */ 
/*      */   private void releaseByteBufferToPool()
/*      */   {
/* 2359 */     if (this.dispatchByteBuffer != null) {
/* 2360 */       this.orb.getByteBufferPool().releaseByteBuffer(this.dispatchByteBuffer);
/* 2361 */       if (transportDebug()) {
/* 2362 */         int i = System.identityHashCode(this.dispatchByteBuffer);
/* 2363 */         StringBuffer localStringBuffer = new StringBuffer();
/* 2364 */         localStringBuffer.append(".handleInput: releasing ByteBuffer (" + i + ") to ByteBufferPool");
/*      */ 
/* 2366 */         dprint(localStringBuffer.toString());
/*      */       }
/*      */     }
/*      */   }
/*      */ }
