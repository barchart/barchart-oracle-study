...
/*      */     }
/*      */     finally {
/* 1546 */       if (this.orb.transportDebugFlag)
/* 1547 */         dprint(".purgeCalls<-: " + i + "/" + paramBoolean1 + "/" + paramBoolean2 + " " + this);
/*      */     }
/*      */   }
/*      */ 
...
/*      */     throws IOException
/*      */   {
/* 1562 */     Message localMessage = MessageBase.createCloseConnection(paramGIOPVersion);
/* 1563 */     sendHelper(paramGIOPVersion, localMessage);
/*      */   }
/*      */ 
/*      */   public void sendMessageError(GIOPVersion paramGIOPVersion)
/*      */     throws IOException
/*      */   {
/* 1569 */     Message localMessage = MessageBase.createMessageError(paramGIOPVersion);
/* 1570 */     sendHelper(paramGIOPVersion, localMessage);
/*      */   }
/*      */ 
/*      */   public void sendCancelRequest(GIOPVersion paramGIOPVersion, int paramInt)
/*      */     throws IOException
/*      */   {
/* 1582 */     CancelRequestMessage localCancelRequestMessage = MessageBase.createCancelRequest(paramGIOPVersion, paramInt);
/* 1583 */     sendHelper(paramGIOPVersion, localCancelRequestMessage);
/*      */   }
/*      */ 
/*      */   protected void sendHelper(GIOPVersion paramGIOPVersion, Message paramMessage)
/*      */     throws IOException
/*      */   {
/* 1590 */     CDROutputObject localCDROutputObject = new CDROutputObject(this.orb, null, paramGIOPVersion, this, paramMessage, (byte)1);
/*      */ 
/* 1593 */     paramMessage.write(localCDROutputObject);
/*      */ 
/* 1595 */     localCDROutputObject.writeTo(this);
/*      */   }
/*      */ 
...
/* 1602 */     writeLock();
/*      */     try {
/* 1604 */       sendCancelRequest(paramGIOPVersion, paramInt);
/*      */     } finally {
/* 1606 */       writeUnlock();
/*      */     }
/*      */   }
...
/*      */   {
/* 1625 */     this.codeBaseServerIOR = paramIOR;
/*      */   }
/*      */ 
/*      */   public final IOR getCodeBaseIOR() {
/* 1629 */     return this.codeBaseServerIOR;
/*      */   }
/*      */ 
/*      */   public final CodeBase getCodeBase()
/*      */   {
/* 1635 */     return this.cachedCodeBase;
/*      */   }
/*      */ 
/*      */   protected void setReadTimeouts(ReadTimeouts paramReadTimeouts)
/*      */   {
/* 1642 */     this.readTimeouts = paramReadTimeouts;
/*      */   }
/*      */ 
/*      */   protected void setPartialMessageMediator(CorbaMessageMediator paramCorbaMessageMediator) {
/* 1646 */     this.partialMessageMediator = paramCorbaMessageMediator;
/*      */   }
/*      */ 
/*      */   protected CorbaMessageMediator getPartialMessageMediator() {
/* 1650 */     return this.partialMessageMediator;
/*      */   }
/*      */ 
/*      */   public String toString()
/*      */   {
/* 1655 */     synchronized (this.stateEvent) {
/* 1656 */       return "SocketOrChannelConnectionImpl[ " + (this.socketChannel == null ? this.socket.toString() : this.socketChannel.toString()) + " " + getStateString(this.state) + " " + shouldUseSelectThreadToWait() + " " + shouldUseWorkerThreadForEvent() + " " + shouldReadGiopHeaderOnly() + "]";
/*      */     }
/*      */   }
/*      */ 
/*      */   public void dprint(String paramString)
/*      */   {
/* 1671 */     ORBUtility.dprint("SocketOrChannelConnectionImpl", paramString);
/*      */   }
/*      */ 
/*      */   protected void dprint(String paramString, Throwable paramThrowable)
/*      */   {
/* 1676 */     dprint(paramString);
/* 1677 */     paramThrowable.printStackTrace(System.out);
/*      */   }
/*      */ }
