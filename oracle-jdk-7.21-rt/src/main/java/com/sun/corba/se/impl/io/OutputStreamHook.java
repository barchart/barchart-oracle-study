...
/*  58 */       this.fields.put(paramString, new Boolean(paramBoolean));
/*     */     }
/*     */ 
/*     */     public void put(String paramString, char paramChar)
/*     */     {
/*  65 */       this.fields.put(paramString, new Character(paramChar));
/*     */     }
/*     */ 
/*     */     public void put(String paramString, byte paramByte)
/*     */     {
/*  72 */       this.fields.put(paramString, new Byte(paramByte));
/*     */     }
/*     */ 
/*     */     public void put(String paramString, short paramShort)
/*     */     {
/*  79 */       this.fields.put(paramString, new Short(paramShort));
/*     */     }
/*     */ 
/*     */     public void put(String paramString, int paramInt)
/*     */     {
/*  86 */       this.fields.put(paramString, new Integer(paramInt));
/*     */     }
/*     */ 
/*     */     public void put(String paramString, long paramLong)
/*     */     {
/*  93 */       this.fields.put(paramString, new Long(paramLong));
/*     */     }
/*     */ 
/*     */     public void put(String paramString, float paramFloat)
/*     */     {
/* 101 */       this.fields.put(paramString, new Float(paramFloat));
/*     */     }
/*     */ 
/*     */     public void put(String paramString, double paramDouble)
/*     */     {
/* 108 */       this.fields.put(paramString, new Double(paramDouble));
/*     */     }
/*     */ 
/*     */     public void put(String paramString, Object paramObject)
/*     */     {
/* 115 */       this.fields.put(paramString, paramObject);
/*     */     }
/*     */ 
/*     */     public void write(ObjectOutput paramObjectOutput)
/*     */       throws IOException
/*     */     {
/* 122 */       OutputStreamHook localOutputStreamHook = (OutputStreamHook)paramObjectOutput;
/*     */ 
/* 124 */       ObjectStreamField[] arrayOfObjectStreamField = localOutputStreamHook.getFieldsNoCopy();
/*     */ 
/* 129 */       for (int i = 0; i < arrayOfObjectStreamField.length; i++)
/*     */       {
/* 131 */         Object localObject = this.fields.get(arrayOfObjectStreamField[i].getName());
/*     */ 
/* 133 */         localOutputStreamHook.writeField(arrayOfObjectStreamField[i], localObject);
/*     */       }
/*     */     }
/*     */   }
/*     */ 
