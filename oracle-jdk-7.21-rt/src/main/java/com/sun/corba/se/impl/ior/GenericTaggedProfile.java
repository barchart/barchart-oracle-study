...
/*     */   {
/*  98 */     EncapsOutputStream localEncapsOutputStream = new EncapsOutputStream(this.orb);
/*  99 */     write(localEncapsOutputStream);
/* 100 */     InputStream localInputStream = (InputStream)localEncapsOutputStream.create_input_stream();
/* 101 */     return TaggedProfileHelper.read(localInputStream);
/*     */   }
/*     */ }
