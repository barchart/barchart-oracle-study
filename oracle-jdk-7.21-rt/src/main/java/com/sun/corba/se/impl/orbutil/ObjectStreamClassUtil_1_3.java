...
/*     */         try
/*     */         {
/* 513 */           localObject = Class.forName("sun.misc.ClassReflector");
/*     */         }
...
/* 520 */           localObject = java.io.ObjectStreamClass.class;
/*     */         }
/* 522 */         hasStaticInitializerMethod = ((Class)localObject).getDeclaredMethod("hasStaticInitializer", new Class[] { Class.class });
/*     */       }
/*     */       catch (NoSuchMethodException localNoSuchMethodException)
/*     */       {
/*     */       }
/*     */ 
/* 528 */       if (hasStaticInitializerMethod == null) {
/* 529 */         throw new InternalError("Can't find hasStaticInitializer method on " + ((Class)localObject).getName());
/*     */       }
/*     */ 
/* 532 */       hasStaticInitializerMethod.setAccessible(true);
/*     */     }
/*     */     try {
/* 535 */       localObject = (Boolean)hasStaticInitializerMethod.invoke(null, new Object[] { paramClass });
/*     */ 
/* 537 */       return ((Boolean)localObject).booleanValue();
/*     */     } catch (Exception localException) {
/* 539 */       throw new InternalError("Error invoking hasStaticInitializer: " + localException);
/*     */     }
/*     */   }
/*     */ 
...
/*     */   {
/* 547 */     return (Method)AccessController.doPrivileged(new PrivilegedAction() {
/*     */       public Object run() {
/* 549 */         Method localMethod = null;
/*     */         try {
/* 551 */           localMethod = this.val$cl.getDeclaredMethod(paramString, paramArrayOfClass);
/*     */ 
/* 553 */           int i = localMethod.getModifiers();
/* 554 */           if (((i & paramInt2) != 0) || ((i & paramInt1) != paramInt1))
/*     */           {
/* 556 */             localMethod = null;
/*     */           }
/*     */ 
/*     */         }
/*     */         catch (NoSuchMethodException localNoSuchMethodException)
