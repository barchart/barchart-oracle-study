...
/*     */ 
/* 136 */     CDROutputObject localCDROutputObject = new CDROutputObject(this.orb, paramMessageMediator, localCorbaMessageMediator.getRequestHeader(), localCorbaMessageMediator.getStreamFormatVersion(), 0);
/*     */ 
