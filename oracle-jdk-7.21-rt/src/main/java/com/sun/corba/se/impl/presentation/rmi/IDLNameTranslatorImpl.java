...
/*     */   {
/* 911 */     Object localObject1 = Remote.class;
/*     */     Object localObject2;
/* 913 */     if (paramArrayOfString.length > 0) {
/* 914 */       localObject2 = paramArrayOfString[0];
/*     */       try {
/* 916 */         localObject1 = Class.forName((String)localObject2);
/*     */       } catch (Exception localException) {
/* 918 */         localException.printStackTrace();
/* 919 */         System.exit(-1);
/*     */       }
/*     */     }
/*     */ 
/* 923 */     System.out.println("Building name translation for " + localObject1);
/*     */     try {
/* 925 */       localObject2 = get((Class)localObject1);
/*     */ 
/* 927 */       System.out.println(localObject2);
/*     */     } catch (IllegalStateException localIllegalStateException) {
/* 929 */       localIllegalStateException.printStackTrace();
/*     */     }
/*     */   }
/*     */ 
/*     */   static
