...
/*    */   {
/* 90 */     EncapsOutputStream localEncapsOutputStream = new EncapsOutputStream((com.sun.corba.se.spi.orb.ORB)paramORB);
/* 91 */     write(localEncapsOutputStream);
/* 92 */     return localEncapsOutputStream.toByteArray();
/*    */   }
/*    */ 
/*    */   public CorbaServerRequestDispatcher getServerRequestDispatcher(com.sun.corba.se.spi.orb.ORB paramORB)
/*    */   {
/* 97 */     return this.oktemp.getServerRequestDispatcher(paramORB, this.id);
/*    */   }
/*    */ }
