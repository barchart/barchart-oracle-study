...
/*     */ 
/*     */ 
/* 257 */       if (Math.abs(f15) < 1.0E-08D)
/* 258 */         f15 = 0.0F;
/* 259 */       if (Math.abs(f16) < 1.0E-08D)
/* 260 */         f16 = 0.0F;
/* 261 */       if (Math.abs(f17) < 1.0E-08D)
/* 262 */         f17 = 0.0F;
/* 263 */       if (Math.abs(f18) < 1.0E-08D)
/* 264 */         f18 = 0.0F;
/* 265 */       this.x1 = f15;
/* 266 */       this.x2 = f16;
/* 267 */       this.y1 = f17;
...
/*     */ 
/*     */ 
/* 501 */       if (Math.abs(f15) < 1.0E-08D)
/* 502 */         f15 = 0.0F;
/* 503 */       if (Math.abs(f16) < 1.0E-08D)
/* 504 */         f16 = 0.0F;
/* 505 */       if (Math.abs(f17) < 1.0E-08D)
/* 506 */         f17 = 0.0F;
/* 507 */       if (Math.abs(f18) < 1.0E-08D)
/* 508 */         f18 = 0.0F;
/* 509 */       this.x1 = f15;
/* 510 */       this.x2 = f16;
/* 511 */       this.y1 = f17;
...
/* 540 */       (this.resonancedB > 1.E-05D) || (d < 0.9999999000000001D)))
/* 541 */       this.wet = 1.0F;
/*     */   }
/*     */ 
...
/*     */       }
/*     */ 
/* 603 */       if (Math.abs(f9) < 1.0E-08D)
/* 604 */         f9 = 0.0F;
/* 605 */       if (Math.abs(f10) < 1.0E-08D)
/* 606 */         f10 = 0.0F;
/* 607 */       this.y2 = f9;
/* 608 */       this.y1 = f10;
/*     */     }
