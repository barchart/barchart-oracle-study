...
/*  43 */   int max_count = 10;
/*  44 */   int used_count = 0;
/*  45 */   private int[] stage = new int[this.max_count];
/*  46 */   private int[] stage_ix = new int[this.max_count];
/*  47 */   private double[] stage_v = new double[this.max_count];
/*  48 */   private int[] stage_count = new int[this.max_count];
/*  49 */   private double[][] on = new double[this.max_count][1];
/*  50 */   private double[][] active = new double[this.max_count][1];
/*  51 */   private double[][] out = new double[this.max_count][1];
/*  52 */   private double[][] delay = new double[this.max_count][1];
/*  53 */   private double[][] attack = new double[this.max_count][1];
/*  54 */   private double[][] hold = new double[this.max_count][1];
/*  55 */   private double[][] decay = new double[this.max_count][1];
/*  56 */   private double[][] sustain = new double[this.max_count][1];
/*  57 */   private double[][] release = new double[this.max_count][1];
/*  58 */   private double[][] shutdown = new double[this.max_count][1];
/*  59 */   private double[][] release2 = new double[this.max_count][1];
/*  60 */   private double[][] attack2 = new double[this.max_count][1];
/*  61 */   private double[][] decay2 = new double[this.max_count][1];
...
/* 136 */             this.stage[i] = 7;
/*     */           } else {
/* 138 */             if ((this.release2[i][0] < 1.0E-06D) && (this.release[i][0] < 0.0D) && (Double.isInfinite(this.release[i][0])))
/*     */             {
...
/*     */ 
/* 178 */             if ((d2 < 1.0E-06D) && (d1 < 0.0D) && (Double.isInfinite(d1)))
/*     */             {
