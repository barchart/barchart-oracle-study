...
/*  67 */   protected static final Mixer.Info info = new Info();
/*     */ 
...
/*     */ 
/*  85 */   private float controlrate = 147.0F;
/*     */ 
/*  87 */   private long latency = 100000L;
/*     */ 
/*  89 */   private boolean jitter_correction = false;
/*     */ 
/*  91 */   private List<LineListener> listeners = new ArrayList();
...
/*     */         }
/* 354 */         Object localObject1 = openStream(getFormat());
/*     */ 
...
/* 409 */                 paramSourceDataLine = (SourceDataLine)???.getLine(localObject3);
/*     */               }
/*     */             }
/*     */ 
...
/* 440 */         int i = 512;
/*     */         try {
/* 442 */           i = ((AudioInputStream)localObject1).available();
/*     */         }
...
/* 456 */           j = 3 * i;
/*     */         }
/* 458 */         if (this.jitter_correction) {
/* 459 */           localObject1 = new SoftJitterCorrector((AudioInputStream)localObject1, j, i);
/*     */         }
/*     */ 
/* 462 */         this.pusher = new SoftAudioPusher(paramSourceDataLine, (AudioInputStream)localObject1, i);
/* 463 */         this.pusher_stream = ((AudioInputStream)localObject1);
