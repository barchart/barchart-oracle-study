...
/*   87 */   protected TreeMap<Long, Object> midimessages = new TreeMap();
...
/*  863 */       private int nrofchannels = SoftMainMixer.this.synth.getFormat().getChannels();
/*      */ 
/*  865 */       private int buffersize = this.buffers[0].getSize();
/*  866 */       private byte[] bbuffer = new byte[this.buffersize * (SoftMainMixer.this.synth.getFormat().getSampleSizeInBits() / 8) * this.nrofchannels];
/*      */ 
