...
/*     */ {
/*  45 */   protected int preset = 0;
/*  46 */   protected int bank = 0;
/*  47 */   protected boolean druminstrument = false;
/*  48 */   protected byte[] guid = null;
/*  49 */   protected DLSInfo info = new DLSInfo();
/*  50 */   protected List<DLSRegion> regions = new ArrayList();
/*  51 */   protected List<DLSModulator> modulators = new ArrayList();
/*     */ 
