...
/*     */ 
/*     */   public int read(float[] paramArrayOfFloat) throws IOException {
...
/*     */ 
/*     */     public BytaArrayAudioFloatInputStream(AudioFloatConverter paramAudioFloatConverter, byte[] paramArrayOfByte, int paramInt1, int paramInt2)
/*     */     {
...
/*     */     private byte[] buffer;
/*     */ 
/* 134 */     public DirectAudioFloatInputStream(AudioInputStream paramAudioInputStream) { this.converter = AudioFloatConverter.getConverter(paramAudioInputStream.getFormat());
