...
/*  36 */   private double[][] out = new double[this.max_count][1];
/*  37 */   private double[][] delay = new double[this.max_count][1];
/*  38 */   private double[][] delay2 = new double[this.max_count][1];
/*  39 */   private double[][] freq = new double[this.max_count][1];
/*  40 */   private int[] delay_counter = new int[this.max_count];
/*  41 */   private double[] sin_phase = new double[this.max_count];
/*  42 */   private double[] sin_stepfreq = new double[this.max_count];
/*  43 */   private double[] sin_step = new double[this.max_count];
/*  44 */   private double control_time = 0.0D;
/*  45 */   private double sin_factor = 0.0D;
/*  46 */   private static double PI2 = 6.283185307179586D;
/*     */ 
