...
/* 306 */       for (j = 0; j < i; j++)
/* 307 */         this.input[j] = (arrayOfFloat1[j] * f1 + 1.0E-20F);
/*     */     else {
/* 309 */       for (j = 0; j < i; j++)
/* 310 */         this.input[j] = (arrayOfFloat1[j] * f1 - 1.0E-20F);
/*     */     }
...
/* 389 */         if ((f2 > 1.0E-10D) || (f2 < -1.0E-10D))
/*     */         {
