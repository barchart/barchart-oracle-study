...
/*   93 */   protected double portamento_time = 1.0D;
/*   94 */   protected int[] portamento_lastnote = new int[''];
...
/*  127 */   protected boolean[][] keybasedcontroller_active = (boolean[][])null;
/*  128 */   protected double[][] keybasedcontroller_value = (double[][])null;
/*      */ 
...
/*      */   }
/*      */ 
/*      */   protected void initVoice(SoftVoice paramSoftVoice, SoftPerformer paramSoftPerformer, int paramInt1, int paramInt2, int paramInt3, int paramInt4, ModelConnectionBlock[] paramArrayOfModelConnectionBlock, ModelChannelMixer paramModelChannelMixer, boolean paramBoolean)
/*      */   {
...
/* 1292 */       this.co_midi_pitch[0] = (paramInt * 6.103515625E-05D);
...
/* 1357 */     arrayOfDouble[0] = (arrayOfInt[0] * 6.103515625E-05D);
/*      */ 
...
/* 1394 */     arrayOfDouble[0] = (arrayOfInt[0] * 6.103515625E-05D);
/*      */ 
