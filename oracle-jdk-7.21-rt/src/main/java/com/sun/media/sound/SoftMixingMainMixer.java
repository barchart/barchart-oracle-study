...
/*  82 */   private List<SoftMixingDataLine> openLinesList = new ArrayList();
/*     */ 
...
/*     */ 
/* 167 */       private int nrofchannels = SoftMixingMainMixer.this.mixer.getFormat().getChannels();
/*     */ 
/* 170 */       private int buffersize = this.buffers[0].getSize();
/*     */ 
/* 172 */       private byte[] bbuffer = new byte[this.buffersize * (SoftMixingMainMixer.this.mixer.getFormat().getSampleSizeInBits() / 8) * this.nrofchannels];
/*     */ 
