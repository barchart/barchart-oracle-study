...
/*     */ 
/*     */ public class SoftMixingClip extends SoftMixingDataLine
/*     */   implements Clip
/*     */ {
...
/*     */ 
/* 166 */   protected SoftMixingClip(SoftMixingMixer paramSoftMixingMixer, DataLine.Info paramInfo) { super(paramSoftMixingMixer, paramInfo); }
/*     */ 
/*     */ 
...
/*     */ 
/* 200 */       if (Math.abs(this.format.getSampleRate() - this.outputformat.getSampleRate()) > 1.0E-06D)
