...
/*  48 */   protected double tunedKey = 0.0D;
...
/*  66 */   protected Map<String, SoftControl> objects = new HashMap();
...
/*     */   }
/*     */ 
/*     */   protected void updateTuning(SoftTuning paramSoftTuning)
/*     */   {
...
/*     */   }
/*     */ 
/*     */   protected void setNote(int paramInt) {
/* 297 */     this.note = paramInt;
/* 298 */     this.tunedKey = (this.tuning.getTuning(paramInt) / 100.0D);
/*     */   }
/*     */ 
/*     */   protected void noteOn(int paramInt1, int paramInt2, int paramInt3)
/*     */   {
...
/*     */   }
/*     */ 
/*     */   protected void setPolyPressure(int paramInt)
/*     */   {
...
/*     */   }
/*     */ 
/*     */   protected void setChannelPressure(int paramInt) {
...
/*     */   }
/*     */ 
/*     */   protected void controlChange(int paramInt1, int paramInt2) {
...
/*     */   }
/*     */ 
/*     */   protected void nrpnChange(int paramInt1, int paramInt2) {
...
/*     */   }
/*     */ 
/*     */   protected void rpnChange(int paramInt1, int paramInt2) {
...
/*     */   }
/*     */ 
/*     */   protected void setPitchBend(int paramInt) {
...
/*     */   }
/*     */ 
/*     */   protected void setSoloMute(boolean paramBoolean) {
...
/*     */   }
/*     */ 
/*     */   protected void noteOff(int paramInt) {
/* 532 */     if (!this.on)
/* 533 */       return;
/* 534 */     this.on = false;
/*     */ 
...
/*     */   }
/*     */ 
/*     */   protected void mixAudioStream(SoftAudioBuffer paramSoftAudioBuffer1, SoftAudioBuffer paramSoftAudioBuffer2, SoftAudioBuffer paramSoftAudioBuffer3, float paramFloat1, float paramFloat2)
/*     */   {
/* 766 */     int i = paramSoftAudioBuffer1.getSize();
/* 767 */     if ((paramFloat1 < 1.E-09D) && (paramFloat2 < 1.E-09D))
/*     */       return;
/*     */     float[] arrayOfFloat7;
/*     */     int n;
