...
/*      */   {
/* 1976 */     ModifiableClassLoaderRepository localModifiableClassLoaderRepository = this.instantiator.getClassLoaderRepository();
/*      */ 
/* 1978 */     if (localModifiableClassLoaderRepository == null) {
/* 1979 */       IllegalArgumentException localIllegalArgumentException = new IllegalArgumentException("Dynamic addition of class loaders is not supported");
/*      */ 
/* 1983 */       throw new RuntimeOperationsException(localIllegalArgumentException, "Exception occurred trying to register the MBean as a class loader");
/*      */     }
/*      */ 
/* 1987 */     localModifiableClassLoaderRepository.addClassLoader(paramObjectName, paramClassLoader);
/*      */   }
/*      */ 
/*      */   private void removeClassLoader(ClassLoader paramClassLoader, ObjectName paramObjectName)
/*      */   {
/* 2002 */     if (paramClassLoader != this.server.getClass().getClassLoader()) {
/* 2003 */       ModifiableClassLoaderRepository localModifiableClassLoaderRepository = this.instantiator.getClassLoaderRepository();
/*      */ 
/* 2005 */       if (localModifiableClassLoaderRepository != null)
/* 2006 */         localModifiableClassLoaderRepository.removeClassLoader(paramObjectName);
/*      */     }
/*      */   }
/*      */ 
/*      */   private ResourceContext createClassLoaderContext(final ClassLoader paramClassLoader, final ObjectName paramObjectName)
/*      */   {
/* 2029 */     return new ResourceContext()
/*      */     {
/*      */       public void registering() {
/* 2032 */         DefaultMBeanServerInterceptor.this.addClassLoader(paramClassLoader, paramObjectName);
/*      */       }
/*      */ 
/*      */       public void unregistered() {
/* 2036 */         DefaultMBeanServerInterceptor.this.removeClassLoader(paramClassLoader, paramObjectName);
/*      */       }
/*      */ 
/*      */       public void done()
/*      */       {
...
/*      */   {
/* 2056 */     if ((paramObject instanceof ClassLoader)) {
/* 2057 */       return createClassLoaderContext((ClassLoader)paramObject, paramObjectName);
/*      */     }
/*      */ 
