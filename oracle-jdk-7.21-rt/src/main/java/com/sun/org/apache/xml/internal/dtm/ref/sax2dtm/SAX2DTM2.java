...
/*      */     }
/*      */ 
/* 3163 */     return (String)this.m_values.elementAt(dataIndex);
/*      */   }
/*      */ 
...
/*      */       else
/*      */       {
/* 3180 */         this.m_chars.sendSAXcharacters(handler, this.m_data.elementAt(-dataIndex), this.m_data.elementAt(-dataIndex + 1));
/*      */       }
/*      */     }
/*      */   }
/*      */ 
...
/*      */     throws SAXException
/*      */   {
/* 3253 */     if ((this.m_namespaceDeclSetElements != null) && (this.m_namespaceDeclSetElements.size() == 1) && (this.m_namespaceDeclSets != null) && (((SuballocatedIntVector)this.m_namespaceDeclSets.elementAt(0)).size() == 1))
/*      */     {
/* 3258 */       return;
/*      */     }
...
/*      */       }
/*      */ 
/* 3288 */       String nodeValue = (String)this.m_values.elementAt(dataIndex);
/*      */ 
...
/* 3380 */     String nodeValue = (String)this.m_values.elementAt(valueIndex);
/*      */ 
