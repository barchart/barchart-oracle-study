...
/*     */       {
/* 305 */         localObject = paramNameSpaceSymbTable.addMappingAndRender("xmlns", "", nullNode);
/*     */       }
/*     */ 
/* 308 */       if (localObject != null) {
/* 309 */         localSortedSet.add(localObject);
/*     */       }
/*     */ 
/* 313 */       this.xmlattrStack.getXmlnsAttr(localSortedSet);
/* 314 */       paramNameSpaceSymbTable.getUnrenderedNodes(localSortedSet);
/*     */     }
/*     */ 
/* 318 */     return localSortedSet.iterator();
/*     */   }
/*     */ 
/*     */   public byte[] engineCanonicalizeXPathNodeSet(Set paramSet, String paramString)
/*     */     throws CanonicalizationException
/*     */   {
/* 332 */     throw new CanonicalizationException("c14n.Canonicalizer.UnsupportedOperation");
/*     */   }
/*     */ 
/*     */   public byte[] engineCanonicalizeSubTree(Node paramNode, String paramString)
/*     */     throws CanonicalizationException
/*     */   {
/* 348 */     throw new CanonicalizationException("c14n.Canonicalizer.UnsupportedOperation");
/*     */   }
/*     */ 
...
/* 352 */     if (!paramXMLSignatureInput.isNeedsToBeExpanded())
/* 353 */       return;
/* 354 */     Document localDocument = null;
/* 355 */     if (paramXMLSignatureInput.getSubNode() != null)
/* 356 */       localDocument = XMLUtils.getOwnerDocument(paramXMLSignatureInput.getSubNode());
/*     */     else {
/* 358 */       localDocument = XMLUtils.getOwnerDocument(paramXMLSignatureInput.getNodeSet());
/*     */     }
/* 360 */     XMLUtils.circumventBug2650(localDocument);
/*     */   }
/*     */ 
/*     */   void handleParent(Element paramElement, NameSpaceSymbTable paramNameSpaceSymbTable)
/*     */   {
/* 365 */     if (!paramElement.hasAttributes()) {
/* 366 */       return;
/*     */     }
/* 368 */     this.xmlattrStack.push(-1);
/* 369 */     NamedNodeMap localNamedNodeMap = paramElement.getAttributes();
/* 370 */     int i = localNamedNodeMap.getLength();
/* 371 */     for (int j = 0; j < i; j++) {
/* 372 */       Attr localAttr = (Attr)localNamedNodeMap.item(j);
/* 373 */       if ("http://www.w3.org/2000/xmlns/" != localAttr.getNamespaceURI())
/*     */       {
/* 375 */         if ("http://www.w3.org/XML/1998/namespace" == localAttr.getNamespaceURI()) {
/* 376 */           this.xmlattrStack.addXmlnsAttr(localAttr);
/*     */         }
/*     */       }
/*     */       else
/*     */       {
/* 381 */         String str1 = localAttr.getLocalName();
/* 382 */         String str2 = localAttr.getNodeValue();
/* 383 */         if ((!"xml".equals(str1)) || (!"http://www.w3.org/XML/1998/namespace".equals(str2)))
/*     */         {
/* 387 */           paramNameSpaceSymbTable.addMapping(str1, str2, localAttr);
/*     */         }
/*     */       }
/*     */     }
/*     */   }
