...
/*      */   {
/*  958 */     StringBuffer pathString = new StringBuffer(this.m_path);
/*      */ 
...
/*      */ 
/* 1331 */       if (((this.m_scheme == null) && (testURI.m_scheme == null)) || ((this.m_scheme != null) && (testURI.m_scheme != null) && (this.m_scheme.equals(testURI.m_scheme)) && (((this.m_userinfo == null) && (testURI.m_userinfo == null)) || ((this.m_userinfo != null) && (testURI.m_userinfo != null) && (this.m_userinfo.equals(testURI.m_userinfo)) && (((this.m_host == null) && (testURI.m_host == null)) || ((this.m_host != null) && (testURI.m_host != null) && (this.m_host.equals(testURI.m_host)) && (this.m_port == testURI.m_port) && (((this.m_path == null) && (testURI.m_path == null)) || ((this.m_path != null) && (testURI.m_path != null) && (this.m_path.equals(testURI.m_path)) && (((this.m_queryString == null) && (testURI.m_queryString == null)) || ((this.m_queryString != null) && (testURI.m_queryString != null) && (this.m_queryString.equals(testURI.m_queryString)) && (((this.m_fragment == null) && (testURI.m_fragment == null)) || ((this.m_fragment != null) && (testURI.m_fragment != null) && (this.m_fragment.equals(testURI.m_fragment))))))))))))))
/*      */       {
/* 1339 */         return true;
/*      */       }
/*      */     }
...
/*      */ 
/* 1356 */     if (this.m_scheme != null)
/*      */     {
/* 1358 */       uriSpecString.append(this.m_scheme);
...
/*      */   {
/* 1379 */     return this.m_host != null;
/*      */   }
/*      */ 
/*      */   public static boolean isConformantSchemeName(String p_scheme)
/*      */   {
/* 1394 */     if ((p_scheme == null) || (p_scheme.trim().length() == 0))
/*      */     {
/* 1396 */       return false;
/*      */     }
/*      */ 
/* 1399 */     if (!isAlpha(p_scheme.charAt(0)))
/*      */     {
/* 1401 */       return false;
/*      */     }
/*      */ 
/* 1406 */     for (int i = 1; i < p_scheme.length(); i++)
/*      */     {
/* 1408 */       char testChar = p_scheme.charAt(i);
/*      */ 
/* 1410 */       if ((!isAlphanum(testChar)) && ("+-.".indexOf(testChar) == -1))
/*      */       {
/* 1412 */         return false;
/*      */       }
/*      */     }
...
/*      */   {
/* 1435 */     if (p_address == null)
/*      */     {
/* 1437 */       return false;
/*      */     }
/*      */ 
/* 1440 */     String address = p_address.trim();
/* 1441 */     int addrLength = address.length();
/*      */ 
/* 1443 */     if ((addrLength == 0) || (addrLength > 255))
/*      */     {
/* 1445 */       return false;
/*      */     }
/*      */ 
/* 1448 */     if ((address.startsWith(".")) || (address.startsWith("-")))
/*      */     {
/* 1450 */       return false;
/*      */     }
/*      */ 
/* 1456 */     int index = address.lastIndexOf('.');
/*      */ 
/* 1458 */     if (address.endsWith("."))
/*      */     {
/* 1460 */       index = address.substring(0, index).lastIndexOf('.');
/*      */     }
/*      */ 
/* 1463 */     if ((index + 1 < addrLength) && (isDigit(p_address.charAt(index + 1))))
/*      */     {
/* 1466 */       int numDots = 0;
/*      */ 
/* 1471 */       for (int i = 0; i < addrLength; i++)
/*      */       {
/* 1473 */         char testChar = address.charAt(i);
/*      */ 
/* 1475 */         if (testChar == '.')
/*      */         {
/* 1477 */           if ((!isDigit(address.charAt(i - 1))) || ((i + 1 < addrLength) && (!isDigit(address.charAt(i + 1)))))
/*      */           {
/* 1480 */             return false;
/*      */           }
/*      */ 
...
/*      */     else
/*      */     {
/* 1503 */       for (int i = 0; i < addrLength; i++)
/*      */       {
/* 1505 */         char testChar = address.charAt(i);
/*      */ 
/* 1507 */         if (testChar == '.')
/*      */         {
/* 1509 */           if (!isAlphanum(address.charAt(i - 1)))
/*      */           {
/* 1511 */             return false;
/*      */           }
/*      */ 
/* 1514 */           if ((i + 1 < addrLength) && (!isAlphanum(address.charAt(i + 1))))
/*      */           {
/* 1516 */             return false;
/*      */           }
/*      */         }
/* 1519 */         else if ((!isAlphanum(testChar)) && (testChar != '-'))
/*      */         {
/* 1521 */           return false;
/*      */         }
/*      */       }
...
/*      */   {
/* 1551 */     return (isDigit(p_char)) || ((p_char >= 'a') && (p_char <= 'f')) || ((p_char >= 'A') && (p_char <= 'F'));
/*      */   }
/*      */ 
/*      */   private static boolean isAlpha(char p_char)
/*      */   {
/* 1564 */     return ((p_char >= 'a') && (p_char <= 'z')) || ((p_char >= 'A') && (p_char <= 'Z'));
/*      */   }
/*      */ 
/*      */   private static boolean isAlphanum(char p_char)
/*      */   {
/* 1577 */     return (isAlpha(p_char)) || (isDigit(p_char));
/*      */   }
/*      */ 
/*      */   private static boolean isReservedCharacter(char p_char)
/*      */   {
/* 1590 */     return ";/?:@&=+$,".indexOf(p_char) != -1;
/*      */   }
/*      */ 
/*      */   private static boolean isUnreservedCharacter(char p_char)
/*      */   {
/* 1602 */     return (isAlphanum(p_char)) || ("-_.!~*'() ".indexOf(p_char) != -1);
/*      */   }
/*      */ 
...
/*      */     }
/*      */ 
/* 1622 */     int end = p_uric.length();
/* 1623 */     char testChar = '\000';
/*      */ 
/* 1625 */     for (int i = 0; i < end; i++)
/*      */     {
/* 1627 */       testChar = p_uric.charAt(i);
/*      */ 
/* 1629 */       if (testChar == '%')
/*      */       {
/* 1631 */         if ((i + 2 >= end) || (!isHex(p_uric.charAt(i + 1))) || (!isHex(p_uric.charAt(i + 2))))
/*      */         {
/* 1634 */           return false;
/*      */         }
/*      */ 
/* 1638 */         i += 2;
/*      */       }
/* 1644 */       else if ((!isReservedCharacter(testChar)) && (!isUnreservedCharacter(testChar)))
/*      */       {
/* 1650 */         return false;
/*      */       }
/*      */     }
