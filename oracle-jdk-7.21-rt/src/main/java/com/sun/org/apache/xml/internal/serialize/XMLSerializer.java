...
/*  862 */         msg = DOMMessageFormatter.formatMessage("http://www.w3.org/dom/DOMTR", "NullLocalElementName", new Object[] { elem.getNodeName() });
/*      */ 
/*  865 */         modifyDOMError(msg, (short)2, null, elem);
/*  866 */         continueProcess = this.fDOMErrorHandler.handleError(this.fDOMError);
/*      */ 
