...
/* 539 */   private static final String[] fgSAXFeatures = { "namespaces", "namespace-prefixes", "string-interning", "validation", "external-general-entities", "external-parameter-entities" };
/*     */ 
/* 549 */   private static final String[] fgSAXProperties = { "declaration-handler", "lexical-handler", "dom-node", "xml-string" };
/*     */ 
...
/*     */ 
/* 592 */   private static final String[] fgXercesProperties = { "dom/current-element-node", "dom/document-class-name", "internal/symbol-table", "internal/error-handler", "internal/error-reporter", "internal/entity-manager", "internal/entity-resolver", "internal/grammar-pool", "internal/datatype-validator-factory", "internal/document-scanner", "internal/dtd-scanner", "internal/validator", "schema/external-schemaLocation", "schema/external-noNamespaceSchemaLocation", "internal/validation-manager", "input-buffer-size", "security-manager", "locale", "internal/validation/schema/dv-factory" };
/*     */ 
/* 615 */   private static final Enumeration fgEmptyEnumeration = new ArrayEnumeration(new Object[0]);
/*     */ 
/*     */   public static Enumeration getSAXFeatures()
/*     */   {
/* 632 */     return fgSAXFeatures.length > 0 ? new ArrayEnumeration(fgSAXFeatures) : fgEmptyEnumeration;
/*     */   }
/*     */ 
/*     */   public static Enumeration getSAXProperties()
/*     */   {
/* 638 */     return fgSAXProperties.length > 0 ? new ArrayEnumeration(fgSAXProperties) : fgEmptyEnumeration;
/*     */   }
/*     */ 
/*     */   public static Enumeration getXercesFeatures()
/*     */   {
/* 646 */     return fgXercesFeatures.length > 0 ? new ArrayEnumeration(fgXercesFeatures) : fgEmptyEnumeration;
/*     */   }
/*     */ 
/*     */   public static Enumeration getXercesProperties()
/*     */   {
/* 652 */     return fgXercesProperties.length > 0 ? new ArrayEnumeration(fgXercesProperties) : fgEmptyEnumeration;
/*     */   }
/*     */ 
/*     */   public static void main(String[] argv)
/*     */   {
/* 725 */     print("SAX features:", "http://xml.org/sax/features/", fgSAXFeatures);
/* 726 */     print("SAX properties:", "http://xml.org/sax/properties/", fgSAXProperties);
/* 727 */     print("Xerces features:", "http://apache.org/xml/features/", fgXercesFeatures);
/* 728 */     print("Xerces properties:", "http://apache.org/xml/properties/", fgXercesProperties);
/*     */   }
/*     */ 
...
/*     */     {
/* 699 */       return this.index < this.array.length;
/*     */     }
/*     */ 
/*     */     public Object nextElement()
/*     */     {
/* 710 */       if (this.index < this.array.length) {
/* 711 */         return this.array[(this.index++)];
/*     */       }
