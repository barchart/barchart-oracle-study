...
/*      */     }
/*      */ 
/*  833 */     uri = element.getNamespaceURI();
/*  834 */     prefix = element.getPrefix();
/*      */ 
...
/*  860 */         msg = DOMMessageFormatter.formatMessage("http://www.w3.org/dom/DOMTR", "NullLocalElementName", new Object[] { element.getNodeName() });
/*      */ 
/*  863 */         reportDOMError(this.fErrorHandler, this.fError, this.fLocator, msg, (short)3, "NullLocalElementName");
/*      */       }
/*      */       else {
/*  866 */         msg = DOMMessageFormatter.formatMessage("http://www.w3.org/dom/DOMTR", "NullLocalElementName", new Object[] { element.getNodeName() });
/*      */ 
...
/*  893 */       for (i = 0; i < this.fAttributeList.size(); i++) {
