...
/*     */ 
/* 145 */   private boolean ignoreMissingProperties = (SecuritySupport.getSystemProperty(pIgnoreMissing) != null) || (SecuritySupport.getSystemProperty(pFiles) != null);
...
/*     */ 
/* 165 */   private boolean fromPropertiesFile = false;
/*     */ 
/* 168 */   private int defaultVerbosity = 1;
/*     */ 
/* 171 */   private Integer verbosity = null;
/*     */ 
/* 174 */   private boolean defaultPreferPublic = true;
/*     */ 
/* 177 */   private Boolean preferPublic = null;
/*     */ 
/* 180 */   private boolean defaultUseStaticCatalog = true;
/*     */ 
/* 183 */   private Boolean useStaticCatalog = null;
/*     */ 
/* 186 */   private static Catalog staticCatalog = null;
/*     */ 
/* 189 */   private boolean defaultOasisXMLCatalogPI = true;
/*     */ 
/* 192 */   private Boolean oasisXMLCatalogPI = null;
/*     */ 
/* 195 */   private boolean defaultRelativeCatalogs = true;
/*     */ 
...
/* 235 */       this.useServicesMechanism = true;
/*     */   }
/*     */ 
...
/* 255 */       InputStream in = CatalogManager.class.getResourceAsStream("/" + this.propertyFile);
/*     */ 
/* 257 */       if (in == null) {
...
/* 417 */       return (allow.equalsIgnoreCase("true")) || (allow.equalsIgnoreCase("yes")) || (allow.equalsIgnoreCase("1"));
/*     */     }
/*     */     catch (MissingResourceException e) {
/*     */     }
...
/* 566 */       if (this.resources == null) return this.defaultPreferPublic; try
/*     */       {
...
/* 625 */       if (this.resources == null) return this.defaultUseStaticCatalog; try
/*     */       {
...
/*     */     }
/*     */ 
/* 637 */     return (staticCatalog.equalsIgnoreCase("true")) || (staticCatalog.equalsIgnoreCase("yes")) || (staticCatalog.equalsIgnoreCase("1"));
/*     */   }
/*     */ 
...
/* 756 */       if (this.resources == null) return this.defaultOasisXMLCatalogPI; try
/*     */       {
...
/*     */     }
/*     */ 
/* 768 */     return (allow.equalsIgnoreCase("true")) || (allow.equalsIgnoreCase("yes")) || (allow.equalsIgnoreCase("1"));
/*     */   }
/*     */ 
...
/* 785 */     return this.useServicesMechanism;
/*     */   }
/*     */ 
...
/* 812 */       if (this.resources == null) return null; try
/*     */       {
