...
/*     */       try
/*     */       {
/* 150 */         this.target.set(state.prev.target);
...
/* 178 */         state.loader = SingleMapNodeProperty.this.entryLoader;
/*     */       else
...
/* 211 */         state.loader = SingleMapNodeProperty.this.keyLoader;
/* 212 */         state.receiver = SingleMapNodeProperty.keyReceiver;
/* 213 */         return;
/*     */       }
/* 215 */       if (ea.matches(SingleMapNodeProperty.this.valueTag)) {
/* 216 */         state.loader = SingleMapNodeProperty.this.valueLoader;
/* 217 */         state.receiver = SingleMapNodeProperty.valueReceiver;
/* 218 */         return;
/*     */       }
...
/*  91 */     this.acc = prop.getAccessor().optimize(context);
...
/*     */ 
/* 101 */     Class sig = ReflectionNavigator.REFLECTION.erasure(prop.getRawType());
...
/* 235 */       ((Object[])state.target)[this.index] = o;
/*     */     }
/*     */   }
/*     */ }
