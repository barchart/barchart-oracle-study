...
/*     */       }
/* 251 */       this.msgProp = new MessageProp(0, this.privacy);
/*     */ 
/* 256 */       int i = networkByteOrderToInt(arrayOfByte, 1, 3);
/*     */ 
/* 260 */       this.sendMaxBufSize = (this.sendMaxBufSize == 0 ? i : Math.min(this.sendMaxBufSize, i));
/*     */ 
/* 264 */       this.rawSendSize = this.secCtx.getWrapSizeLimit(0, this.privacy, this.sendMaxBufSize);
/*     */ 
/* 267 */       if (logger.isLoggable(Level.FINE)) {
/* 268 */         logger.log(Level.FINE, "KRB5SRV10:Selected protection: {0}; privacy: {1}; integrity: {2}", new Object[] { new Byte(b), Boolean.valueOf(this.privacy), Boolean.valueOf(this.integrity) });
/*     */ 
/* 273 */         logger.log(Level.FINE, "KRB5SRV11:Client max recv size: {0}; server max send size: {1}; rawSendSize: {2}", new Object[] { new Integer(i), new Integer(this.sendMaxBufSize), new Integer(this.rawSendSize) });
/*     */       }
/*     */ 
/* 281 */       if (arrayOfByte.length > 4)
/*     */         try {
/* 283 */           this.authzid = new String(arrayOfByte, 4, arrayOfByte.length - 4, "UTF-8");
/*     */         }
/*     */         catch (UnsupportedEncodingException localUnsupportedEncodingException) {
/* 286 */           throw new SaslException("Cannot decode authzid", localUnsupportedEncodingException);
/*     */         }
/*     */       else {
/* 289 */         this.authzid = this.peer;
/*     */       }
/* 291 */       logger.log(Level.FINE, "KRB5SRV12:Authzid: {0}", this.authzid);
/*     */ 
/* 293 */       AuthorizeCallback localAuthorizeCallback = new AuthorizeCallback(this.peer, this.authzid);
/*     */ 
/* 296 */       this.cbh.handle(new Callback[] { localAuthorizeCallback });
/* 297 */       if (localAuthorizeCallback.isAuthorized()) {
/* 298 */         this.authzid = localAuthorizeCallback.getAuthorizedID();
/* 299 */         this.completed = true;
/*     */       }
/*     */       else {
/* 302 */         throw new SaslException(this.peer + " is not authorized to connect as " + this.authzid);
/*     */       }
/*     */ 
/* 306 */       return null;
/*     */     } catch (GSSException localGSSException) {
/* 308 */       throw new SaslException("Final handshake step failed", localGSSException);
/*     */     } catch (IOException localIOException) {
/* 310 */       throw new SaslException("Problem with callback handler", localIOException);
/*     */     } catch (UnsupportedCallbackException localUnsupportedCallbackException) {
/* 312 */       throw new SaslException("Problem with callback handler", localUnsupportedCallbackException);
/*     */     }
/*     */   }
/*     */ 
/*     */   public String getAuthorizationID() {
/* 317 */     if (this.completed) {
/* 318 */       return this.authzid;
/*     */     }
