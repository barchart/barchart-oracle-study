...
/* 330 */   protected static final Logger logger = Logger.getLogger("javax.security.sasl");
...
/* 341 */   private static final byte[] DEFAULT_QOP = { 1 };
/* 342 */   private static final String[] QOP_TOKENS = { "auth-conf", "auth-int", "auth" };
/*     */ 
/* 345 */   private static final byte[] QOP_MASKS = { 4, 2, 1 };
/*     */ 
/* 349 */   private static final byte[] DEFAULT_STRENGTH = { 4, 2, 1 };
/*     */ 
/* 351 */   private static final String[] STRENGTH_TOKENS = { "low", "medium", "high" };
/*     */ 
/* 354 */   private static final byte[] STRENGTH_MASKS = { 1, 2, 4 };
/*     */ 
...
/*     */   {
/* 259 */     traceOutput(paramString1, paramString2, paramString3, paramArrayOfByte, 0, paramArrayOfByte.length);
/*     */   }
/*     */ 
...
/* 269 */         paramInt2 = Math.min(16, paramInt2);
/* 270 */         localLevel = Level.FINER;
/*     */       } else {
/* 272 */         localLevel = Level.FINEST;
/*     */       }
/*     */ 
/* 275 */       ByteArrayOutputStream localByteArrayOutputStream = new ByteArrayOutputStream(paramInt2);
/* 276 */       new HexDumpEncoder().encodeBuffer(new ByteArrayInputStream(paramArrayOfByte, paramInt1, paramInt2), localByteArrayOutputStream);
/*     */ 
/* 280 */       logger.logp(localLevel, paramString1, paramString2, "{0} ( {1} ): {2}", new Object[] { paramString3, new Integer(i), localByteArrayOutputStream.toString() });
/*     */     }
/*     */     catch (Exception localException) {
/* 283 */       logger.logp(Level.WARNING, paramString1, paramString2, "SASLIMPL09:Error generating trace output: {0}", localException);
/*     */     }
/*     */   }
/*     */ 
...
/*     */   {
/* 294 */     if (paramInt2 > 4) {
/* 295 */       throw new IllegalArgumentException("Cannot handle more than 4 bytes");
/*     */     }
/*     */ 
/* 298 */     int i = 0;
/*     */ 
/* 300 */     for (int j = 0; j < paramInt2; j++) {
/* 301 */       i <<= 8;
/* 302 */       i |= paramArrayOfByte[(paramInt1 + j)] & 0xFF;
/*     */     }
/* 304 */     return i;
/*     */   }
/*     */ 
...
/*     */   {
/* 313 */     if (paramInt3 > 4) {
/* 314 */       throw new IllegalArgumentException("Cannot handle more than 4 bytes");
/*     */     }
/*     */ 
/* 317 */     for (int i = paramInt3 - 1; i >= 0; i--) {
/* 318 */       paramArrayOfByte[(paramInt2 + i)] = ((byte)(paramInt1 & 0xFF));
/* 319 */       paramInt1 >>>= 8;
/*     */     }
/*     */   }
/*     */ }
