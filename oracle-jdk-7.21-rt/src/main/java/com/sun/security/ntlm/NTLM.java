...
/*     */       try {
/* 138 */         return this.internal[paramInt] & 255 + (this.internal[(paramInt + 1)] & 0xFF00) + (this.internal[(paramInt + 2)] & 0xFF0000) + (this.internal[(paramInt + 3)] & 0xFF000000);
/*     */       }
...
/*     */       try
/*     */       {
/* 150 */         return this.internal[paramInt] & 255 + (this.internal[(paramInt + 1)] & 0xFF00);
/*     */       } catch (ArrayIndexOutOfBoundsException localArrayIndexOutOfBoundsException) {
/*     */       }
