...
/*     */       try {
/* 513 */         this.resourceBundle = ResourceBundle.getBundle(this.resourceBundleName);
/*     */       }
/*     */       catch (MissingResourceException localMissingResourceException)
/*     */       {
/* 517 */         this.resourceBundle = null;
/*     */       }
/*     */     }
/*     */ 
/* 521 */     this.needToInferCaller = false;
/*     */   }
/*     */ 
/*     */   private void inferCaller()
/*     */   {
/* 526 */     this.needToInferCaller = false;
/* 527 */     JavaLangAccess localJavaLangAccess = SharedSecrets.getJavaLangAccess();
/* 528 */     Throwable localThrowable = new Throwable();
/* 529 */     int i = localJavaLangAccess.getStackTraceDepth(localThrowable);
/*     */ 
/* 531 */     int j = 1;
/* 532 */     for (int k = 0; k < i; k++)
/*     */     {
/* 535 */       StackTraceElement localStackTraceElement = localJavaLangAccess.getStackTraceElement(localThrowable, k);
/*     */ 
/* 537 */       String str = localStackTraceElement.getClassName();
/* 538 */       boolean bool = isLoggerImplFrame(str);
/* 539 */       if (j != 0)
/*     */       {
/* 541 */         if (bool) {
/* 542 */           j = 0;
...
/* 545 */       else if (!bool)
/*     */       {
/* 547 */         if ((!str.startsWith("java.lang.reflect.")) && (!str.startsWith("sun.reflect.")))
/*     */         {
/* 549 */           setSourceClassName(str);
/* 550 */           setSourceMethodName(localStackTraceElement.getMethodName());
/* 551 */           return;
/*     */         }
/*     */       }
/*     */     }
...
/*     */   {
/* 562 */     return (paramString.equals("java.util.logging.Logger")) || (paramString.startsWith("java.util.logging.LoggingProxyImpl")) || (paramString.startsWith("sun.util.logging."));
/*     */   }
/*     */ }
