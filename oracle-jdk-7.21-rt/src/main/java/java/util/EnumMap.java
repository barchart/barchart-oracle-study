...
/* 732 */     return localEnumMap;
/*     */   }
/*     */ 
/*     */   private void typeCheck(K paramK)
/*     */   {
/* 739 */     Class localClass = paramK.getClass();
/* 740 */     if ((localClass != this.keyType) && (localClass.getSuperclass() != this.keyType))
/* 741 */       throw new ClassCastException(localClass + " != " + this.keyType);
/*     */   }
/*     */ 
/*     */   private static <K extends Enum<K>> K[] getKeyUniverse(Class<K> paramClass)
/*     */   {
/* 749 */     return SharedSecrets.getJavaLangAccess().getEnumConstantsShared(paramClass);
/*     */   }
/*     */ 
/*     */   private void writeObject(ObjectOutputStream paramObjectOutputStream)
/*     */     throws IOException
/*     */   {
/* 768 */     paramObjectOutputStream.defaultWriteObject();
/*     */ 
/* 771 */     paramObjectOutputStream.writeInt(this.size);
/*     */ 
/* 774 */     int i = this.size;
/* 775 */     for (int j = 0; i > 0; j++)
/* 776 */       if (null != this.vals[j]) {
/* 777 */         paramObjectOutputStream.writeObject(this.keyUniverse[j]);
/* 778 */         paramObjectOutputStream.writeObject(unmaskNull(this.vals[j]));
/* 779 */         i--;
/*     */       }
/*     */   }
/*     */ 
...
/*     */   {
/* 792 */     paramObjectInputStream.defaultReadObject();
/*     */ 
/* 794 */     this.keyUniverse = getKeyUniverse(this.keyType);
/* 795 */     this.vals = new Object[this.keyUniverse.length];
/*     */ 
/* 798 */     int i = paramObjectInputStream.readInt();
/*     */ 
/* 801 */     for (int j = 0; j < i; j++) {
/* 802 */       Enum localEnum = (Enum)paramObjectInputStream.readObject();
/* 803 */       Object localObject = paramObjectInputStream.readObject();
/* 804 */       put(localEnum, localObject);
/*     */     }
/*     */   }
/*     */ 
