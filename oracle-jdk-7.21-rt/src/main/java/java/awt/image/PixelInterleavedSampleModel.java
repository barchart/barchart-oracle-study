...
/*  88 */     int i = paramArrayOfInt[0];
/*  89 */     int j = paramArrayOfInt[0];
/*  90 */     for (int k = 1; k < paramArrayOfInt.length; k++) {
/*  91 */       i = Math.min(i, paramArrayOfInt[k]);
/*  92 */       j = Math.max(j, paramArrayOfInt[k]);
/*     */     }
/*  94 */     j -= i;
/*  95 */     if (j > paramInt5) {
