...
/*  151 */     this.numBands = paramArrayOfInt.length;
/*  152 */     if (paramInt4 < 0) {
...
/*      */     }
/*  226 */     int i = paramArrayOfInt1[0];
/*  227 */     if (i < 0) {
/*  228 */       throw new IllegalArgumentException("Index of bank 0 is less than 0 (" + i + ")");
/*      */     }
/*      */ 
/*  231 */     for (int j = 1; j < paramArrayOfInt1.length; j++) {
/*  232 */       if (paramArrayOfInt1[j] > i) {
/*  233 */         i = paramArrayOfInt1[j];
/*      */       }
/*  235 */       else if (paramArrayOfInt1[j] < 0) {
...
/*  242 */     this.numBands = paramArrayOfInt2.length;
/*  243 */     if (paramArrayOfInt2.length != paramArrayOfInt1.length)
