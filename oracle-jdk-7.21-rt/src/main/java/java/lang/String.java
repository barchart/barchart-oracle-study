...
/*      */ 
/* 3075 */   private static final int HASHING_SEED = i;
/*      */ 
...
/*      */       int i1;
/* 2462 */       if ((n != 0) || (i2 == 931))
/* 2463 */         i1 = ConditionalSpecialCasing.toLowerCaseEx(this, i4, paramLocale);
/* 2464 */       else if (i2 == 304)
/* 2465 */         i1 = -1;
/*      */       else {
/* 2467 */         i1 = Character.toLowerCase(i2);
/*      */       }
...
/* 2471 */         if (i1 == -1) {
/* 2472 */           if ((n == 0) && (i2 == 304)) {
/* 2473 */             arrayOfChar1 = ConditionalSpecialCasing.toLowerCaseCharArray(this, i4, Locale.ENGLISH);
/*      */           }
/*      */           else
/* 2476 */             arrayOfChar1 = ConditionalSpecialCasing.toLowerCaseCharArray(this, i4, paramLocale);
/*      */         }
/*      */         else {
/* 2479 */           if (i3 == 2) {
/* 2480 */             m += Character.toChars(i1, (char[])localObject, i4 + m) - i3;
/* 2481 */             continue;
/*      */           }
/* 2483 */           arrayOfChar1 = Character.toChars(i1);
/*      */         }
/*      */ 
/* 2487 */         int i5 = arrayOfChar1.length;
/* 2488 */         if (i5 > i3) {
/* 2489 */           char[] arrayOfChar2 = new char[localObject.length + i5 - i3];
/* 2490 */           System.arraycopy(localObject, 0, arrayOfChar2, 0, i4 + m);
/* 2491 */           localObject = arrayOfChar2;
/*      */         }
/* 2493 */         for (int i6 = 0; i6 < i5; i6++) {
/* 2494 */           localObject[(i4 + m + i6)] = arrayOfChar1[i6];
/*      */         }
/* 2496 */         m += i5 - i3;
/*      */       } else {
/* 2498 */         localObject[(i4 + m)] = ((char)i1);
/*      */       }
/*      */     }
/* 2501 */     return new String((char[])localObject, 0, j + m);
/*      */   }
/*      */ 
...
/*      */   {
/* 2576 */     if (paramLocale == null) {
/* 2577 */       throw new NullPointerException();
/*      */     }
/*      */ 
/* 2581 */     int j = this.value.length;
/*      */ 
/* 2585 */     for (int i = 0; i < j; ) {
/* 2586 */       int k = this.value[i];
/*      */ 
/* 2588 */       if ((k >= 55296) && (k <= 56319))
/*      */       {
/* 2590 */         k = codePointAt(i);
/* 2591 */         m = Character.charCount(k);
/*      */       } else {
/* 2593 */         m = 1;
/*      */       }
/* 2595 */       int n = Character.toUpperCaseEx(k);
/* 2596 */       if ((n == -1) || (k != n))
/*      */       {
/*      */         break label100;
/*      */       }
...
/* 2602 */     return this;
/*      */ 
/* 2605 */     label100: Object localObject = new char[j];
/* 2606 */     int m = 0;
/*      */ 
/* 2610 */     System.arraycopy(this.value, 0, localObject, 0, i);
/*      */ 
/* 2612 */     String str = paramLocale.getLanguage();
/* 2613 */     int i1 = (str == "tr") || (str == "az") || (str == "lt") ? 1 : 0;
/*      */     int i4;
/* 2619 */     for (int i5 = i; i5 < j; i5 += i4) {
/* 2620 */       int i3 = this.value[i5];
/* 2621 */       if (((char)i3 >= 55296) && ((char)i3 <= 56319))
/*      */       {
/* 2623 */         i3 = codePointAt(i5);
/* 2624 */         i4 = Character.charCount(i3);
/*      */       } else {
/* 2626 */         i4 = 1;
/*      */       }
/*      */       int i2;
/* 2628 */       if (i1 != 0)
/* 2629 */         i2 = ConditionalSpecialCasing.toUpperCaseEx(this, i5, paramLocale);
/*      */       else {
/* 2631 */         i2 = Character.toUpperCaseEx(i3);
/*      */       }
/* 2633 */       if ((i2 == -1) || (i2 >= 65536))
/*      */       {
/*      */         char[] arrayOfChar1;
/* 2635 */         if (i2 == -1) {
/* 2636 */           if (i1 != 0) {
/* 2637 */             arrayOfChar1 = ConditionalSpecialCasing.toUpperCaseCharArray(this, i5, paramLocale);
/*      */           }
/*      */           else
/* 2640 */             arrayOfChar1 = Character.toUpperCaseCharArray(i3);
/*      */         } else {
/* 2642 */           if (i4 == 2) {
/* 2643 */             m += Character.toChars(i2, (char[])localObject, i5 + m) - i4;
/* 2644 */             continue;
/*      */           }
/* 2646 */           arrayOfChar1 = Character.toChars(i2);
/*      */         }
/*      */ 
/* 2650 */         int i6 = arrayOfChar1.length;
/* 2651 */         if (i6 > i4) {
/* 2652 */           char[] arrayOfChar2 = new char[localObject.length + i6 - i4];
/* 2653 */           System.arraycopy(localObject, 0, arrayOfChar2, 0, i5 + m);
/* 2654 */           localObject = arrayOfChar2;
/*      */         }
/* 2656 */         for (int i7 = 0; i7 < i6; i7++) {
/* 2657 */           localObject[(i5 + m + i7)] = arrayOfChar1[i7];
/*      */         }
/* 2659 */         m += i6 - i4;
/*      */       } else {
/* 2661 */         localObject[(i5 + m)] = ((char)i2);
/*      */       }
/*      */     }
/* 2664 */     return new String((char[])localObject, 0, j + m);
/*      */   }
/*      */ 
...
/*      */   public String trim()
/*      */   {
/* 2722 */     int i = this.value.length;
/* 2723 */     int j = 0;
/* 2724 */     char[] arrayOfChar = this.value;
/*      */ 
/* 2726 */     while ((j < i) && (arrayOfChar[j] <= ' ')) {
/* 2727 */       j++;
/*      */     }
/* 2729 */     while ((j < i) && (arrayOfChar[(i - 1)] <= ' ')) {
/* 2730 */       i--;
/*      */     }
/* 2732 */     return (j > 0) || (i < this.value.length) ? substring(j, i) : this;
/*      */   }
/*      */ 
...
/*      */   {
/* 2753 */     char[] arrayOfChar = new char[this.value.length];
/* 2754 */     System.arraycopy(this.value, 0, arrayOfChar, 0, this.value.length);
/* 2755 */     return arrayOfChar;
/*      */   }
/*      */ 
/*      */   public static String format(String paramString, Object[] paramArrayOfObject)
/*      */   {
/* 2797 */     return new Formatter().format(paramString, paramArrayOfObject).toString();
/*      */   }
/*      */ 
/*      */   public static String format(Locale paramLocale, String paramString, Object[] paramArrayOfObject)
/*      */   {
/* 2841 */     return new Formatter(paramLocale).format(paramString, paramArrayOfObject).toString();
/*      */   }
/*      */ 
/*      */   public static String valueOf(Object paramObject)
/*      */   {
/* 2854 */     return paramObject == null ? "null" : paramObject.toString();
/*      */   }
/*      */ 
/*      */   public static String valueOf(char[] paramArrayOfChar)
/*      */   {
/* 2868 */     return new String(paramArrayOfChar);
/*      */   }
/*      */ 
/*      */   public static String valueOf(char[] paramArrayOfChar, int paramInt1, int paramInt2)
/*      */   {
/* 2893 */     return new String(paramArrayOfChar, paramInt1, paramInt2);
/*      */   }
/*      */ 
/*      */   public static String copyValueOf(char[] paramArrayOfChar, int paramInt1, int paramInt2)
/*      */   {
/* 2908 */     return new String(paramArrayOfChar, paramInt1, paramInt2);
/*      */   }
/*      */ 
/*      */   public static String copyValueOf(char[] paramArrayOfChar)
/*      */   {
/* 2920 */     return new String(paramArrayOfChar);
/*      */   }
/*      */ 
/*      */   public static String valueOf(boolean paramBoolean)
/*      */   {
/* 2932 */     return paramBoolean ? "true" : "false";
/*      */   }
/*      */ 
/*      */   public static String valueOf(char paramChar)
/*      */   {
/* 2944 */     char[] arrayOfChar = { paramChar };
/* 2945 */     return new String(arrayOfChar, true);
/*      */   }
/*      */ 
/*      */   public static String valueOf(int paramInt)
/*      */   {
/* 2959 */     return Integer.toString(paramInt);
/*      */   }
/*      */ 
/*      */   public static String valueOf(long paramLong)
/*      */   {
/* 2973 */     return Long.toString(paramLong);
/*      */   }
/*      */ 
/*      */   public static String valueOf(float paramFloat)
/*      */   {
/* 2987 */     return Float.toString(paramFloat);
/*      */   }
/*      */ 
/*      */   public static String valueOf(double paramDouble)
/*      */   {
/* 3001 */     return Double.toString(paramDouble);
/*      */   }
/*      */ 
...
/*      */   int hash32()
/*      */   {
/* 3089 */     int i = this.hash32;
/* 3090 */     if (0 == i)
/*      */     {
/* 3092 */       i = Hashing.murmur3_32(HASHING_SEED, this.value, 0, this.value.length);
/*      */ 
/* 3095 */       i = 0 != i ? i : 1;
/*      */ 
/* 3097 */       this.hash32 = i;
...
/*      */   static
/*      */   {
/* 3035 */     long l1 = System.nanoTime();
/* 3036 */     long l2 = System.currentTimeMillis();
/* 3037 */     int[] arrayOfInt1 = { System.identityHashCode(String.class), System.identityHashCode(System.class), (int)(l1 >>> 32), (int)l1, (int)(l2 >>> 32), (int)l2, (int)(System.nanoTime() >>> 2) };
/*      */ 
/* 3049 */     int i = 0;
/*      */ 
/* 3052 */     for (int m : arrayOfInt1) {
/* 3053 */       m *= -862048943;
/* 3054 */       m = m << 15 | m >>> 17;
/* 3055 */       m *= 461845907;
/*      */ 
/* 3057 */       i ^= m;
/* 3058 */       i = i << 13 | i >>> 19;
/* 3059 */       i = i * 5 + -430675100;
/*      */     }
/*      */ 
/* 3066 */     i ^= arrayOfInt1.length * 4;
/*      */ 
/* 3069 */     i ^= i >>> 16;
/* 3070 */     i *= -2048144789;
/* 3071 */     i ^= i >>> 13;
