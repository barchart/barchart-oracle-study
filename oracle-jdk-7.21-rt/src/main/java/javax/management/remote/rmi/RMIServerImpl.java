...
/*     */ {
/* 522 */   private static final ClassLogger logger = new ClassLogger("javax.management.remote.rmi", "RMIServerImpl");
/*     */ 
/* 528 */   private final List<WeakReference<RMIConnection>> clientList = new ArrayList();
...
/* 483 */     if (str1.length() > 0)
/* 484 */       localStringBuilder.append("//").append(str1);
...
/* 503 */     synchronized (this.clientList) {
/* 504 */       Iterator localIterator = this.clientList.iterator();
/* 505 */       while (localIterator.hasNext()) {
/* 506 */         WeakReference localWeakReference = (WeakReference)localIterator.next();
/* 507 */         if (localWeakReference.get() == null)
/* 508 */           localIterator.remove();
/*     */       }
/*     */     }
/*     */   }
/*     */ 
...
/*     */   {
/* 515 */     if (this.notifBuffer == null) {
/* 516 */       this.notifBuffer = ArrayNotificationBuffer.getNotificationBuffer(this.mbeanServer, this.env);
/*     */     }
/*     */ 
/* 519 */     return this.notifBuffer;
/*     */   }
/*     */ }
