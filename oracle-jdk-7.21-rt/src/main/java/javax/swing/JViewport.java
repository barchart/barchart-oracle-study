...
/*      */ 
/* 1590 */     localRepaintManager.copyArea(this, paramGraphics, paramInt5, paramInt6, paramInt9, paramInt10, i, j, false);
/*      */ 
/* 1594 */     int k = paramJComponent.getX();
/* 1595 */     int m = paramJComponent.getY();
/* 1596 */     paramGraphics.translate(k, m);
/* 1597 */     paramGraphics.setClip(paramInt1, paramInt2, paramInt3, paramInt4);
/* 1598 */     paramJComponent.paintForceDoubleBuffered(paramGraphics);
/* 1599 */     paramGraphics.translate(-k, -m);
/*      */   }
/*      */ 
/*      */   private void paintView(Graphics paramGraphics)
/*      */   {
/* 1609 */     Rectangle localRectangle = paramGraphics.getClipBounds();
/* 1610 */     JComponent localJComponent = (JComponent)getView();
/*      */ 
/* 1612 */     if (localJComponent.getWidth() >= getWidth())
/*      */     {
/* 1615 */       int i = localJComponent.getX();
/* 1616 */       int j = localJComponent.getY();
/* 1617 */       paramGraphics.translate(i, j);
/* 1618 */       paramGraphics.setClip(localRectangle.x - i, localRectangle.y - j, localRectangle.width, localRectangle.height);
/* 1619 */       localJComponent.paintForceDoubleBuffered(paramGraphics);
/* 1620 */       paramGraphics.translate(-i, -j);
/* 1621 */       paramGraphics.setClip(localRectangle.x, localRectangle.y, localRectangle.width, localRectangle.height);
/*      */     }
/*      */     else
/*      */     {
/*      */       try
/*      */       {
/* 1627 */         this.inBlitPaint = true;
/* 1628 */         paintForceDoubleBuffered(paramGraphics);
/*      */       } finally {
/* 1630 */         this.inBlitPaint = false;
/*      */       }
/*      */     }
/*      */   }
/*      */ 
...
/*      */   {
/* 1643 */     if ((!isShowing()) || ((!(getParent() instanceof JComponent)) && (!(getView() instanceof JComponent))))
/*      */     {
/* 1645 */       return false;
/*      */     }
/* 1647 */     if (isPainting())
...
/*      */     }
/*      */ 
/* 1654 */     Rectangle localRectangle1 = RepaintManager.currentManager(this).getDirtyRegion((JComponent)getParent());
/*      */ 
/* 1657 */     if ((localRectangle1 != null) && (localRectangle1.width > 0) && (localRectangle1.height > 0))
/*      */     {
/* 1660 */       return false;
/*      */     }
/*      */ 
/* 1663 */     Rectangle localRectangle2 = new Rectangle(0, 0, getWidth(), getHeight());
/* 1664 */     Rectangle localRectangle3 = new Rectangle();
/* 1665 */     Rectangle localRectangle4 = null;
/*      */ 
/* 1667 */     Object localObject2 = null;
/*      */ 
/* 1670 */     for (Object localObject1 = this; (localObject1 != null) && (isLightweightComponent((Component)localObject1)); localObject1 = ((Container)localObject1).getParent()) {
/* 1671 */       int i = ((Container)localObject1).getX();
/* 1672 */       int j = ((Container)localObject1).getY();
/* 1673 */       int k = ((Container)localObject1).getWidth();
/* 1674 */       int m = ((Container)localObject1).getHeight();
/*      */ 
/* 1676 */       localRectangle3.setBounds(localRectangle2);
/* 1677 */       SwingUtilities.computeIntersection(0, 0, k, m, localRectangle2);
/* 1678 */       if (!localRectangle2.equals(localRectangle3)) {
/* 1679 */         return false;
/*      */       }
/* 1681 */       if ((localObject2 != null) && ((localObject1 instanceof JComponent)) && (!((JComponent)localObject1).isOptimizedDrawingEnabled()))
/*      */       {
/* 1683 */         Component[] arrayOfComponent = ((Container)localObject1).getComponents();
/* 1684 */         int n = 0;
/*      */ 
/* 1686 */         for (int i1 = arrayOfComponent.length - 1; i1 >= 0; i1--) {
/* 1687 */           if (arrayOfComponent[i1] == localObject2) {
/* 1688 */             n = i1 - 1;
/* 1689 */             break;
/*      */           }
/*      */         }
/*      */ 
/* 1693 */         while (n >= 0) {
/* 1694 */           localRectangle4 = arrayOfComponent[n].getBounds(localRectangle4);
/*      */ 
/* 1696 */           if (localRectangle4.intersects(localRectangle2))
/* 1697 */             return false;
/* 1698 */           n--;
/*      */         }
/*      */       }
/* 1701 */       localRectangle2.x += i;
/* 1702 */       localRectangle2.y += j;
...
/*      */   {
/* 1727 */     if (this.accessibleContext == null) {
/* 1728 */       this.accessibleContext = new AccessibleJViewport();
/*      */     }
/* 1730 */     return this.accessibleContext;
/*      */   }
/*      */ 
...
/*      */     {
/* 1755 */       return AccessibleRole.VIEWPORT;
/*      */     }
/*      */   }
/*      */ 
