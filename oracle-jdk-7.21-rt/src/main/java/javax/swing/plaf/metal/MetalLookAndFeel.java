...
/* 2274 */   static ReferenceQueue<LookAndFeel> queue = new ReferenceQueue();
/*      */ 
...
/*      */     {
/* 2244 */       this.theme = paramMetalTheme;
/* 2245 */       this.type = paramInt;
/*      */     }
/*      */ 
/*      */     public Object createValue(UIDefaults paramUIDefaults) {
/* 2249 */       FontUIResource localFontUIResource = null;
/* 2250 */       switch (this.type) {
/*      */       case 0:
/* 2252 */         localFontUIResource = this.theme.getControlTextFont();
/* 2253 */         break;
/*      */       case 1:
/* 2255 */         localFontUIResource = this.theme.getSystemTextFont();
/* 2256 */         break;
/*      */       case 2:
/* 2258 */         localFontUIResource = this.theme.getUserTextFont();
/* 2259 */         break;
/*      */       case 3:
/* 2261 */         localFontUIResource = this.theme.getMenuTextFont();
/* 2262 */         break;
/*      */       case 4:
/* 2264 */         localFontUIResource = this.theme.getWindowTitleFont();
/* 2265 */         break;
/*      */       case 5:
/* 2267 */         localFontUIResource = this.theme.getSubTextFont();
/*      */       }
/*      */ 
/* 2270 */       return localFontUIResource;
/*      */     }
/*      */   }
/*      */ 
/*      */   private static class MetalLayoutStyle extends DefaultLayoutStyle
/*      */   {
/* 2370 */     private static MetalLayoutStyle INSTANCE = new MetalLayoutStyle();
/*      */ 
...
/*      */     {
/* 2377 */       super.getPreferredGap(paramJComponent1, paramJComponent2, paramComponentPlacement, paramInt, paramContainer);
/*      */ 
/* 2380 */       int i = 0;
/*      */ 
/* 2382 */       switch (MetalLookAndFeel.1.$SwitchMap$javax$swing$LayoutStyle$ComponentPlacement[paramComponentPlacement.ordinal()])
/*      */       {
/*      */       case 1:
/* 2385 */         if ((paramInt == 3) || (paramInt == 7))
/*      */         {
/* 2387 */           int j = getIndent(paramJComponent1, paramInt);
/* 2388 */           if (j > 0) {
/* 2389 */             return j;
/*      */           }
/* 2391 */           return 12;
...
/*      */ 
/*      */       case 2:
/* 2395 */         if ((paramJComponent1.getUIClassID() == "ToggleButtonUI") && (paramJComponent2.getUIClassID() == "ToggleButtonUI"))
/*      */         {
/* 2397 */           ButtonModel localButtonModel1 = ((JToggleButton)paramJComponent1).getModel();
/*      */ 
/* 2399 */           ButtonModel localButtonModel2 = ((JToggleButton)paramJComponent2).getModel();
/*      */ 
/* 2401 */           if (((localButtonModel1 instanceof DefaultButtonModel)) && ((localButtonModel2 instanceof DefaultButtonModel)) && (((DefaultButtonModel)localButtonModel1).getGroup() == ((DefaultButtonModel)localButtonModel2).getGroup()) && (((DefaultButtonModel)localButtonModel1).getGroup() != null))
/*      */           {
/* 2414 */             return 2;
/*      */           }
/*      */ 
/* 2419 */           if (MetalLookAndFeel.usingOcean()) {
/* 2420 */             return 6;
/*      */           }
/* 2422 */           return 5;
/*      */         }
...
/*      */       }
/*      */ 
/* 2430 */       if (isLabelAndNonlabel(paramJComponent1, paramJComponent2, paramInt))
/*      */       {
/* 2438 */         return getButtonGap(paramJComponent1, paramJComponent2, paramInt, i + 6);
/*      */       }
/*      */ 
/* 2441 */       return getButtonGap(paramJComponent1, paramJComponent2, paramInt, i);
/*      */     }
/*      */ 
/*      */     public int getContainerGap(JComponent paramJComponent, int paramInt, Container paramContainer)
/*      */     {
/* 2447 */       super.getContainerGap(paramJComponent, paramInt, paramContainer);
/*      */ 
/* 2464 */       return getButtonGap(paramJComponent, paramInt, 12 - getButtonAdjustment(paramJComponent, paramInt));
/*      */     }
/*      */ 
/*      */     protected int getButtonGap(JComponent paramJComponent1, JComponent paramJComponent2, int paramInt1, int paramInt2)
/*      */     {
/* 2471 */       paramInt2 = super.getButtonGap(paramJComponent1, paramJComponent2, paramInt1, paramInt2);
/* 2472 */       if (paramInt2 > 0) {
/* 2473 */         int i = getButtonAdjustment(paramJComponent1, paramInt1);
/* 2474 */         if (i == 0) {
/* 2475 */           i = getButtonAdjustment(paramJComponent2, flipDirection(paramInt1));
/*      */         }
/*      */ 
/* 2478 */         paramInt2 -= i;
/*      */       }
...
/* 2481 */         return 0;
/*      */       }
/* 2483 */       return paramInt2;
/*      */     }
/*      */ 
/*      */     private int getButtonAdjustment(JComponent paramJComponent, int paramInt) {
/* 2487 */       String str = paramJComponent.getUIClassID();
/* 2488 */       if ((str == "ButtonUI") || (str == "ToggleButtonUI")) {
/* 2489 */         if ((!MetalLookAndFeel.usingOcean()) && ((paramInt == 3) || (paramInt == 5)))
/*      */         {
/* 2491 */           if ((paramJComponent.getBorder() instanceof UIResource)) {
/* 2492 */             return 1;
/*      */           }
/*      */         }
/*      */       }
/* 2496 */       else if ((paramInt == 5) && 
/* 2497 */         ((str == "RadioButtonUI") || (str == "CheckBoxUI")) && (!MetalLookAndFeel.usingOcean()))
/*      */       {
/* 2499 */         return 1;
/*      */       }
/*      */ 
...
/*      */     {
/* 2194 */       this.className = paramString;
/*      */     }
/*      */ 
/*      */     MetalLazyValue(String paramString1, String paramString2) {
/* 2198 */       this(paramString1);
/* 2199 */       this.methodName = paramString2;
/*      */     }
/*      */ 
/*      */     public Object createValue(UIDefaults paramUIDefaults) {
/*      */       try {
/* 2204 */         final Class localClass = Class.forName(this.className);
/*      */ 
/* 2206 */         if (this.methodName == null) {
/* 2207 */           return localClass.newInstance();
/*      */         }
/* 2209 */         Method localMethod = (Method)AccessController.doPrivileged(new PrivilegedAction()
/*      */         {
/*      */           public Method run() {
/* 2212 */             Method[] arrayOfMethod = localClass.getDeclaredMethods();
/* 2213 */             for (int i = arrayOfMethod.length - 1; i >= 0; 
/* 2214 */               i--) {
/* 2215 */               if (arrayOfMethod[i].getName().equals(MetalLookAndFeel.MetalLazyValue.this.methodName)) {
/* 2216 */                 arrayOfMethod[i].setAccessible(true);
/* 2217 */                 return arrayOfMethod[i];
/*      */               }
/*      */             }
/* 2220 */             return null;
/*      */           }
/*      */         });
/* 2223 */         if (localMethod != null)
/* 2224 */           return localMethod.invoke(null, (Object[])null);
