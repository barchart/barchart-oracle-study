...
/*      */   {
/* 1929 */     if (paramClass.isInstance(paramComponentUI)) {
/* 1930 */       return paramComponentUI;
/*      */     }
/* 1932 */     return null;
/*      */   }
/*      */ 
...
/*      */   {
/* 1987 */     Object localObject = (ActionMap)UIManager.get("AuditoryCues.actionMap");
/*      */ 
/* 1989 */     if (localObject == null) {
/* 1990 */       Object[] arrayOfObject = (Object[])UIManager.get("AuditoryCues.cueList");
/* 1991 */       if (arrayOfObject != null) {
/* 1992 */         localObject = new ActionMapUIResource();
/* 1993 */         for (int i = arrayOfObject.length - 1; i >= 0; i--) {
/* 1994 */           ((ActionMap)localObject).put(arrayOfObject[i], createAudioAction(arrayOfObject[i]));
/*      */         }
/*      */       }
/*      */ 
/* 1998 */       UIManager.getLookAndFeelDefaults().put("AuditoryCues.actionMap", localObject);
/*      */     }
/*      */ 
/* 2001 */     return localObject;
/*      */   }
/*      */ 
/*      */   protected Action createAudioAction(Object paramObject)
/*      */   {
/* 2021 */     if (paramObject != null) {
/* 2022 */       String str1 = (String)paramObject;
/* 2023 */       String str2 = (String)UIManager.get(paramObject);
/* 2024 */       return new AudioAction(str1, str2);
/*      */     }
/* 2026 */     return null;
/*      */   }
/*      */ 
...
/*      */     }
/*      */ 
/* 2132 */     byte[] arrayOfByte = (byte[])AccessController.doPrivileged(new PrivilegedAction()
/*      */     {
/*      */       public byte[] run() {
/*      */         try {
/* 2136 */           InputStream localInputStream = BasicLookAndFeel.this.getClass().getResourceAsStream(paramString);
/*      */ 
/* 2138 */           if (localInputStream == null) {
/* 2139 */             return null;
/*      */           }
/* 2141 */           BufferedInputStream localBufferedInputStream = new BufferedInputStream(localInputStream);
/*      */ 
/* 2143 */           ByteArrayOutputStream localByteArrayOutputStream = new ByteArrayOutputStream(1024);
/*      */ 
/* 2145 */           byte[] arrayOfByte = new byte[1024];
/*      */           int i;
/* 2147 */           while ((i = localBufferedInputStream.read(arrayOfByte)) > 0) {
/* 2148 */             localByteArrayOutputStream.write(arrayOfByte, 0, i);
/*      */           }
/* 2150 */           localBufferedInputStream.close();
/* 2151 */           localByteArrayOutputStream.flush();
/* 2152 */           return localByteArrayOutputStream.toByteArray();
/*      */         }
/*      */         catch (IOException localIOException) {
/* 2155 */           System.err.println(localIOException.toString());
/* 2156 */         }return null;
/*      */       }
/*      */     });
/* 2160 */     if (arrayOfByte == null) {
/* 2161 */       System.err.println(getClass().getName() + "/" + paramString + " not found.");
/*      */ 
/* 2163 */       return null;
/*      */     }
/* 2165 */     if (arrayOfByte.length == 0) {
/* 2166 */       System.err.println("warning: " + paramString + " is zero-length");
/*      */ 
/* 2168 */       return null;
/*      */     }
/* 2170 */     return arrayOfByte;
/*      */   }
/*      */ 
/*      */   protected void playSound(Action paramAction)
/*      */   {
/* 2191 */     if (paramAction != null) {
/* 2192 */       Object[] arrayOfObject = (Object[])UIManager.get("AuditoryCues.playList");
/*      */ 
/* 2194 */       if (arrayOfObject != null)
/*      */       {
/* 2196 */         HashSet localHashSet = new HashSet();
/* 2197 */         for (Object localObject2 : arrayOfObject) {
/* 2198 */           localHashSet.add(localObject2);
/*      */         }
/*      */ 
/* 2201 */         ??? = (String)paramAction.getValue("Name");
/*      */ 
/* 2203 */         if (localHashSet.contains(???))
/* 2204 */           paramAction.actionPerformed(new ActionEvent(this, 1001, (String)???));
/*      */       }
/*      */     }
/*      */   }
/*      */ 
...
/*      */   {
/* 2218 */     LookAndFeel localLookAndFeel = UIManager.getLookAndFeel();
/* 2219 */     if ((localLookAndFeel instanceof BasicLookAndFeel))
/* 2220 */       paramActionMap.setParent(((BasicLookAndFeel)localLookAndFeel).getAudioActionMap());
/*      */   }
/*      */ 
/*      */   static void playSound(JComponent paramJComponent, Object paramObject)
/*      */   {
/* 2232 */     LookAndFeel localLookAndFeel = UIManager.getLookAndFeel();
/* 2233 */     if ((localLookAndFeel instanceof BasicLookAndFeel)) {
/* 2234 */       ActionMap localActionMap = paramJComponent.getActionMap();
/* 2235 */       if (localActionMap != null) {
/* 2236 */         Action localAction = localActionMap.get(paramObject);
/* 2237 */         if (localAction != null)
/*      */         {
/* 2239 */           ((BasicLookAndFeel)localLookAndFeel).playSound(localAction);
/*      */         }
/*      */       }
/*      */     }
/*      */   }
...
/*      */     AWTEventHelper()
/*      */     {
/* 2252 */       AccessController.doPrivileged(this);
/*      */     }
/*      */ 
/*      */     public Object run() {
/* 2256 */       Toolkit localToolkit = Toolkit.getDefaultToolkit();
/* 2257 */       if (BasicLookAndFeel.this.invocator == null)
/* 2258 */         localToolkit.addAWTEventListener(this, 16L);
/*      */       else {
/* 2260 */         localToolkit.removeAWTEventListener(BasicLookAndFeel.this.invocator);
/*      */       }
/*      */ 
/* 2263 */       return null;
/*      */     }
...
/* 2267 */       int i = paramAWTEvent.getID();
/*      */       Object localObject1;
/*      */       Object localObject2;
/*      */       Object localObject3;
/* 2268 */       if ((i & 0x10) != 0L) {
/* 2269 */         localObject1 = (MouseEvent)paramAWTEvent;
/* 2270 */         if (((MouseEvent)localObject1).isPopupTrigger()) {
/* 2271 */           localObject2 = MenuSelectionManager.defaultManager().getSelectedPath();
/*      */ 
/* 2274 */           if ((localObject2 != null) && (localObject2.length != 0)) {
/* 2275 */             return;
/*      */           }
/*      */ 
/* 2278 */           localObject3 = ((MouseEvent)localObject1).getSource();
/* 2279 */           JComponent localJComponent = null;
/* 2280 */           if ((localObject3 instanceof JComponent))
/* 2281 */             localJComponent = (JComponent)localObject3;
/* 2282 */           else if ((localObject3 instanceof BasicSplitPaneDivider))
/*      */           {
/* 2285 */             localJComponent = (JComponent)((BasicSplitPaneDivider)localObject3).getParent();
/*      */           }
/*      */ 
/* 2288 */           if ((localJComponent != null) && 
/* 2289 */             (localJComponent.getComponentPopupMenu() != null)) {
/* 2290 */             Point localPoint = localJComponent.getPopupLocation((MouseEvent)localObject1);
/* 2291 */             if (localPoint == null) {
/* 2292 */               localPoint = ((MouseEvent)localObject1).getPoint();
/* 2293 */               localPoint = SwingUtilities.convertPoint((Component)localObject3, localPoint, localJComponent);
/*      */             }
/*      */ 
/* 2296 */             localJComponent.getComponentPopupMenu().show(localJComponent, localPoint.x, localPoint.y);
/* 2297 */             ((MouseEvent)localObject1).consume();
/*      */           }
/*      */         }
/*      */ 
/*      */       }
/*      */ 
/* 2303 */       if (i == 501) {
/* 2304 */         localObject1 = paramAWTEvent.getSource();
/* 2305 */         if (!(localObject1 instanceof Component)) {
/* 2306 */           return;
/*      */         }
/* 2308 */         localObject2 = (Component)localObject1;
/* 2309 */         if (localObject2 != null) {
/* 2310 */           localObject3 = localObject2;
/* 2311 */           while ((localObject3 != null) && (!(localObject3 instanceof Window))) {
/* 2312 */             if ((localObject3 instanceof JInternalFrame))
/*      */               try {
/* 2314 */                 ((JInternalFrame)localObject3).setSelected(true);
/*      */               } catch (PropertyVetoException localPropertyVetoException) {
/*      */               }
/* 2317 */             localObject3 = ((Component)localObject3).getParent();
/*      */           }
/*      */         }
/*      */       }
/*      */     }
...
/* 2053 */       super();
/*      */       Object localObject;
/* 2054 */       this.audioResource = localObject;
/*      */     }
/*      */ 
/*      */     public void actionPerformed(ActionEvent paramActionEvent) {
/* 2058 */       if (this.audioBuffer == null) {
/* 2059 */         this.audioBuffer = BasicLookAndFeel.this.loadAudioData(this.audioResource);
/*      */       }
/* 2061 */       if (this.audioBuffer != null) {
/* 2062 */         cancelCurrentSound(null);
/*      */         try {
/* 2064 */           AudioInputStream localAudioInputStream = AudioSystem.getAudioInputStream(new ByteArrayInputStream(this.audioBuffer));
/*      */ 
/* 2067 */           DataLine.Info localInfo = new DataLine.Info(Clip.class, localAudioInputStream.getFormat());
/*      */ 
/* 2069 */           Clip localClip = (Clip)AudioSystem.getLine(localInfo);
/* 2070 */           localClip.open(localAudioInputStream);
/* 2071 */           localClip.addLineListener(this);
/*      */ 
/* 2073 */           synchronized (BasicLookAndFeel.this.audioLock) {
/* 2074 */             BasicLookAndFeel.this.clipPlaying = localClip;
/*      */           }
/*      */ 
/* 2077 */           localClip.start(); } catch (Exception localException) {
/*      */         }
/*      */       }
/*      */     }
/*      */ 
/*      */     public void update(LineEvent paramLineEvent) {
/* 2083 */       if (paramLineEvent.getType() == LineEvent.Type.STOP)
/* 2084 */         cancelCurrentSound((Clip)paramLineEvent.getLine());
/*      */     }
/*      */ 
/*      */     private void cancelCurrentSound(Clip paramClip)
/*      */     {
/* 2093 */       Clip localClip = null;
/*      */ 
/* 2095 */       synchronized (BasicLookAndFeel.this.audioLock) {
/* 2096 */         if ((paramClip == null) || (paramClip == BasicLookAndFeel.this.clipPlaying)) {
/* 2097 */           localClip = BasicLookAndFeel.this.clipPlaying;
/* 2098 */           BasicLookAndFeel.this.clipPlaying = null;
/*      */         }
/*      */       }
/*      */ 
/* 2102 */       if (localClip != null) {
/* 2103 */         localClip.removeLineListener(this);
/* 2104 */         localClip.close();
/*      */       }
/*      */     }
/*      */   }
/*      */ }
