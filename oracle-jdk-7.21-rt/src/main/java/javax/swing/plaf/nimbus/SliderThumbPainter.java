...
/* 400 */     return decodeGradient(0.51061F * f3 + f1, -4.553649E-18F * f4 + f2, 0.4993369F * f3 + f1, 1.003979F * f4 + f2, new float[] { 0.0F, 0.5F, 1.0F }, new Color[] { this.color1, decodeColor(this.color1, this.color2, 0.5F), this.color2 });
/*     */   }
/*     */ 
...
/* 428 */     return decodeGradient(0.51F * f3 + f1, -4.553649E-18F * f4 + f2, 0.51F * f3 + f1, 1.003979F * f4 + f2, new float[] { 0.0F, 0.5F, 1.0F }, new Color[] { this.color7, decodeColor(this.color7, this.color8, 0.5F), this.color8 });
/*     */   }
/*     */ 
...
/* 458 */     return decodeGradient(0.51061F * f3 + f1, -4.553649E-18F * f4 + f2, 0.4993369F * f3 + f1, 1.003979F * f4 + f2, new float[] { 0.0F, 0.5F, 1.0F }, new Color[] { this.color13, decodeColor(this.color13, this.color14, 0.5F), this.color14 });
/*     */   }
/*     */ 
...
/* 488 */     return decodeGradient(0.51061F * f3 + f1, -4.553649E-18F * f4 + f2, 0.4993369F * f3 + f1, 1.003979F * f4 + f2, new float[] { 0.0F, 0.5F, 1.0F }, new Color[] { this.color14, decodeColor(this.color14, this.color19, 0.5F), this.color19 });
/*     */   }
/*     */ 
