...
/*  66 */   private Color color9 = decodeColor("nimbusBase", 5.203486E-05F, -0.4175325F, 0.0980392F, -222);
...
/* 193 */     this.path.curveTo(decodeAnchorX(2.0F, 5.909091F), decodeAnchorY(1.933333F, -3.552714E-15F), decodeAnchorX(2.933333F, -0.04545455F), decodeAnchorY(1.066667F, 8.363636F), decodeX(2.933333F), decodeY(1.066667F));
