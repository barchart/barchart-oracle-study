...
/*      */   {
/* 1140 */     Element localElement = getElement();
/* 1141 */     int i = paramDocumentEvent.getOffset();
/* 1142 */     int j = getViewIndex(i, Position.Bias.Forward);
/* 1143 */     if ((j == -1) && (paramDocumentEvent.getType() == DocumentEvent.EventType.REMOVE) && (i >= getEndOffset()))
/*      */     {
/* 1148 */       j = getViewCount() - 1;
/*      */     }
/* 1150 */     int k = j;
/* 1151 */     View localView = j >= 0 ? getView(j) : null;
/* 1152 */     if ((localView != null) && 
/* 1153 */       (localView.getStartOffset() == i) && (i > 0))
/*      */     {
/* 1156 */       j = Math.max(j - 1, 0);
/*      */     }
/*      */ 
/* 1159 */     if (paramDocumentEvent.getType() != DocumentEvent.EventType.REMOVE) {
/* 1160 */       k = getViewIndex(i + paramDocumentEvent.getLength(), Position.Bias.Forward);
/* 1161 */       if (k < 0) {
/* 1162 */         k = getViewCount() - 1;
/*      */       }
/*      */     }
/* 1165 */     int m = k + 1;
/* 1166 */     int n = m;
/* 1167 */     Object localObject = paramElementChange != null ? paramElementChange.getChildrenAdded() : null;
/* 1168 */     if ((localObject != null) && (localObject.length > 0)) {
/* 1169 */       m = paramElementChange.getIndex();
/* 1170 */       n = m + localObject.length - 1;
/*      */     }
/*      */ 
/* 1176 */     j = Math.max(j, 0);
/* 1177 */     for (int i1 = j; i1 <= k; i1++)
/* 1178 */       if ((i1 < m) || (i1 > n)) {
/* 1179 */         localView = getView(i1);
/* 1180 */         if (localView != null) {
/* 1181 */           Shape localShape = getChildAllocation(i1, paramShape);
/* 1182 */           forwardUpdateToView(localView, paramDocumentEvent, localShape, paramViewFactory);
/*      */         }
/*      */       }
/*      */   }
/*      */ 
...
/*      */   {
/* 1205 */     DocumentEvent.EventType localEventType = paramDocumentEvent.getType();
/* 1206 */     if (localEventType == DocumentEvent.EventType.INSERT)
/* 1207 */       paramView.insertUpdate(paramDocumentEvent, paramShape, paramViewFactory);
/* 1208 */     else if (localEventType == DocumentEvent.EventType.REMOVE)
/* 1209 */       paramView.removeUpdate(paramDocumentEvent, paramShape, paramViewFactory);
/*      */     else
/* 1211 */       paramView.changedUpdate(paramDocumentEvent, paramShape, paramViewFactory);
/*      */   }
/*      */ 
...
/*      */   {
/* 1232 */     if ((paramElementChange != null) && (paramShape != null))
/*      */     {
/* 1234 */       preferenceChanged(null, true, true);
/* 1235 */       Container localContainer = getContainer();
/* 1236 */       if (localContainer != null)
/* 1237 */         localContainer.repaint();
/*      */     }
/*      */   }
/*      */ 
/*      */   @Deprecated
...
/*      */     throws BadLocationException
/*      */   {
/* 1318 */     return modelToView(paramInt, paramShape, Position.Bias.Forward);
/*      */   }
/*      */ 
/*      */   @Deprecated
...
/* 1337 */     return viewToModel(paramFloat1, paramFloat2, paramShape, sharedBiasReturn);
/*      */   }
/*      */ }
