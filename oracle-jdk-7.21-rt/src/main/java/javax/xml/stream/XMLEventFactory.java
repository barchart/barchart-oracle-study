...
/*     */   {
/*  59 */     return (XMLEventFactory)FactoryFinder.find("javax.xml.stream.XMLEventFactory", "com.sun.xml.internal.stream.events.XMLEventFactoryImpl");
/*     */   }
/*     */ 
/*     */   public static XMLEventFactory newFactory()
/*     */     throws FactoryConfigurationError
/*     */   {
/*  92 */     return (XMLEventFactory)FactoryFinder.find("javax.xml.stream.XMLEventFactory", "com.sun.xml.internal.stream.events.XMLEventFactoryImpl");
/*     */   }
/*     */ 
/*     */   /** @deprecated */
...
/*     */     try
/*     */     {
/* 117 */       return (XMLEventFactory)FactoryFinder.newInstance(factoryId, classLoader, false);
/*     */     } catch (FactoryFinder.ConfigurationError e) {
/* 119 */       throw new FactoryConfigurationError(e.getException(), e.getMessage());
/*     */     }
/*     */   }
/*     */ 
...
/*     */     try
/*     */     {
/* 144 */       return (XMLEventFactory)FactoryFinder.newInstance(factoryId, classLoader, false);
/*     */     } catch (FactoryFinder.ConfigurationError e) {
/* 146 */       throw new FactoryConfigurationError(e.getException(), e.getMessage());
/*     */     }
/*     */   }
/*     */ 
