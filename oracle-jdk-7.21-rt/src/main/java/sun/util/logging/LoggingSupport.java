...
/*     */   {
/* 154 */     String str = (String)AccessController.doPrivileged(new PrivilegedAction()
/*     */     {
/*     */       public String run()
/*     */       {
/* 158 */         return System.getProperty("java.util.logging.SimpleFormatter.format");
/*     */       }
/*     */     });
/* 162 */     if ((paramBoolean) && (proxy != null) && (str == null)) {
/* 163 */       str = proxy.getProperty("java.util.logging.SimpleFormatter.format");
/*     */     }
/*     */ 
/* 166 */     if (str != null)
/*     */       try
/*     */       {
/* 169 */         String.format(str, new Object[] { new Date(), "", "", "", "", "" });
/*     */       }
/*     */       catch (IllegalArgumentException localIllegalArgumentException) {
/* 172 */         str = "%1$tb %1$td, %1$tY %1$tl:%1$tM:%1$tS %1$Tp %2$s%n%4$s: %5$s%6$s%n";
/*     */       }
/*     */     else {
/* 175 */       str = "%1$tb %1$td, %1$tY %1$tl:%1$tM:%1$tS %1$Tp %2$s%n%4$s: %5$s%6$s%n";
/*     */     }
/* 177 */     return str;
/*     */   }
/*     */ }
