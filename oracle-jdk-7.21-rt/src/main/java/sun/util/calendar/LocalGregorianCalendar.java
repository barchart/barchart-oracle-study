...
/* 289 */         CalendarDate localCalendarDate = localEra.getSinceDate();
...
/*     */         }
/*     */ 
/* 323 */         l2 = localEra.getSince(paramCalendarDate.getZone());
/* 324 */         if (l1 >= l2) {
/*     */           break;
/*     */         }
/*     */       }
...
/* 331 */       m = localDate.getNormalizedYear() - localEra.getSinceDate().getYear() + 1;
