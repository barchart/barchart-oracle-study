...
/*     */ 
/* 408 */     localPermissionCollection.add(new RuntimePermission("accessClassInPackage.sun.jvmstat.*"));
/* 409 */     localPermissionCollection.add(new RuntimePermission("accessClassInPackage.sun.jvm.hotspot.*"));
/*     */ 
/* 411 */     localPermissionCollection.add(new FilePermission("<<ALL FILES>>", "read"));
/*     */ 
/* 417 */     ProtectionDomain localProtectionDomain = new ProtectionDomain(new CodeSource(null, (Certificate[])null), localPermissionCollection);
/*     */ 
/* 420 */     return new AccessControlContext(new ProtectionDomain[] { localProtectionDomain });
/*     */   }
/*     */ }
