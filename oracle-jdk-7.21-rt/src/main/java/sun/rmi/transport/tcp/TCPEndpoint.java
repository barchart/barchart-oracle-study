...
/*     */       {
/*     */       }
/* 632 */       throw new ConnectIOException("Exception creating connection to: " + this.host, localIOException);
/*     */     }
/*     */ 
/*     */     try
/*     */     {
/* 639 */       localSocket.setTcpNoDelay(true);
/*     */     }
...
/*     */     try
/*     */     {
/* 646 */       localSocket.setKeepAlive(true);
/*     */     }
/*     */     catch (Exception localException2)
/*     */     {
/*     */     }
/* 651 */     return localSocket;
/*     */   }
/*     */ 
...
/* 659 */       TCPTransport.tcpLog.log(Log.VERBOSE, "creating server socket on " + this);
/*     */     }
/*     */ 
/* 663 */     Object localObject = this.ssf;
/* 664 */     if (localObject == null) {
/* 665 */       localObject = chooseFactory();
/*     */     }
/* 667 */     ServerSocket localServerSocket = ((RMIServerSocketFactory)localObject).createServerSocket(this.listenPort);
/*     */ 
/* 671 */     if (this.listenPort == 0) {
/* 672 */       setDefaultPort(localServerSocket.getLocalPort(), this.csf, this.ssf);
/*     */     }
/* 674 */     return localServerSocket;
/*     */   }
/*     */ 
/*     */   static
/*     */   {
...
/*     */     {
/* 694 */       this.hostAddress = paramString;
/*     */     }
/*     */ 
/*     */     static String attemptFQDN(InetAddress paramInetAddress)
/*     */       throws java.net.UnknownHostException
/*     */     {
/* 718 */       Object localObject1 = paramInetAddress.getHostName();
/*     */ 
/* 720 */       if (((String)localObject1).indexOf('.') < 0)
/*     */       {
/* 722 */         String str = paramInetAddress.getHostAddress();
/* 723 */         FQDN localFQDN = new FQDN(str);
/*     */ 
/* 725 */         int i = TCPEndpoint.getInt("sun.rmi.transport.tcp.localHostNameTimeOut", 10000);
/*     */         try
/*     */         {
/* 730 */           synchronized (localFQDN) {
/* 731 */             localFQDN.getFQDN();
/*     */ 
/* 734 */             localFQDN.wait(i);
/*     */           }
/*     */         }
/*     */         catch (InterruptedException localInterruptedException) {
/* 738 */           Thread.currentThread().interrupt();
/*     */         }
/* 740 */         localObject1 = localFQDN.getHost();
/*     */ 
/* 742 */         if ((localObject1 == null) || (((String)localObject1).equals("")) || (((String)localObject1).indexOf('.') < 0))
/*     */         {
/* 745 */           localObject1 = str;
/*     */         }
/*     */       }
...
/*     */     {
/* 760 */       Thread localThread = (Thread)AccessController.doPrivileged(new NewThreadAction(this, "FQDN Finder", true));
/*     */ 
/* 762 */       localThread.start();
/*     */     }
/*     */ 
/*     */     private synchronized String getHost() {
/* 766 */       return this.reverseLookup;
/*     */     }
/*     */ 
/*     */     public void run()
/*     */     {
...
/*     */       try
/*     */       {
/* 777 */         str = InetAddress.getByName(this.hostAddress).getHostName();
/*     */       } catch (java.net.UnknownHostException ) {
/*     */       } finally {
/* 780 */         synchronized (this) {
/* 781 */           this.reverseLookup = str;
/* 782 */           notify();
/*     */         }
/*     */       }
/*     */     }
