...
/* 68 */       paramSurfaceData2 = this.oglgc.createManagedSurface(paramInt1, paramInt2, this.transparency);
/*    */     }
/* 70 */     return paramSurfaceData2;
/*    */   }
/*    */ 
...
/*    */   {
/* 79 */     return (paramCompositeType.isDerivedFrom(CompositeType.AnyAlpha)) && ((paramColor == null) || (this.transparency == 1));
/*    */   }
/*    */ }
