...
/*      */     //   873: iinc 13 255
/*      */     //   876: goto -36 -> 840
/*      */     //   879: new 431	java/lang/IllegalStateException
/*      */     //   882: dup
/*      */     //   883: ldc 17
...
/* 3254 */     if (this.runCount == 1) {
/* 3255 */       return getParaLevel();
/*      */     }
/* 3257 */     verifyIndex(paramInt, 0, this.runCount);
/* 3258 */     getLogicalToVisualRunsMap();
/* 3259 */     return this.runs[this.logicalToVisualRunsMap[paramInt]].level;
/*      */   }
/*      */ 
...
/* 3280 */     if (this.runCount == 1)
/* 3281 */       return 0;
/* 3282 */     if (paramInt == this.runCount) {
/* 3283 */       return this.length;
/*      */     }
/* 3285 */     verifyIndex(paramInt, 0, this.runCount);
/* 3286 */     getLogicalToVisualRunsMap();
/* 3287 */     return this.runs[this.logicalToVisualRunsMap[paramInt]].start;
/*      */   }
/*      */ 
...
/* 3309 */     if (this.runCount == 1) {
/* 3310 */       return this.length;
/*      */     }
/* 3312 */     verifyIndex(paramInt, 0, this.runCount);
/* 3313 */     getLogicalToVisualRunsMap();
/* 3314 */     int i = this.logicalToVisualRunsMap[paramInt];
/* 3315 */     int j = i == 0 ? this.runs[i].limit : this.runs[i].limit - this.runs[(i - 1)].limit;
/*      */ 
/* 3317 */     return this.runs[i].start + j;
/*      */   }
/*      */ 
/*      */   public static boolean requiresBidi(char[] paramArrayOfChar, int paramInt1, int paramInt2)
/*      */   {
/* 3345 */     if ((0 > paramInt1) || (paramInt1 > paramInt2) || (paramInt2 > paramArrayOfChar.length)) {
/* 3346 */       throw new IllegalArgumentException("Value start " + paramInt1 + " is out of range 0 to " + paramInt2);
/*      */     }
/*      */ 
/* 3349 */     for (int i = paramInt1; i < paramInt2; i++) {
/* 3350 */       if ((Character.isHighSurrogate(paramArrayOfChar[i])) && (i < paramInt2 - 1) && (Character.isLowSurrogate(paramArrayOfChar[(i + 1)])))
/*      */       {
/* 3352 */         if ((1 << UCharacter.getDirection(Character.codePointAt(paramArrayOfChar, i)) & 0xE022) != 0)
/* 3353 */           return true;
/*      */       }
/* 3355 */       else if ((1 << UCharacter.getDirection(paramArrayOfChar[i]) & 0xE022) != 0) {
/* 3356 */         return true;
/*      */       }
/*      */     }
/* 3359 */     return false;
...
/*      */   {
/* 3385 */     if ((0 > paramInt1) || (paramArrayOfByte.length <= paramInt1)) {
/* 3386 */       throw new IllegalArgumentException("Value levelStart " + paramInt1 + " is out of range 0 to " + (paramArrayOfByte.length - 1));
/*      */     }
/*      */ 
/* 3390 */     if ((0 > paramInt2) || (paramArrayOfObject.length <= paramInt2)) {
/* 3391 */       throw new IllegalArgumentException("Value objectStart " + paramInt1 + " is out of range 0 to " + (paramArrayOfObject.length - 1));
/*      */     }
/*      */ 
/* 3395 */     if ((0 > paramInt3) || (paramArrayOfObject.length < paramInt2 + paramInt3)) {
/* 3396 */       throw new IllegalArgumentException("Value count " + paramInt1 + " is out of range 0 to " + (paramArrayOfObject.length - paramInt2));
/*      */     }
/*      */ 
/* 3400 */     byte[] arrayOfByte = new byte[paramInt3];
/* 3401 */     System.arraycopy(paramArrayOfByte, paramInt1, arrayOfByte, 0, paramInt3);
/* 3402 */     int[] arrayOfInt = reorderVisual(arrayOfByte);
/* 3403 */     Object[] arrayOfObject = new Object[paramInt3];
/* 3404 */     System.arraycopy(paramArrayOfObject, paramInt2, arrayOfObject, 0, paramInt3);
/* 3405 */     for (int i = 0; i < paramInt3; i++)
/* 3406 */       paramArrayOfObject[(paramInt2 + i)] = arrayOfObject[arrayOfInt[i]];
/*      */   }
/*      */ 
/*      */   public String toString()
/*      */   {
/* 3414 */     StringBuilder localStringBuilder = new StringBuilder(getClass().getName());
/*      */ 
/* 3416 */     localStringBuilder.append("[dir: ");
/* 3417 */     localStringBuilder.append(this.direction);
/* 3418 */     localStringBuilder.append(" baselevel: ");
/* 3419 */     localStringBuilder.append(this.paraLevel);
/* 3420 */     localStringBuilder.append(" length: ");
/* 3421 */     localStringBuilder.append(this.length);
/* 3422 */     localStringBuilder.append(" runs: ");
/* 3423 */     if (this.levels == null) {
/* 3424 */       localStringBuilder.append("none");
/*      */     } else {
/* 3426 */       localStringBuilder.append('[');
/* 3427 */       localStringBuilder.append(this.levels[0]);
/* 3428 */       for (i = 1; i < this.levels.length; i++) {
/* 3429 */         localStringBuilder.append(' ');
/* 3430 */         localStringBuilder.append(this.levels[i]);
/*      */       }
/* 3432 */       localStringBuilder.append(']');
/*      */     }
/* 3434 */     localStringBuilder.append(" text: [0x");
/* 3435 */     localStringBuilder.append(Integer.toHexString(this.text[0]));
/* 3436 */     for (int i = 1; i < this.text.length; i++) {
/* 3437 */       localStringBuilder.append(" 0x");
/* 3438 */       localStringBuilder.append(Integer.toHexString(this.text[i]));
/*      */     }
/* 3440 */     localStringBuilder.append("]]");
/*      */ 
/* 3442 */     return localStringBuilder.toString();
/*      */   }
/*      */ 
...
/*      */   {
/* 3504 */     private static final Class<?> clazz = getClass("java.awt.font.NumericShaper");
/*      */ 
/* 3506 */     private static final Method shapeMethod = getMethod(clazz, "shape", new Class[] { [C.class, Integer.TYPE, Integer.TYPE });
/*      */ 
/*      */     private static Class<?> getClass(String paramString)
/*      */     {
/*      */       try {
/* 3511 */         return Class.forName(paramString, true, null); } catch (ClassNotFoundException localClassNotFoundException) {
/*      */       }
/* 3513 */       return null;
/*      */     }
/*      */ 
...
/*      */         try {
/* 3523 */           return paramClass.getMethod(paramString, paramArrayOfClass);
...
/*      */   {
/* 3450 */     private static final Class<?> clazz = getClass("java.awt.font.TextAttribute");
/*      */ 
...
/*      */ 
/* 3466 */     static final Boolean RUN_DIRECTION_LTR = clazz == null ? Boolean.FALSE : (Boolean)getStaticField(clazz, "RUN_DIRECTION_LTR");
/*      */ 
/*      */     private static Class<?> getClass(String paramString)
/*      */     {
/*      */       try
/*      */       {
/* 3472 */         return Class.forName(paramString, true, null); } catch (ClassNotFoundException localClassNotFoundException) {
/*      */       }
/* 3474 */       return null;
/*      */     }
/*      */ 
...
/*      */     {
/*      */       try {
/* 3480 */         Field localField = paramClass.getField(paramString);
/* 3481 */         return localField.get(null);
/*      */       } catch (NoSuchFieldException|IllegalAccessException localNoSuchFieldException) {
/* 3483 */         throw new AssertionError(localNoSuchFieldException);
/*      */       }
/*      */     }
/*      */ 
...
/* 3490 */       if (clazz == null)
/*      */       {
/* 3492 */         return new AttributedCharacterIterator.Attribute(paramString) { } ;
/*      */       }
/* 3494 */       return (AttributedCharacterIterator.Attribute)getStaticField(clazz, paramString);
/*      */     }
/*      */   }
/*      */ }
