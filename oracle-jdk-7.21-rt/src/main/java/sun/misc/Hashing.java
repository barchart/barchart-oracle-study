...
/*     */   {
/* 248 */     return Holder.LANG_ACCESS.getStringHash32(paramString);
/*     */   }
/*     */ 
...
/*     */     int i;
/* 253 */     if (VM.isBooted()) {
/* 254 */       i = Holder.SEED_MAKER.nextInt();
/*     */     }
/*     */     else
/*     */     {
/* 258 */       int[] arrayOfInt = { System.identityHashCode(Hashing.class), System.identityHashCode(paramObject), System.identityHashCode(Thread.currentThread()), (int)Thread.currentThread().getId(), (int)(System.currentTimeMillis() >>> 2), (int)(System.nanoTime() >>> 5), (int)(Runtime.getRuntime().freeMemory() >>> 4) };
/*     */ 
/* 268 */       i = murmur3_32(arrayOfInt);
/*     */     }
/*     */ 
/* 272 */     return 0 != i ? i : 1;
/*     */   }
...
/*     */   {
/* 220 */     static final Random SEED_MAKER = new Random(Double.doubleToRawLongBits(Math.random()) ^ System.identityHashCode(Hashing.class) ^ System.currentTimeMillis() ^ System.nanoTime() ^ Runtime.getRuntime().freeMemory());
/*     */ 
/* 233 */     static final JavaLangAccess LANG_ACCESS = SharedSecrets.getJavaLangAccess();
/*     */ 
/* 234 */     static { if (null == LANG_ACCESS)
