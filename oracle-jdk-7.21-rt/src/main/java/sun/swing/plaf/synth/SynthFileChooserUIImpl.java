...
/*      */   {
/*  887 */     return new FilterComboBoxRenderer(this.filterComboBox.getRenderer(), null);
/*      */   }
/*      */ 
...
/*      */   {
/* 1071 */     for (int i = 0; i < paramArrayOfAlignedLabel.length; i++)
/* 1072 */       paramArrayOfAlignedLabel[i].group = paramArrayOfAlignedLabel;
/*      */   }
/*      */ 
...
/*      */     AlignedLabel()
/*      */     {
/* 1082 */       setAlignmentX(0.0F);
/*      */     }
/*      */ 
/*      */     AlignedLabel(String arg2) {
/* 1086 */       super();
/* 1087 */       setAlignmentX(0.0F);
/*      */     }
/*      */ 
/*      */     public Dimension getPreferredSize() {
/* 1091 */       Dimension localDimension = super.getPreferredSize();
/*      */ 
/* 1093 */       return new Dimension(getMaxWidth() + 11, localDimension.height);
/*      */     }
/*      */ 
/*      */     private int getMaxWidth() {
/* 1097 */       if ((this.maxWidth == 0) && (this.group != null)) {
/* 1098 */         int i = 0;
/* 1099 */         for (int j = 0; j < this.group.length; j++) {
/* 1100 */           i = Math.max(this.group[j].getSuperPreferredWidth(), i);
/*      */         }
/* 1102 */         for (j = 0; j < this.group.length; j++) {
/* 1103 */           this.group[j].maxWidth = i;
/*      */         }
/*      */       }
/* 1106 */       return this.maxWidth;
/*      */     }
/*      */ 
...
/* 1009 */       Component[] arrayOfComponent = paramContainer.getComponents();
/*      */ 
/* 1011 */       if ((arrayOfComponent != null) && (arrayOfComponent.length > 0)) {
/* 1012 */         int i = arrayOfComponent.length;
/* 1013 */         Dimension[] arrayOfDimension = new Dimension[i];
/* 1014 */         Insets localInsets = paramContainer.getInsets();
/* 1015 */         int j = localInsets.top + this.topMargin;
/* 1016 */         int k = 0;
/*      */ 
/* 1018 */         for (int m = 0; m < i; m++) {
/* 1019 */           arrayOfDimension[m] = arrayOfComponent[m].getPreferredSize();
/* 1020 */           k = Math.max(k, arrayOfDimension[m].width);
/*      */         }
/*      */         int n;
/* 1023 */         if (paramContainer.getComponentOrientation().isLeftToRight()) {
/* 1024 */           m = paramContainer.getSize().width - localInsets.left - k;
/* 1025 */           n = this.hGap + k;
/*      */         } else {
/* 1027 */           m = localInsets.left;
/* 1028 */           n = -(this.hGap + k);
/*      */         }
/* 1030 */         for (int i1 = i - 1; i1 >= 0; i1--) {
/* 1031 */           arrayOfComponent[i1].setBounds(m, j, k, arrayOfDimension[i1].height);
/*      */ 
/* 1033 */           m -= n;
/*      */         }
/*      */       }
...
/* 1039 */       if (paramContainer != null) {
/* 1040 */         Component[] arrayOfComponent = paramContainer.getComponents();
/*      */ 
/* 1042 */         if ((arrayOfComponent != null) && (arrayOfComponent.length > 0)) {
/* 1043 */           int i = arrayOfComponent.length;
/* 1044 */           int j = 0;
/* 1045 */           Insets localInsets = paramContainer.getInsets();
/* 1046 */           int k = this.topMargin + localInsets.top + localInsets.bottom;
/* 1047 */           int m = localInsets.left + localInsets.right;
/* 1048 */           int n = 0;
/*      */ 
/* 1050 */           for (int i1 = 0; i1 < i; i1++) {
/* 1051 */             Dimension localDimension = arrayOfComponent[i1].getPreferredSize();
/* 1052 */             j = Math.max(j, localDimension.height);
/* 1053 */             n = Math.max(n, localDimension.width);
/*      */           }
/* 1055 */           return new Dimension(m + i * n + (i - 1) * this.hGap, k + j);
/*      */         }
/*      */ 
/*      */       }
/*      */ 
...
/* 1064 */       return minimumLayoutSize(paramContainer);
/*      */     }
/*      */ 
...
/*  874 */       SynthFileChooserUIImpl.this.directoryComboBox.hidePopup();
/*  875 */       JComponent localJComponent = SynthFileChooserUIImpl.this.getDirectoryComboBox();
/*  876 */       if ((localJComponent instanceof JComboBox)) {
/*  877 */         File localFile = (File)((JComboBox)localJComponent).getSelectedItem();
/*  878 */         SynthFileChooserUIImpl.this.getFileChooser().setCurrentDirectory(localFile);
/*      */       }
/*      */     }
/*      */   }
/*      */ 
...
/*      */       File[] arrayOfFile;
/*  775 */       if (bool)
/*  776 */         arrayOfFile = (File[])AccessController.doPrivileged(new PrivilegedAction() {
/*      */           public File[] run() {
/*  778 */             return (File[])ShellFolder.get("fileChooserComboBoxFolders");
/*      */           }
/*      */         });
/*      */       else {
/*  782 */         arrayOfFile = this.fsv.getRoots();
/*      */       }
/*      */ 
/*  784 */       this.directories.addAll(Arrays.asList(arrayOfFile));
/*      */       File localFile1;
/*      */       try
/*      */       {
/*  791 */         localFile1 = ShellFolder.getNormalizedFile(paramFile);
/*      */       }
/*      */       catch (IOException localIOException) {
/*  794 */         localFile1 = paramFile;
/*      */       }
/*      */ 
/*      */       try
/*      */       {
/*  799 */         File localFile2 = bool ? ShellFolder.getShellFolder(localFile1) : localFile1;
/*      */ 
/*  801 */         File localFile3 = localFile2;
/*  802 */         Vector localVector = new Vector(10);
/*      */         do
/*  804 */           localVector.addElement(localFile3);
/*  805 */         while ((localFile3 = localFile3.getParentFile()) != null);
/*      */ 
/*  807 */         int j = localVector.size();
/*      */ 
/*  809 */         for (int k = 0; k < j; k++) {
/*  810 */           localFile3 = (File)localVector.get(k);
/*  811 */           if (this.directories.contains(localFile3)) {
/*  812 */             int m = this.directories.indexOf(localFile3);
/*  813 */             for (int n = k - 1; n >= 0; n--) {
/*  814 */               this.directories.insertElementAt(localVector.get(n), m + k - n);
/*      */             }
/*  816 */             break;
/*      */           }
/*      */         }
/*  819 */         calculateDepths();
/*  820 */         setSelectedItem(localFile2);
...
/*  827 */       this.depths = new int[this.directories.size()];
/*  828 */       for (int i = 0; i < this.depths.length; i++) {
/*  829 */         File localFile1 = (File)this.directories.get(i);
/*  830 */         File localFile2 = localFile1.getParentFile();
/*  831 */         this.depths[i] = 0;
/*  832 */         if (localFile2 != null)
/*  833 */           for (int j = i - 1; j >= 0; j--)
/*  834 */             if (localFile2.equals(this.directories.get(j))) {
/*  835 */               this.depths[j] += 1;
/*  836 */               break;
/*      */             }
/*      */       }
...
/*      */     {
/*  844 */       return (this.depths != null) && (paramInt >= 0) && (paramInt < this.depths.length) ? this.depths[paramInt] : 0;
/*      */     }
/*      */ 
/*      */     public void setSelectedItem(Object paramObject) {
/*  848 */       this.selectedDirectory = ((File)paramObject);
/*  849 */       fireContentsChanged(this, -1, -1);
/*      */     }
/*      */ 
/*      */     public Object getSelectedItem() {
/*  853 */       return this.selectedDirectory;
/*      */     }
/*      */ 
/*      */     public int getSize() {
/*  857 */       return this.directories.size();
/*      */     }
/*      */ 
/*      */     public Object getElementAt(int paramInt) {
/*  861 */       return this.directories.elementAt(paramInt);
/*      */     }
/*      */   }
/*      */ 
...
/*      */     {
/*  931 */       this.filters = SynthFileChooserUIImpl.this.getFileChooser().getChoosableFileFilters();
/*      */     }
/*      */ 
/*      */     public void propertyChange(PropertyChangeEvent paramPropertyChangeEvent) {
/*  935 */       String str = paramPropertyChangeEvent.getPropertyName();
/*  936 */       if (str == "ChoosableFileFilterChangedProperty") {
/*  937 */         this.filters = ((FileFilter[])paramPropertyChangeEvent.getNewValue());
/*  938 */         fireContentsChanged(this, -1, -1);
/*  939 */       } else if (str == "fileFilterChanged") {
/*  940 */         fireContentsChanged(this, -1, -1);
/*      */       }
/*      */     }
/*      */ 
/*      */     public void setSelectedItem(Object paramObject) {
/*  945 */       if (paramObject != null) {
/*  946 */         SynthFileChooserUIImpl.this.getFileChooser().setFileFilter((FileFilter)paramObject);
...
/*      */     public Object getSelectedItem()
/*      */     {
/*  957 */       FileFilter localFileFilter1 = SynthFileChooserUIImpl.this.getFileChooser().getFileFilter();
/*  958 */       int i = 0;
/*  959 */       if (localFileFilter1 != null) {
/*  960 */         for (FileFilter localFileFilter2 : this.filters) {
/*  961 */           if (localFileFilter2 == localFileFilter1) {
/*  962 */             i = 1;
/*      */           }
/*      */         }
/*  965 */         if (i == 0) {
/*  966 */           SynthFileChooserUIImpl.this.getFileChooser().addChoosableFileFilter(localFileFilter1);
/*      */         }
/*      */       }
/*  969 */       return SynthFileChooserUIImpl.this.getFileChooser().getFileFilter();
/*      */     }
/*      */ 
/*      */     public int getSize() {
/*  973 */       if (this.filters != null) {
/*  974 */         return this.filters.length;
/*      */       }
/*  976 */       return 0;
/*      */     }
/*      */ 
/*      */     public Object getElementAt(int paramInt)
/*      */     {
/*  981 */       if (paramInt > getSize() - 1)
/*      */       {
/*  983 */         return SynthFileChooserUIImpl.this.getFileChooser().getFileFilter();
/*      */       }
/*  985 */       if (this.filters != null) {
/*  986 */         return this.filters[paramInt];
/*      */       }
/*  988 */       return null;
/*      */     }
/*      */   }
...
/*      */     {
/*      */       Object localObject;
/*  896 */       this.delegate = localObject;
/*      */     }
/*      */ 
/*      */     public Component getListCellRendererComponent(JList paramJList, Object paramObject, int paramInt, boolean paramBoolean1, boolean paramBoolean2) {
/*  900 */       Component localComponent = this.delegate.getListCellRendererComponent(paramJList, paramObject, paramInt, paramBoolean1, paramBoolean2);
/*      */ 
/*  902 */       String str = null;
/*  903 */       if ((paramObject != null) && ((paramObject instanceof FileFilter))) {
/*  904 */         str = ((FileFilter)paramObject).getDescription();
/*      */       }
/*      */ 
/*  909 */       assert ((localComponent instanceof JLabel));
/*  910 */       if (str != null) {
/*  911 */         ((JLabel)localComponent).setText(str);
/*      */       }
/*  913 */       return localComponent;
/*      */     }
/*      */   }
/*      */ 
/*      */   class IndentIcon
