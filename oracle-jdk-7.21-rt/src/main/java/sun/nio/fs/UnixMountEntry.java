...
/*    */   String name()
/*    */   {
/* 46 */     return new String(this.name);
/*    */   }
/*    */ 
/*    */   String fstype() {
/* 50 */     if (this.fstypeAsString == null)
/* 51 */       this.fstypeAsString = new String(this.fstype);
...
/* 68 */       this.optionsAsString = new String(this.opts);
 ...
 * Qualified Name:     sun.nio.fs.UnixMountEntry
