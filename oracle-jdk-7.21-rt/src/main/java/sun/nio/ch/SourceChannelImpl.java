...
/*     */     }
/*     */ 
/* 131 */     if (((paramInt1 & 0x1) != 0) && ((i & 0x1) != 0))
/*     */     {
/* 133 */       k |= 1;
/*     */     }
...
/*     */         do
/* 168 */           i = IOUtil.read(this.fd, paramByteBuffer, -1L, nd, this.lock);
...
/*     */     throws IOException
/*     */   {
/* 182 */     if ((paramInt1 < 0) || (paramInt2 < 0) || (paramInt1 > paramArrayOfByteBuffer.length - paramInt2))
/* 183 */       throw new IndexOutOfBoundsException();
/* 184 */     return read(Util.subsequence(paramArrayOfByteBuffer, paramInt1, paramInt2));
/*     */   }
/*     */ 
/*     */   public long read(ByteBuffer[] paramArrayOfByteBuffer) throws IOException {
/* 188 */     if (paramArrayOfByteBuffer == null)
...
/* 203 */           this.thread = 0L;
/* 204 */           end((l1 > 0L) || (l1 == -2L));
/* 205 */           assert (IOStatus.check(l1)); return l2;
/*     */         }
/* 197 */         this.thread = NativeThread.current();
/*     */         do
/* 199 */           l1 = IOUtil.read(this.fd, paramArrayOfByteBuffer, nd);
/* 200 */         while ((l1 == -3L) && (isOpen()));
/* 201 */         long l2 = IOStatus.normalize(l1);
/*     */ 
/* 203 */         this.thread = 0L;
/* 204 */         end((l1 > 0L) || (l1 == -2L));
/* 205 */         assert (IOStatus.check(l1)); return l2;
...
/* 203 */         this.thread = 0L;
/* 204 */         end((l1 > 0L) || (l1 == -2L));
/* 205 */         if ((!$assertionsDisabled) && (!IOStatus.check(l1))) throw new AssertionError(); 
/*     */       }
/*     */     }
/*     */   }
/*     */ 
