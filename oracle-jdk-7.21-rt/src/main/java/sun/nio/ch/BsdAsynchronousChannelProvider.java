...
/*    */ 
/*    */   private KQueuePort defaultEventPort()
/*    */     throws IOException
/*    */   {
/* 40 */     if (defaultPort == null) {
/* 41 */       synchronized (BsdAsynchronousChannelProvider.class) {
/* 42 */         if (defaultPort == null) {
/* 43 */           defaultPort = new KQueuePort(this, ThreadPool.getDefault()).start();
/*    */         }
/*    */       }
/*    */     }
...
/*    */     throws IOException
/*    */   {
/* 57 */     return new KQueuePort(this, ThreadPool.create(paramInt, paramThreadFactory)).start();
/*    */   }
/*    */ 
/*    */   public AsynchronousChannelGroup openAsynchronousChannelGroup(ExecutorService paramExecutorService, int paramInt)
/*    */     throws IOException
/*    */   {
/* 64 */     return new KQueuePort(this, ThreadPool.wrap(paramExecutorService, paramInt)).start();
/*    */   }
/*    */ 
...
/*    */     }
/* 71 */     if (!(paramAsynchronousChannelGroup instanceof KQueuePort))
 ...
 * Qualified Name:     sun.nio.ch.BsdAsynchronousChannelProvider
