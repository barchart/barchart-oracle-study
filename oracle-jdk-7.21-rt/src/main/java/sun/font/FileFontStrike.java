...
/* 752 */       l = 0xFFFFFFFF & StrikeCache.unsafe.getInt(paramLong + StrikeCache.pixelDataOffset);
/*     */     }
/*     */     else {
/* 755 */       l = StrikeCache.unsafe.getLong(paramLong + StrikeCache.pixelDataOffset);
/*     */     }
/*     */ 
/* 758 */     if (l == 0L) {
/* 759 */       return paramInt;
/*     */     }
/*     */ 
/* 762 */     for (int m = 0; m < j; m++) {
/* 763 */       for (int n = 0; n < 3; n++) {
/* 764 */         if (StrikeCache.unsafe.getByte(l + m * k + n) != 0) {
/* 765 */           return paramInt;
/*     */         }
/*     */       }
/*     */     }
/* 769 */     return paramInt + 1;
/*     */   }
/*     */ 
/*     */   StrikeMetrics getFontMetrics()
/*     */   {
/* 776 */     if (this.strikeMetrics == null) {
/* 777 */       this.strikeMetrics = this.fileFont.getFontMetrics(this.pScalerContext);
/*     */ 
/* 779 */       if (this.invertDevTx != null) {
/* 780 */         this.strikeMetrics.convertToUserSpace(this.invertDevTx);
/*     */       }
/*     */     }
/* 783 */     return this.strikeMetrics;
/*     */   }
/*     */ 
/*     */   Point2D.Float getGlyphMetrics(int paramInt) {
/* 787 */     return getGlyphMetrics(paramInt, true);
/*     */   }
/*     */ 
/*     */   private Point2D.Float getGlyphMetrics(int paramInt, boolean paramBoolean) {
/* 791 */     Point2D.Float localFloat1 = new Point2D.Float();
/*     */ 
/* 794 */     if (paramInt >= 65534)
/* 795 */       return localFloat1;
/*     */     long l;
/* 798 */     if ((this.getImageWithAdvance) && (paramBoolean))
/*     */     {
/* 804 */       l = getGlyphImagePtr(paramInt);
/*     */     }
/* 806 */     else l = getCachedGlyphPtr(paramInt);
/*     */ 
/* 808 */     if (l != 0L) {
/* 809 */       localFloat1 = new Point2D.Float();
/* 810 */       localFloat1.x = StrikeCache.unsafe.getFloat(l + StrikeCache.xAdvanceOffset);
/*     */ 
/* 812 */       localFloat1.y = StrikeCache.unsafe.getFloat(l + StrikeCache.yAdvanceOffset);
/*     */ 
/* 817 */       if (this.invertDevTx != null) {
/* 818 */         this.invertDevTx.deltaTransform(localFloat1, localFloat1);
/*     */       }
/*     */ 
/*     */     }
/*     */     else
/*     */     {
/* 828 */       Integer localInteger = Integer.valueOf(paramInt);
/* 829 */       Point2D.Float localFloat2 = null;
/* 830 */       ConcurrentHashMap localConcurrentHashMap = null;
/* 831 */       if (this.glyphMetricsMapRef != null) {
/* 832 */         localConcurrentHashMap = (ConcurrentHashMap)this.glyphMetricsMapRef.get();
/*     */       }
/* 834 */       if (localConcurrentHashMap != null) {
/* 835 */         localFloat2 = (Point2D.Float)localConcurrentHashMap.get(localInteger);
/* 836 */         if (localFloat2 != null) {
/* 837 */           localFloat1.x = localFloat2.x;
/* 838 */           localFloat1.y = localFloat2.y;
/*     */ 
/* 840 */           return localFloat1;
/*     */         }
/*     */       }
/* 843 */       if (localFloat2 == null) {
/* 844 */         this.fileFont.getGlyphMetrics(this.pScalerContext, paramInt, localFloat1);
/*     */ 
/* 848 */         if (this.invertDevTx != null) {
/* 849 */           this.invertDevTx.deltaTransform(localFloat1, localFloat1);
/*     */         }
/* 851 */         localFloat2 = new Point2D.Float(localFloat1.x, localFloat1.y);
/*     */ 
/* 855 */         if (localConcurrentHashMap == null) {
/* 856 */           localConcurrentHashMap = new ConcurrentHashMap();
/*     */ 
/* 858 */           this.glyphMetricsMapRef = new SoftReference(localConcurrentHashMap);
/*     */         }
/*     */ 
/* 862 */         localConcurrentHashMap.put(localInteger, localFloat2);
/*     */       }
/*     */     }
/* 865 */     return localFloat1;
/*     */   }
/*     */ 
/*     */   Point2D.Float getCharMetrics(char paramChar) {
/* 869 */     return getGlyphMetrics(this.mapper.charToGlyph(paramChar));
/*     */   }
/*     */ 
/*     */   Rectangle2D.Float getGlyphOutlineBounds(int paramInt)
/*     */   {
/* 891 */     if (this.boundsMap == null) {
/* 892 */       this.boundsMap = new ConcurrentHashMap();
/*     */     }
/*     */ 
/* 895 */     Integer localInteger = Integer.valueOf(paramInt);
/* 896 */     Rectangle2D.Float localFloat = (Rectangle2D.Float)this.boundsMap.get(localInteger);
/*     */ 
/* 898 */     if (localFloat == null) {
/* 899 */       localFloat = this.fileFont.getGlyphOutlineBounds(this.pScalerContext, paramInt);
/* 900 */       this.boundsMap.put(localInteger, localFloat);
/*     */     }
/* 902 */     return localFloat;
/*     */   }
/*     */ 
/*     */   public Rectangle2D getOutlineBounds(int paramInt) {
/* 906 */     return this.fileFont.getGlyphOutlineBounds(this.pScalerContext, paramInt);
/*     */   }
/*     */ 
/*     */   GeneralPath getGlyphOutline(int paramInt, float paramFloat1, float paramFloat2)
/*     */   {
/* 914 */     GeneralPath localGeneralPath = null;
/* 915 */     ConcurrentHashMap localConcurrentHashMap = null;
/*     */ 
/* 917 */     if (this.outlineMapRef != null) {
/* 918 */       localConcurrentHashMap = (ConcurrentHashMap)this.outlineMapRef.get();
/* 919 */       if (localConcurrentHashMap != null) {
/* 920 */         localGeneralPath = (GeneralPath)localConcurrentHashMap.get(Integer.valueOf(paramInt));
/*     */       }
/*     */     }
/*     */ 
/* 924 */     if (localGeneralPath == null) {
/* 925 */       localGeneralPath = this.fileFont.getGlyphOutline(this.pScalerContext, paramInt, 0.0F, 0.0F);
/* 926 */       if (localConcurrentHashMap == null) {
/* 927 */         localConcurrentHashMap = new ConcurrentHashMap();
/* 928 */         this.outlineMapRef = new WeakReference(localConcurrentHashMap);
/*     */       }
/*     */ 
/* 932 */       localConcurrentHashMap.put(Integer.valueOf(paramInt), localGeneralPath);
/*     */     }
/* 934 */     localGeneralPath = (GeneralPath)localGeneralPath.clone();
/* 935 */     if ((paramFloat1 != 0.0F) || (paramFloat2 != 0.0F)) {
/* 936 */       localGeneralPath.transform(AffineTransform.getTranslateInstance(paramFloat1, paramFloat2));
/*     */     }
/* 938 */     return localGeneralPath;
/*     */   }
/*     */ 
/*     */   GeneralPath getGlyphVectorOutline(int[] paramArrayOfInt, float paramFloat1, float paramFloat2) {
/* 942 */     return this.fileFont.getGlyphVectorOutline(this.pScalerContext, paramArrayOfInt, paramArrayOfInt.length, paramFloat1, paramFloat2);
/*     */   }
/*     */ 
/*     */   protected void adjustPoint(Point2D.Float paramFloat)
/*     */   {
/* 947 */     if (this.invertDevTx != null)
/* 948 */       this.invertDevTx.deltaTransform(paramFloat, paramFloat);
/*     */   }
/*     */ 
/*     */   static
/*     */   {
