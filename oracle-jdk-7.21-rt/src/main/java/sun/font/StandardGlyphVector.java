...
/*      */   {
/* 1829 */     return appendString(null).toString();
/*      */   }
/*      */ 
/*      */   StringBuffer appendString(StringBuffer paramStringBuffer) {
/* 1833 */     if (paramStringBuffer == null)
/* 1834 */       paramStringBuffer = new StringBuffer();
/*      */     try
/*      */     {
/* 1837 */       paramStringBuffer.append("SGV{font: ");
/* 1838 */       paramStringBuffer.append(this.font.toString());
/* 1839 */       paramStringBuffer.append(", frc: ");
/* 1840 */       paramStringBuffer.append(this.frc.toString());
/* 1841 */       paramStringBuffer.append(", glyphs: (");
/* 1842 */       paramStringBuffer.append(this.glyphs.length);
/* 1843 */       paramStringBuffer.append(")[");
/* 1844 */       for (int i = 0; i < this.glyphs.length; i++) {
/* 1845 */         if (i > 0) {
/* 1846 */           paramStringBuffer.append(", ");
/*      */         }
/* 1848 */         paramStringBuffer.append(Integer.toHexString(this.glyphs[i]));
/*      */       }
/* 1850 */       paramStringBuffer.append("]");
/* 1851 */       if (this.positions != null) {
/* 1852 */         paramStringBuffer.append(", positions: (");
/* 1853 */         paramStringBuffer.append(this.positions.length);
/* 1854 */         paramStringBuffer.append(")[");
/* 1855 */         for (i = 0; i < this.positions.length; i += 2) {
/* 1856 */           if (i > 0) {
/* 1857 */             paramStringBuffer.append(", ");
/*      */           }
/* 1859 */           paramStringBuffer.append(this.positions[i]);
/* 1860 */           paramStringBuffer.append("@");
/* 1861 */           paramStringBuffer.append(this.positions[(i + 1)]);
/*      */         }
/* 1863 */         paramStringBuffer.append("]");
/*      */       }
/* 1865 */       if (this.charIndices != null) {
/* 1866 */         paramStringBuffer.append(", indices: (");
/* 1867 */         paramStringBuffer.append(this.charIndices.length);
/* 1868 */         paramStringBuffer.append(")[");
/* 1869 */         for (i = 0; i < this.charIndices.length; i++) {
/* 1870 */           if (i > 0) {
/* 1871 */             paramStringBuffer.append(", ");
/*      */           }
/* 1873 */           paramStringBuffer.append(this.charIndices[i]);
/*      */         }
/* 1875 */         paramStringBuffer.append("]");
/*      */       }
/* 1877 */       paramStringBuffer.append(", flags:");
/* 1878 */       if (getLayoutFlags() == 0) {
/* 1879 */         paramStringBuffer.append(" default");
/*      */       } else {
/* 1881 */         if ((this.flags & 0x1) != 0) {
/* 1882 */           paramStringBuffer.append(" tx");
/*      */         }
/* 1884 */         if ((this.flags & 0x2) != 0) {
/* 1885 */           paramStringBuffer.append(" pos");
/*      */         }
/* 1887 */         if ((this.flags & 0x4) != 0) {
/* 1888 */           paramStringBuffer.append(" rtl");
/*      */         }
/* 1890 */         if ((this.flags & 0x8) != 0)
/* 1891 */           paramStringBuffer.append(" complex");
/*      */       }
/*      */     }
/*      */     catch (Exception localException)
/*      */     {
/* 1896 */       paramStringBuffer.append(" " + localException.getMessage());
/*      */     }
/* 1898 */     paramStringBuffer.append("}");
/*      */ 
/* 1900 */     return paramStringBuffer; } 
...
/*      */ 
/* 1912 */     public String toString() { return toStringBuffer(null).toString(); }
/*      */ 
/*      */     protected StringBuffer toStringBuffer(StringBuffer paramStringBuffer)
/*      */     {
/* 1916 */       if (paramStringBuffer == null) {
/* 1917 */         paramStringBuffer = new StringBuffer();
/*      */       }
/* 1919 */       paramStringBuffer.append("ax: ");
/* 1920 */       paramStringBuffer.append(this.ascentX);
/* 1921 */       paramStringBuffer.append(" ay: ");
/* 1922 */       paramStringBuffer.append(this.ascentY);
/* 1923 */       paramStringBuffer.append(" dx: ");
/* 1924 */       paramStringBuffer.append(this.descentX);
/* 1925 */       paramStringBuffer.append(" dy: ");
/* 1926 */       paramStringBuffer.append(this.descentY);
/* 1927 */       paramStringBuffer.append(" lx: ");
/* 1928 */       paramStringBuffer.append(this.leadingX);
/* 1929 */       paramStringBuffer.append(" ly: ");
/* 1930 */       paramStringBuffer.append(this.leadingY);
/*      */ 
...
/*      */ 
/* 1744 */       FontStrike localFontStrike = paramStandardGlyphVector.font2D.getStrike(localFontStrikeDesc);
/*      */ 
/* 1746 */       return new GlyphStrike(paramStandardGlyphVector, localFontStrike, f1, f2);
/*      */     }
/*      */ 
...
/* 1750 */       this.sgv = paramStandardGlyphVector;
/* 1751 */       this.strike = paramFontStrike;
/* 1752 */       this.dx = paramFloat1;
/* 1753 */       this.dy = paramFloat2;
/*      */     }
/*      */ 
/*      */     void getADL(StandardGlyphVector.ADL paramADL) {
/* 1757 */       StrikeMetrics localStrikeMetrics = this.strike.getFontMetrics();
/* 1758 */       Point2D.Float localFloat = null;
/* 1759 */       if (this.sgv.font.isTransformed()) {
/* 1760 */         localFloat = new Point2D.Float();
/* 1761 */         localFloat.x = ((float)this.sgv.font.getTransform().getTranslateX());
/* 1762 */         localFloat.y = ((float)this.sgv.font.getTransform().getTranslateY());
/*      */       }
/*      */ 
/* 1765 */       paramADL.ascentX = (-localStrikeMetrics.ascentX);
/* 1766 */       paramADL.ascentY = (-localStrikeMetrics.ascentY);
/* 1767 */       paramADL.descentX = localStrikeMetrics.descentX;
/* 1768 */       paramADL.descentY = localStrikeMetrics.descentY;
/* 1769 */       paramADL.leadingX = localStrikeMetrics.leadingX;
/* 1770 */       paramADL.leadingY = localStrikeMetrics.leadingY;
/*      */     }
/*      */ 
/*      */     void getGlyphPosition(int paramInt1, int paramInt2, float[] paramArrayOfFloat1, float[] paramArrayOfFloat2) {
/* 1774 */       paramArrayOfFloat1[paramInt2] += this.dx;
/* 1775 */       paramInt2++;
/* 1776 */       paramArrayOfFloat1[paramInt2] += this.dy;
/*      */     }
/*      */ 
/*      */     void addDefaultGlyphAdvance(int paramInt, Point2D.Float paramFloat)
/*      */     {
/* 1782 */       Point2D.Float localFloat = this.strike.getGlyphMetrics(paramInt);
/* 1783 */       paramFloat.x += localFloat.x + this.dx;
/* 1784 */       paramFloat.y += localFloat.y + this.dy;
/*      */     }
/*      */ 
/*      */     Rectangle2D getGlyphOutlineBounds(int paramInt, float paramFloat1, float paramFloat2) {
/* 1788 */       Object localObject = null;
/* 1789 */       if (this.sgv.invdtx == null) {
/* 1790 */         localObject = new Rectangle2D.Float();
/* 1791 */         ((Rectangle2D)localObject).setRect(this.strike.getGlyphOutlineBounds(paramInt));
/*      */       } else {
/* 1793 */         GeneralPath localGeneralPath = this.strike.getGlyphOutline(paramInt, 0.0F, 0.0F);
/* 1794 */         localGeneralPath.transform(this.sgv.invdtx);
/* 1795 */         localObject = localGeneralPath.getBounds2D();
/*      */       }
/*      */ 
/* 1805 */       if (!((Rectangle2D)localObject).isEmpty()) {
/* 1806 */         ((Rectangle2D)localObject).setRect(((Rectangle2D)localObject).getMinX() + paramFloat1 + this.dx, ((Rectangle2D)localObject).getMinY() + paramFloat2 + this.dy, ((Rectangle2D)localObject).getWidth(), ((Rectangle2D)localObject).getHeight());
/*      */       }
/*      */ 
/* 1810 */       return localObject;
/*      */     }
/*      */ 
/*      */     void appendGlyphOutline(int paramInt, GeneralPath paramGeneralPath, float paramFloat1, float paramFloat2)
/*      */     {
/* 1815 */       GeneralPath localGeneralPath = null;
/* 1816 */       if (this.sgv.invdtx == null) {
/* 1817 */         localGeneralPath = this.strike.getGlyphOutline(paramInt, paramFloat1 + this.dx, paramFloat2 + this.dy);
/*      */       } else {
/* 1819 */         localGeneralPath = this.strike.getGlyphOutline(paramInt, 0.0F, 0.0F);
/* 1820 */         localGeneralPath.transform(this.sgv.invdtx);
/* 1821 */         localGeneralPath.transform(AffineTransform.getTranslateInstance(paramFloat1 + this.dx, paramFloat2 + this.dy));
/*      */       }
/* 1823 */       PathIterator localPathIterator = localGeneralPath.getPathIterator(null);
/* 1824 */       paramGeneralPath.append(localPathIterator, false);
/*      */     }
/*      */   }
/*      */ 
