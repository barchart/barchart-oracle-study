...
/*     */     }
/*     */ 
/* 475 */     writeJPEGStream(this.param, paramColorModel, this.outStream, localObject1, n, m);
/*     */   }
/*     */ 
/*     */   private int getNearestColorId(ColorModel paramColorModel)
/*     */   {
/* 490 */     ColorSpace localColorSpace = paramColorModel.getColorSpace();
/* 491 */     switch (localColorSpace.getType()) {
/*     */     case 5:
/* 493 */       if (paramColorModel.hasAlpha()) return 6;
/* 494 */       return 2;
/*     */     }
/*     */ 
/* 497 */     return getDefaultColorId(paramColorModel);
/*     */   }
/*     */ 
