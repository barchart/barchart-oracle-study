...
/*      */     }
/*      */ 
/* 1389 */     if ((this.scanlineStride < 0) || (this.scanlineStride > 2147483647 / this.height))
/*      */     {
/* 1392 */       throw new RasterFormatException("Invalid scanline stride");
/*      */     }
/*      */ 
/* 1395 */     int i = this.dataBitOffset + (this.height - 1) * this.scanlineStride * 8 + (this.width - 1) * this.pixelBitStride + this.pixelBitStride - 1;
/*      */ 
/* 1399 */     if ((i < 0) || (i / 8 >= this.data.length)) {
/* 1400 */       throw new RasterFormatException("raster dimensions overflow array bounds");
/*      */     }
/*      */ 
/* 1403 */     if ((paramBoolean) && 
/* 1404 */       (this.height > 1)) {
/* 1405 */       i = this.width * this.pixelBitStride - 1;
/* 1406 */       if (i / 8 >= this.scanlineStride)
/* 1407 */         throw new RasterFormatException("data for adjacent scanlines overlaps");
/*      */     }
/*      */   }
/*      */ 
/*      */   public String toString()
/*      */   {
/* 1415 */     return new String("BytePackedRaster: width = " + this.width + " height = " + this.height + " #channels " + this.numBands + " xOff = " + this.sampleModelTranslateX + " yOff = " + this.sampleModelTranslateY);
/*      */   }
/*      */ 
/*      */   static
/*      */   {
