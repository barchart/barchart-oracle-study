...
/* 888 */     i = 0;
/*     */ 
/* 892 */     if ((this.scanlineStride < 0) || (this.scanlineStride > 2147483647 / this.height))
/*     */     {
/* 896 */       throw new RasterFormatException("Incorrect scanline stride: " + this.scanlineStride);
/*     */     }
/*     */ 
/* 899 */     int k = (this.height - 1) * this.scanlineStride;
/*     */ 
/* 901 */     if ((this.pixelStride < 0) || (this.pixelStride > 2147483647 / this.width))
/*     */     {
/* 905 */       throw new RasterFormatException("Incorrect pixel stride: " + this.pixelStride);
/*     */     }
/*     */ 
/* 908 */     int m = (this.width - 1) * this.pixelStride;
/*     */ 
/* 910 */     if (m > 2147483647 - k)
/*     */     {
/* 912 */       throw new RasterFormatException("Incorrect raster attributes");
/*     */     }
/* 914 */     m += k;
/*     */ 
/* 916 */     for (int n = 0; n < this.numDataElements; n++) {
/* 917 */       if (this.dataOffsets[n] > 2147483647 - m) {
/* 918 */         throw new RasterFormatException("Incorrect band offset: " + this.dataOffsets[n]);
/*     */       }
/*     */ 
/* 923 */       int j = m + this.dataOffsets[n];
/*     */ 
/* 925 */       if (j > i) {
/* 926 */         i = j;
/*     */       }
/*     */     }
/* 929 */     if (this.data.length < i)
/* 930 */       throw new RasterFormatException("Data array too small (should be " + i + " )");
/*     */   }
/*     */ 
/*     */   public String toString()
/*     */   {
/* 936 */     return new String("ByteComponentRaster: width = " + this.width + " height = " + this.height + " #numDataElements " + this.numDataElements + " dataOff[0] = " + this.dataOffsets[0]);
/*     */   }
/*     */ 
/*     */   static
/*     */   {
