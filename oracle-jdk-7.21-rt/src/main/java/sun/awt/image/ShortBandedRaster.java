...
/*     */   {
/* 744 */     for (int i = 0; i < this.dataOffsets.length; i++) {
/* 745 */       if (this.dataOffsets[i] < 0) {
/* 746 */         throw new RasterFormatException("Data offsets for band " + i + "(" + this.dataOffsets[i] + ") must be >= 0");
/*     */       }
/*     */ 
/*     */     }
/*     */ 
/* 752 */     i = 0;
/*     */ 
/* 755 */     for (int k = 0; k < this.numDataElements; k++) {
/* 756 */       int j = (this.height - 1) * this.scanlineStride + (this.width - 1) + this.dataOffsets[k];
/* 757 */       if (j > i) {
/* 758 */         i = j;
/*     */       }
/*     */     }
/* 761 */     for (k = 0; k < this.numDataElements; k++)
/* 762 */       if (this.data[k].length < i)
/* 763 */         throw new RasterFormatException("Data array too small (should be " + i + " )");
/*     */   }
/*     */ 
/*     */   public String toString()
/*     */   {
/* 770 */     return new String("ShortBandedRaster: width = " + this.width + " height = " + this.height + " #numBands " + this.numBands + " #dataElements " + this.numDataElements);
/*     */   }
/*     */ }
