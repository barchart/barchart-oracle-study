...
/* 336 */       this.sdCurrent = getBackupSurface();
/*     */ 
...
/*     */     }
/*     */ 
/* 344 */     this.vImg.updateGraphicsConfig();
/*     */   }
/*     */ 
/*     */   public void paletteChanged()
/*     */   {
/* 353 */     this.lostSurface = true;
/*     */   }
/*     */ 
/*     */   protected boolean isConfigValid(GraphicsConfiguration paramGraphicsConfiguration)
/*     */   {
/* 365 */     return (paramGraphicsConfiguration == null) || (paramGraphicsConfiguration.getDevice() == this.vImg.getGraphicsConfig().getDevice());
/*     */   }
/*     */ 
/*     */   public ImageCapabilities getCapabilities(GraphicsConfiguration paramGraphicsConfiguration)
/*     */   {
/* 371 */     if (isConfigValid(paramGraphicsConfiguration)) {
/* 372 */       return isAccelerationEnabled() ? new AcceleratedImageCapabilities() : new ImageCapabilities(false);
/*     */     }
/*     */ 
/* 376 */     return super.getCapabilities(paramGraphicsConfiguration);
/*     */   }
/*     */ 
/*     */   public void flush()
/*     */   {
/* 402 */     this.lostSurface = true;
/* 403 */     SurfaceData localSurfaceData = this.sdAccel;
/* 404 */     this.sdAccel = null;
/* 405 */     if (localSurfaceData != null)
/* 406 */       localSurfaceData.flush();
/*     */   }
/*     */ 
...
/* 387 */       return VolatileSurfaceManager.this.sdCurrent == VolatileSurfaceManager.this.sdAccel;
/*     */     }
/*     */ 
