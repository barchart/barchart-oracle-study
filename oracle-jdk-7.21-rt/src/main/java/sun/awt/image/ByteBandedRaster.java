...
/*     */   {
/* 745 */     for (int i = 0; i < this.dataOffsets.length; i++) {
/* 746 */       if (this.dataOffsets[i] < 0) {
/* 747 */         throw new RasterFormatException("Data offsets for band " + i + "(" + this.dataOffsets[i] + ") must be >= 0");
/*     */       }
/*     */ 
/*     */     }
/*     */ 
/* 753 */     i = 0;
/*     */ 
/* 756 */     for (int k = 0; k < this.numDataElements; k++) {
/* 757 */       int j = (this.height - 1) * this.scanlineStride + (this.width - 1) + this.dataOffsets[k];
/* 758 */       if (j > i) {
/* 759 */         i = j;
/*     */       }
/*     */     }
/*     */ 
/* 763 */     if (this.data.length == 1) {
/* 764 */       if (this.data[0].length < i * this.numDataElements) {
/* 765 */         throw new RasterFormatException("Data array too small (it is " + this.data[0].length + " and should be " + i * this.numDataElements + " )");
/*     */       }
/*     */ 
/*     */     }
/*     */     else
/*     */     {
/* 773 */       for (k = 0; k < this.numDataElements; k++)
/* 774 */         if (this.data[k].length < i)
/* 775 */           throw new RasterFormatException("Data array too small (it is " + this.data[k].length + " and should be " + i + " )");
/*     */     }
/*     */   }
/*     */ 
/*     */   public String toString()
/*     */   {
/* 785 */     return new String("ByteBandedRaster: width = " + this.width + " height = " + this.height + " #bands " + this.numDataElements + " minX = " + this.minX + " minY = " + this.minY);
/*     */   }
/*     */ }
