...
/* 822 */     i = 0;
/*     */ 
/* 826 */     if ((this.scanlineStride < 0) || (this.scanlineStride > 2147483647 / this.height))
/*     */     {
/* 830 */       throw new RasterFormatException("Incorrect scanline stride: " + this.scanlineStride);
/*     */     }
/*     */ 
/* 833 */     int k = (this.height - 1) * this.scanlineStride;
/*     */ 
/* 835 */     if ((this.pixelStride < 0) || (this.pixelStride > 2147483647 / this.width))
/*     */     {
/* 839 */       throw new RasterFormatException("Incorrect pixel stride: " + this.pixelStride);
/*     */     }
/*     */ 
/* 842 */     int m = (this.width - 1) * this.pixelStride;
/*     */ 
/* 844 */     if (m > 2147483647 - k)
/*     */     {
/* 846 */       throw new RasterFormatException("Incorrect raster attributes");
/*     */     }
/* 848 */     m += k;
/*     */ 
/* 850 */     for (int n = 0; n < this.numDataElements; n++) {
/* 851 */       if (this.dataOffsets[n] > 2147483647 - m) {
/* 852 */         throw new RasterFormatException("Incorrect band offset: " + this.dataOffsets[n]);
/*     */       }
/*     */ 
/* 856 */       int j = m + this.dataOffsets[n];
/*     */ 
/* 858 */       if (j > i) {
/* 859 */         i = j;
/*     */       }
/*     */     }
/* 862 */     if (this.data.length < i)
/* 863 */       throw new RasterFormatException("Data array too small (should be " + i + " )");
/*     */   }
/*     */ 
/*     */   public String toString()
/*     */   {
/* 869 */     return new String("ShortComponentRaster: width = " + this.width + " height = " + this.height + " #numDataElements " + this.numDataElements);
/*     */   }
/*     */ 
/*     */   static
/*     */   {
