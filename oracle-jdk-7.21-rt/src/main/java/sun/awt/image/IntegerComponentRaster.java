...
/* 657 */     int i = 0;
/*     */ 
/* 661 */     if ((this.scanlineStride < 0) || (this.scanlineStride > 2147483647 / this.height))
/*     */     {
/* 665 */       throw new RasterFormatException("Incorrect scanline stride: " + this.scanlineStride);
/*     */     }
/*     */ 
/* 668 */     int k = (this.height - 1) * this.scanlineStride;
/*     */ 
/* 670 */     if ((this.pixelStride < 0) || (this.pixelStride > 2147483647 / this.width))
/*     */     {
/* 674 */       throw new RasterFormatException("Incorrect pixel stride: " + this.pixelStride);
/*     */     }
/*     */ 
/* 677 */     int m = (this.width - 1) * this.pixelStride;
/*     */ 
/* 679 */     if (m > 2147483647 - k)
/*     */     {
/* 681 */       throw new RasterFormatException("Incorrect raster attributes");
/*     */     }
/* 683 */     m += k;
/*     */ 
/* 685 */     for (int n = 0; n < this.numDataElements; n++) {
/* 686 */       if (this.dataOffsets[n] > 2147483647 - m) {
/* 687 */         throw new RasterFormatException("Incorrect band offset: " + this.dataOffsets[n]);
/*     */       }
/*     */ 
/* 691 */       int j = m + this.dataOffsets[n];
/*     */ 
/* 693 */       if (j > i) {
/* 694 */         i = j;
/*     */       }
/*     */     }
/* 697 */     if (this.data.length < i)
/* 698 */       throw new RasterFormatException("Data array too small (should be " + i + " )");
/*     */   }
/*     */ 
/*     */   public String toString()
/*     */   {
/* 704 */     return new String("IntegerComponentRaster: width = " + this.width + " height = " + this.height + " #Bands = " + this.numBands + " #DataElements " + this.numDataElements + " xOff = " + this.sampleModelTranslateX + " yOff = " + this.sampleModelTranslateY + " dataOffset[0] " + this.dataOffsets[0]);
/*     */   }
/*     */ 
/*     */   static
/*     */   {
