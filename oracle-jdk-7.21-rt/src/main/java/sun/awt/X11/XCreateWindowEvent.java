...
/* 62 */   public boolean get_override_redirect() { log.finest(""); return Native.getBool(this.pData + 44L); } 
/* 63 */   public void set_override_redirect(boolean paramBoolean) { log.finest(""); Native.putBool(this.pData + 44L, paramBoolean); }
/*    */ 
/*    */   String getName()
/*    */   {
...
/* 78 */     localStringBuilder.append("parent = ").append(get_parent()).append(", ");
/* 79 */     localStringBuilder.append("window = ").append(getWindow(get_window())).append(", ");
/* 80 */     localStringBuilder.append("x = ").append(get_x()).append(", ");
/* 81 */     localStringBuilder.append("y = ").append(get_y()).append(", ");
/* 82 */     localStringBuilder.append("width = ").append(get_width()).append(", ");
/* 83 */     localStringBuilder.append("height = ").append(get_height()).append(", ");
/* 84 */     localStringBuilder.append("border_width = ").append(get_border_width()).append(", ");
/* 85 */     localStringBuilder.append("override_redirect = ").append(get_override_redirect()).append(", ");
/* 86 */     return localStringBuilder.toString();
/*    */   }
/*    */ }

/* Location:           /home/user1/Temp/jvm/rt.jar
 * Qualified Name:     sun.awt.X11.XCreateWindowEvent
