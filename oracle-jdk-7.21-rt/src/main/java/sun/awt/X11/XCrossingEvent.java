...
/*  64 */   public int get_mode() { log.finest(""); return Native.getInt(this.pData + 48L); } 
/*  65 */   public void set_mode(int paramInt) { log.finest(""); Native.putInt(this.pData + 48L, paramInt); } 
/*  66 */   public int get_detail() { log.finest(""); return Native.getInt(this.pData + 52L); } 
/*  67 */   public void set_detail(int paramInt) { log.finest(""); Native.putInt(this.pData + 52L, paramInt); } 
...
/*  70 */   public boolean get_focus() { log.finest(""); return Native.getBool(this.pData + 60L); } 
/*  71 */   public void set_focus(boolean paramBoolean) { log.finest(""); Native.putBool(this.pData + 60L, paramBoolean); } 
/*  72 */   public int get_state() { log.finest(""); return Native.getInt(this.pData + 64L); } 
/*  73 */   public void set_state(int paramInt) { log.finest(""); Native.putInt(this.pData + 64L, paramInt); }
/*     */ 
/*     */   String getName()
/*     */   {
...
/*     */   {
/*  82 */     StringBuilder localStringBuilder = new StringBuilder(680);
/*     */ 
/*  84 */     localStringBuilder.append("type = ").append(XlibWrapper.eventToString[get_type()]).append(", ");
/*  85 */     localStringBuilder.append("serial = ").append(get_serial()).append(", ");
/*  86 */     localStringBuilder.append("send_event = ").append(get_send_event()).append(", ");
/*  87 */     localStringBuilder.append("display = ").append(get_display()).append(", ");
/*  88 */     localStringBuilder.append("window = ").append(getWindow(get_window())).append(", ");
/*  89 */     localStringBuilder.append("root = ").append(get_root()).append(", ");
/*  90 */     localStringBuilder.append("subwindow = ").append(get_subwindow()).append(", ");
/*  91 */     localStringBuilder.append("time = ").append(get_time()).append(", ");
/*  92 */     localStringBuilder.append("x = ").append(get_x()).append(", ");
/*  93 */     localStringBuilder.append("y = ").append(get_y()).append(", ");
/*  94 */     localStringBuilder.append("x_root = ").append(get_x_root()).append(", ");
/*  95 */     localStringBuilder.append("y_root = ").append(get_y_root()).append(", ");
/*  96 */     localStringBuilder.append("mode = ").append(get_mode()).append(", ");
/*  97 */     localStringBuilder.append("detail = ").append(get_detail()).append(", ");
/*  98 */     localStringBuilder.append("same_screen = ").append(get_same_screen()).append(", ");
/*  99 */     localStringBuilder.append("focus = ").append(get_focus()).append(", ");
/* 100 */     localStringBuilder.append("state = ").append(get_state()).append(", ");
/* 101 */     return localStringBuilder.toString();
/*     */   }
/*     */ }

/* Location:           /home/user1/Temp/jvm/rt.jar
 * Qualified Name:     sun.awt.X11.XCrossingEvent
