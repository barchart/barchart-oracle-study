...
/*  71 */         XToolkit.WITH_XERROR_HANDLER(paramXErrorHandler);
/*     */       }
/*  73 */       int i = XlibWrapper.XTranslateCoordinates(XToolkit.getDisplay(), get_scr_w(), get_dest_w(), get_src_x(), get_src_y(), this.dest_x_ptr, this.dest_y_ptr, this.child_ptr);
/*     */ 
/*  82 */       if (paramXErrorHandler != null) {
/*  83 */         XToolkit.RESTORE_XERROR_HANDLER();
/*     */       }
/*  85 */       return i;
/*     */     } finally {
...
/*     */   }
/*     */ 
/*  91 */   public boolean isExecuted() { return this.__executed; }
/*     */ 
...
/*     */   }
/*     */ 
/* 109 */   public long get_scr_w() { if (isDisposed()) {
 ...
 * Qualified Name:     sun.awt.X11.XTranslateCoordinates
