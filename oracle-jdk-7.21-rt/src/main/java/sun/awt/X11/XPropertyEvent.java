...
/* 50 */   public long get_atom() { log.finest(""); return Native.getLong(this.pData + 20L); } 
/* 51 */   public void set_atom(long paramLong) { log.finest(""); Native.putLong(this.pData + 20L, paramLong); } 
...
/* 71 */     localStringBuilder.append("atom = ").append(XAtom.get(get_atom())).append(", ");
 ...
 * Qualified Name:     sun.awt.X11.XPropertyEvent
