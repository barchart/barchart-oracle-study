...
/* 61 */     localStringBuilder.append("serial = ").append(get_serial()).append(", ");
/* 62 */     localStringBuilder.append("send_event = ").append(get_send_event()).append(", ");
/* 63 */     localStringBuilder.append("display = ").append(get_display()).append(", ");
/* 64 */     localStringBuilder.append("window = ").append(getWindow(get_window())).append(", ");
/* 65 */     return localStringBuilder.toString();
/*    */   }
/*    */ }

/* Location:           /home/user1/Temp/jvm/rt.jar
 * Qualified Name:     sun.awt.X11.XAnyEvent
