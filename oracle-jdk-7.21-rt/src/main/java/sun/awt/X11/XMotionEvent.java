...
/* 66 */   public byte get_is_hint() { log.finest(""); return Native.getByte(this.pData + 52L); } 
/* 67 */   public void set_is_hint(byte paramByte) { log.finest(""); Native.putByte(this.pData + 52L, paramByte); } 
...
/* 93 */     localStringBuilder.append("is_hint = ").append(get_is_hint()).append(", ");
 ...
 * Qualified Name:     sun.awt.X11.XMotionEvent
