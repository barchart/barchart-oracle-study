...
/* 52 */   public int get_place() { log.finest(""); return Native.getInt(this.pData + 24L); } 
/* 53 */   public void set_place(int paramInt) { log.finest(""); Native.putInt(this.pData + 24L, paramInt); }
/*    */ 
/*    */   String getName()
/*    */   {
...
/* 68 */     localStringBuilder.append("parent = ").append(get_parent()).append(", ");
/* 69 */     localStringBuilder.append("window = ").append(getWindow(get_window())).append(", ");
/* 70 */     localStringBuilder.append("place = ").append(get_place()).append(", ");
/* 71 */     return localStringBuilder.toString();
/*    */   }
/*    */ }

/* Location:           /home/user1/Temp/jvm/rt.jar
 * Qualified Name:     sun.awt.X11.XCirculateRequestEvent
