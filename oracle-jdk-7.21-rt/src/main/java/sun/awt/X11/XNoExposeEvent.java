...
/* 50 */   public int get_major_code() { log.finest(""); return Native.getInt(this.pData + 20L); } 
/* 51 */   public void set_major_code(int paramInt) { log.finest(""); Native.putInt(this.pData + 20L, paramInt); } 
/* 52 */   public int get_minor_code() { log.finest(""); return Native.getInt(this.pData + 24L); } 
/* 53 */   public void set_minor_code(int paramInt) { log.finest(""); Native.putInt(this.pData + 24L, paramInt); }
/*    */ 
/*    */   String getName()
/*    */   {
...
/* 68 */     localStringBuilder.append("drawable = ").append(get_drawable()).append(", ");
/* 69 */     localStringBuilder.append("major_code = ").append(get_major_code()).append(", ");
 ...
 * Qualified Name:     sun.awt.X11.XNoExposeEvent
