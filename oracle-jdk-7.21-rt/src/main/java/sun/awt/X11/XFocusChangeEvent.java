...
/* 50 */   public int get_mode() { log.finest(""); return Native.getInt(this.pData + 20L); } 
/* 51 */   public void set_mode(int paramInt) { log.finest(""); Native.putInt(this.pData + 20L, paramInt); } 
/* 52 */   public int get_detail() { log.finest(""); return Native.getInt(this.pData + 24L); } 
/* 53 */   public void set_detail(int paramInt) { log.finest(""); Native.putInt(this.pData + 24L, paramInt); }
/*    */ 
/*    */   String getName()
/*    */   {
...
/* 69 */     localStringBuilder.append("mode = ").append(get_mode()).append(", ");
/* 70 */     localStringBuilder.append("detail = ").append(get_detail()).append(", ");
/* 71 */     return localStringBuilder.toString();
/*    */   }
/*    */ }

/* Location:           /home/user1/Temp/jvm/rt.jar
 * Qualified Name:     sun.awt.X11.XFocusChangeEvent
