...
/* 54 */   public int get_changed_groups() { log.finest(""); return Native.getInt(this.pData + 28L); } 
/* 55 */   public void set_changed_groups(int paramInt) { log.finest(""); Native.putInt(this.pData + 28L, paramInt); } 
/* 56 */   public int get_first_si() { log.finest(""); return Native.getInt(this.pData + 32L); } 
/* 57 */   public void set_first_si(int paramInt) { log.finest(""); Native.putInt(this.pData + 32L, paramInt); } 
/* 58 */   public int get_num_si() { log.finest(""); return Native.getInt(this.pData + 36L); } 
/* 59 */   public void set_num_si(int paramInt) { log.finest(""); Native.putInt(this.pData + 36L, paramInt); } 
/* 60 */   public int get_num_total_si() { log.finest(""); return Native.getInt(this.pData + 40L); } 
/* 61 */   public void set_num_total_si(int paramInt) { log.finest(""); Native.putInt(this.pData + 40L, paramInt); }
/*    */ 
/*    */   String getName()
/*    */   {
...
/* 79 */     localStringBuilder.append("changed_groups = ").append(get_changed_groups()).append(", ");
/* 80 */     localStringBuilder.append("first_si = ").append(get_first_si()).append(", ");
/* 81 */     localStringBuilder.append("num_si = ").append(get_num_si()).append(", ");
/* 82 */     localStringBuilder.append("num_total_si = ").append(get_num_total_si()).append(", ");
/* 83 */     return localStringBuilder.toString();
/*    */   }
/*    */ }

/* Location:           /home/user1/Temp/jvm/rt.jar
 * Qualified Name:     sun.awt.X11.XkbCompatMapNotifyEvent
