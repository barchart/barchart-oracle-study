...
/* 66 */   public int get_button() { log.finest(""); return Native.getInt(this.pData + 52L); } 
/* 67 */   public void set_button(int paramInt) { log.finest(""); Native.putInt(this.pData + 52L, paramInt); } 
...
/* 93 */     localStringBuilder.append("button = ").append(get_button()).append(", ");
 ...
 * Qualified Name:     sun.awt.X11.XButtonEvent
