...
/*  64 */         XToolkit.WITH_XERROR_HANDLER(paramXErrorHandler);
/*     */       }
/*  66 */       Native.putLong(this.children_ptr, 0L);
/*  67 */       int i = XlibWrapper.XQueryTree(XToolkit.getDisplay(), get_w(), this.root_ptr, this.parent_ptr, this.children_ptr, this.nchildren_ptr);
/*     */ 
/*  74 */       if (paramXErrorHandler != null) {
/*  75 */         XToolkit.RESTORE_XERROR_HANDLER();
/*     */       }
/*  77 */       return i;
/*     */     } finally {
...
/*     */   }
/*     */ 
/*  83 */   public boolean isExecuted() { return this.__executed; }
/*     */ 
...
/*     */   }
/*     */ 
/* 101 */   public long get_w() { if (isDisposed()) {
 ...
 * Qualified Name:     sun.awt.X11.XQueryTree
