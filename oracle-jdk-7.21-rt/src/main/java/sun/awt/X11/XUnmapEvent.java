...
/* 52 */   public boolean get_from_configure() { log.finest(""); return Native.getBool(this.pData + 24L); } 
/* 53 */   public void set_from_configure(boolean paramBoolean) { log.finest(""); Native.putBool(this.pData + 24L, paramBoolean); }
/*    */ 
/*    */   String getName()
/*    */   {
...
/* 70 */     localStringBuilder.append("from_configure = ").append(get_from_configure()).append(", ");
/* 71 */     return localStringBuilder.toString();
/*    */   }
/*    */ }

/* Location:           /home/user1/Temp/jvm/rt.jar
 * Qualified Name:     sun.awt.X11.XUnmapEvent
