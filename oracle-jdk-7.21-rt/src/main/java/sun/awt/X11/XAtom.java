...
/* 155 */       return (XAtom)atomToAtom.get(Long.valueOf(paramLong));
/*     */     }
/*     */   }
/*     */ 
/* 159 */   static XAtom lookup(String paramString) { synchronized (XAtom.class) {
/* 160 */       return (XAtom)nameToAtom.get(paramString);
/*     */     }
/*     */   }
/*     */ 
/*     */   static XAtom get(long paramLong)
/*     */   {
/* 169 */     XAtom localXAtom = lookup(paramLong);
/* 170 */     if (localXAtom == null) {
/* 171 */       localXAtom = new XAtom(XToolkit.getDisplay(), paramLong);
/*     */     }
/* 173 */     return localXAtom;
/*     */   }
/*     */   public static XAtom get(String paramString) {
/* 176 */     XAtom localXAtom = lookup(paramString);
/* 177 */     if (localXAtom == null) {
/* 178 */       localXAtom = new XAtom(XToolkit.getDisplay(), paramString);
/*     */     }
/* 180 */     return localXAtom;
/*     */   }
...
/* 195 */     XAtom localXAtom = lookup(paramLong);
/* 196 */     if (localXAtom == null) {
/* 197 */       return Long.toString(paramLong);
/*     */     }
/* 199 */     return localXAtom.toString();
/*     */   }
/*     */ 
/*     */   void register() {
/* 203 */     register(this);
...
/*     */   {
/* 303 */     XAtom localXAtom = get("UTF8_STRING");
/* 304 */     if (this.atom == 0L) {
...
/* 312 */       localUnsupportedEncodingException.printStackTrace();
/*     */     }
/* 314 */     if (arrayOfByte != null)
/* 315 */       setAtomData(paramLong, localXAtom.atom, arrayOfByte);
/*     */   }
/*     */ 
...
/*     */     } catch (UnsupportedEncodingException localUnsupportedEncodingException) {
/* 331 */       localUnsupportedEncodingException.printStackTrace();
/*     */     }
...
/* 368 */     WindowPropertyGetter localWindowPropertyGetter = new WindowPropertyGetter(paramLong1, this, 0L, 1L, false, paramLong2);
/*     */     try
/*     */     {
/* 372 */       int i = localWindowPropertyGetter.execute();
/*     */       long l;
/* 373 */       if ((i != 0) || (localWindowPropertyGetter.getData() == 0L)) {
/* 374 */         return 0L;
/*     */       }
/* 376 */       if ((localWindowPropertyGetter.getActualType() != paramLong2) || (localWindowPropertyGetter.getActualFormat() != 32)) {
/* 377 */         return 0L;
/*     */       }
/* 379 */       return Native.getCard32(localWindowPropertyGetter.getData());
/*     */     } finally {
/* 381 */       localWindowPropertyGetter.dispose();
/*     */     }
/*     */   }
/*     */ 
...
/* 430 */     WindowPropertyGetter localWindowPropertyGetter = new WindowPropertyGetter(paramLong1, this, 0L, paramInt, false, this);
/*     */     try
/*     */     {
/* 434 */       int i = localWindowPropertyGetter.execute();
/*     */       boolean bool;
/* 435 */       if ((i != 0) || (localWindowPropertyGetter.getData() == 0L)) {
/* 436 */         return false;
/*     */       }
/* 438 */       if ((localWindowPropertyGetter.getActualType() != this.atom) || (localWindowPropertyGetter.getActualFormat() != 32) || (localWindowPropertyGetter.getNumberOfItems() != paramInt))
/*     */       {
/* 443 */         return false;
/*     */       }
/* 445 */       XlibWrapper.memcpy(paramLong2, localWindowPropertyGetter.getData(), paramInt * getAtomSize());
/* 446 */       return true;
/*     */     } finally {
/* 448 */       localWindowPropertyGetter.dispose();
/*     */     }
/*     */   }
/*     */ 
...
/* 464 */     WindowPropertyGetter localWindowPropertyGetter = new WindowPropertyGetter(paramLong1, this, 0L, paramInt, false, paramLong2);
/*     */     try
/*     */     {
/* 468 */       int i = localWindowPropertyGetter.execute();
/*     */       boolean bool;
/* 469 */       if ((i != 0) || (localWindowPropertyGetter.getData() == 0L)) {
/* 470 */         return false;
/*     */       }
/* 472 */       if ((localWindowPropertyGetter.getActualType() != paramLong2) || (localWindowPropertyGetter.getActualFormat() != 32) || (localWindowPropertyGetter.getNumberOfItems() != paramInt))
/*     */       {
/* 477 */         return false;
/*     */       }
/* 479 */       XlibWrapper.memcpy(paramLong3, localWindowPropertyGetter.getData(), paramInt * getAtomSize());
/* 480 */       return true;
/*     */     } finally {
/* 482 */       localWindowPropertyGetter.dispose();
/*     */     }
/*     */   }
/*     */ 
...
/*     */     try {
/* 575 */       XlibWrapper.XDeleteProperty(XToolkit.getDisplay(), paramXBaseWindow.getWindow(), this.atom);
/*     */     }
/*     */     finally {
...
/* 600 */     WindowPropertyGetter localWindowPropertyGetter = new WindowPropertyGetter(paramLong1, this, 0L, 65535L, false, paramLong2);
/*     */     try
/*     */     {
/* 604 */       int i = localWindowPropertyGetter.execute();
/* 605 */       if ((i != 0) || (localWindowPropertyGetter.getData() == 0L)) {
/* 606 */         return null;
/*     */       }
/* 608 */       if ((localWindowPropertyGetter.getActualType() != paramLong2) || (localWindowPropertyGetter.getActualFormat() != 8)) {
/* 609 */         return null;
/*     */       }
/* 611 */       byte[] arrayOfByte1 = XlibWrapper.getStringBytes(localWindowPropertyGetter.getData());
/* 612 */       return arrayOfByte1;
/*     */     } finally {
/* 614 */       localWindowPropertyGetter.dispose();
/*     */     }
/*     */   }
/*     */ 
...
/*     */ 
/* 672 */     WindowPropertyGetter localWindowPropertyGetter = new WindowPropertyGetter(paramLong, this, 0L, 65535L, false, 4L);
/*     */     try
/*     */     {
/* 676 */       int i = localWindowPropertyGetter.execute();
/*     */       XAtom[] arrayOfXAtom1;
/* 677 */       if ((i != 0) || (localWindowPropertyGetter.getData() == 0L)) {
/* 678 */         return emptyList;
/*     */       }
/* 680 */       if ((localWindowPropertyGetter.getActualType() != 4L) || (localWindowPropertyGetter.getActualFormat() != 32)) {
/* 681 */         return emptyList;
/*     */       }
/*     */ 
/* 684 */       int j = localWindowPropertyGetter.getNumberOfItems();
/* 685 */       if (j == 0) {
/* 686 */         return emptyList;
/*     */       }
/* 688 */       long l = localWindowPropertyGetter.getData();
/* 689 */       XAtom[] arrayOfXAtom3 = new XAtom[j];
/* 690 */       for (int k = 0; k < j; k++) {
/* 691 */         arrayOfXAtom3[k] = get(getAtom(l + k * getAtomSize()));
/*     */       }
/* 693 */       return arrayOfXAtom3;
/*     */     } finally {
/* 695 */       localWindowPropertyGetter.dispose();
/*     */     }
/*     */   }
/*     */ 
...
/* 762 */     for (int i = 0; i < paramArrayOfXAtom.length; i++) {
/* 763 */       if (paramArrayOfXAtom[i] != null) {
/* 764 */         paramArrayOfXAtom[i].putAtom(l + i * getAtomSize());
/*     */       }
/*     */     }
/* 767 */     return l;
/*     */   }
...
/* 778 */       return false;
/*     */     }
/* 780 */     XAtom localXAtom = (XAtom)paramObject;
/* 781 */     return (this.atom == localXAtom.atom) && (this.display == localXAtom.display);
/*     */   }
/*     */   public int hashCode() {
/* 784 */     return (int)((this.atom ^ this.display) & 0xFFFF);
/*     */   }
/*     */ 
...
/*     */   }
/*     */ 
/* 807 */   public void setWindowProperty(XBaseWindow paramXBaseWindow1, XBaseWindow paramXBaseWindow2) { setWindowProperty(paramXBaseWindow1.getWindow(), paramXBaseWindow2.getWindow()); }
/*     */ 
/*     */ 
...
/* 819 */     WindowPropertyGetter localWindowPropertyGetter = new WindowPropertyGetter(paramLong, this, 0L, 1L, false, 33L);
/*     */     try
/*     */     {
/* 823 */       int i = localWindowPropertyGetter.execute();
/*     */       long l;
/* 824 */       if ((i != 0) || (localWindowPropertyGetter.getData() == 0L)) {
/* 825 */         return 0L;
/*     */       }
/* 827 */       if ((localWindowPropertyGetter.getActualType() != 33L) || (localWindowPropertyGetter.getActualFormat() != 32)) {
/* 828 */         return 0L;
/*     */       }
/* 830 */       return Native.getWindow(localWindowPropertyGetter.getData());
/*     */     } finally {
/* 832 */       localWindowPropertyGetter.dispose();
/*     */     }
/*     */   }
/*     */ }

/* Location:           /home/user1/Temp/jvm/rt.jar
 * Qualified Name:     sun.awt.X11.XAtom
