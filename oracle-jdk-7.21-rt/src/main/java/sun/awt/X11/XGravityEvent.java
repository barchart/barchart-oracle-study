...
/* 70 */     localStringBuilder.append("event = ").append(get_event()).append(", ");
/* 71 */     localStringBuilder.append("window = ").append(getWindow(get_window())).append(", ");
/* 72 */     localStringBuilder.append("x = ").append(get_x()).append(", ");
/* 73 */     localStringBuilder.append("y = ").append(get_y()).append(", ");
/* 74 */     return localStringBuilder.toString();
/*    */   }
/*    */ }

/* Location:           /home/user1/Temp/jvm/rt.jar
 * Qualified Name:     sun.awt.X11.XGravityEvent
