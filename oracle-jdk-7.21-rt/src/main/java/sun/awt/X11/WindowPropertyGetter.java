...
/* 189 */   static Set<XAtom> cacheableProperties = new HashSet(Arrays.asList(new XAtom[] { XAtom.get("_NET_WM_STATE"), XAtom.get("WM_STATE"), XAtom.get("_MOTIF_WM_HINTS") }));
/*     */ 
...
/* 102 */         XToolkit.WITH_XERROR_HANDLER(paramXErrorHandler);
/*     */       }
/* 104 */       Native.putLong(this.data, 0L);
/* 105 */       int i = XlibWrapper.XGetWindowProperty(XToolkit.getDisplay(), this.window, this.property.getAtom(), this.offset, this.length, this.auto_delete ? 1 : 0, this.type, this.actual_type, this.actual_format, this.nitems_ptr, this.bytes_after, this.data);
/*     */ 
...
/* 206 */     XPropertyCache.PropertyCacheEntry localPropertyCacheEntry = XPropertyCache.getCacheEntry(this.window, this.property);
/* 207 */     Native.putInt(this.actual_format, localPropertyCacheEntry.getFormat());
/* 208 */     Native.putLong(this.nitems_ptr, localPropertyCacheEntry.getNumberOfItems());
/* 209 */     Native.putLong(this.bytes_after, localPropertyCacheEntry.getBytesAfter());
/* 210 */     Native.putLong(this.data, unsafe.allocateMemory(getDataLength()));
/* 211 */     XlibWrapper.memcpy(getData(), localPropertyCacheEntry.getData(), getDataLength());
/*     */   }
/*     */ 
/*     */   void cacheProperty() {
/* 215 */     XPropertyCache.storeCache(new XPropertyCache.PropertyCacheEntry(getActualFormat(), getNumberOfItems(), getBytesAfter(), getData(), getDataLength()), this.window, this.property);
/*     */   }
/*     */ }

/* Location:           /home/user1/Temp/jvm/rt.jar
 * Qualified Name:     sun.awt.X11.WindowPropertyGetter
