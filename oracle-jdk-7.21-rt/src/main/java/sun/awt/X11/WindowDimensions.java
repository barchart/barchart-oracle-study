...
/* 123 */       Rectangle localRectangle = new Rectangle(this.loc, this.size);
/* 124 */       localRectangle.width += this.insets.left + this.insets.right;
/* 125 */       localRectangle.height += this.insets.top + this.insets.bottom;
/* 126 */       return localRectangle;
/*     */     }
...
/* 140 */     Dimension localDimension = getClientSize();
/* 141 */     Point localPoint = getLocation();
/* 142 */     localPoint.x += this.insets.left;
/* 143 */     localPoint.y += this.insets.top;
/* 144 */     return new Rectangle(localPoint, localDimension);
/*     */   }
/*     */ 
...
/* 169 */       return false;
/*     */     }
/* 171 */     WindowDimensions localWindowDimensions = (WindowDimensions)paramObject;
/* 172 */     return (localWindowDimensions.insets.equals(this.insets)) && (getClientRect().equals(localWindowDimensions.getClientRect())) && (getBounds().equals(localWindowDimensions.getBounds()));
/*     */   }
/*     */ 
/*     */   public int hashCode()
/*     */   {
 ...
 * Qualified Name:     sun.awt.X11.WindowDimensions
