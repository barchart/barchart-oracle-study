...
/*     */   }
/*     */ 
/*     */   XIconInfo(long[] paramArrayOfLong) {
...
/*     */   }
/*     */ 
/*     */   void setScaledSize(int paramInt1, int paramInt2)
/*     */   {
...
/* 129 */     return "XIconInfo[w=" + this.width + ",h=" + this.height + ",sw=" + this.scaledWidth + ",sh=" + this.scaledHeight + "]";
/*     */   }
/*     */ 
/*     */   int getRawLength() {
 ...
 * Qualified Name:     sun.awt.X11.XIconInfo
